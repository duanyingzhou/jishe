"use strict";
const axError = { formatError: "This is not a valid data format!", paraError: "The parameters do not meet the requirements!", arrayRequired: "The value must be an array type!", noNode: "This page can not find the node!", required: "Required field is missing!", notExist: "The program cannot be executed because the object does not exist!" },
    axIsMobi = () => "ontouchstart" in document.documentElement,
    axEventMap = axIsMobi() ? ["touchstart", "touchmove", "touchend", "touchcancel"] : ["mousedown", "mousemove", "mouseup", "mouseleave"],
    axIsDate = t => isNaN(t) && !isNaN(Date.parse(t)),
    axCeil = { phone: parseInt(getComputedStyle(document.documentElement).getPropertyValue("--ceil-phone")), pad: parseInt(getComputedStyle(document.documentElement).getPropertyValue("--ceil-pad")), flip: parseInt(getComputedStyle(document.documentElement).getPropertyValue("--ceil-flip")), pro: parseInt(getComputedStyle(document.documentElement).getPropertyValue("--ceil-pro")), pc: parseInt(getComputedStyle(document.documentElement).getPropertyValue("--ceil-pc")) },
    axClient = () => { let t = document.body.clientWidth; return t < axCeil.phone ? "phone" : t > axCeil.phone && t < axCeil.pad ? "pad" : t > axCeil.pad && t < axCeil.flip ? "flip" : t > axCeil.flip && t < axCeil.pro ? "pro" : "pc" },
    axType = t => Object.prototype.toString.call(t).slice(8, -1),
    axIsEmpty = t => { let e = axType(t); return !t || ("Function" === e ? "{}" == t.toString().replace(/\s+/g, "").match(/{.*}/g)[0] : "Array" === e ? "" == t.join("") : "Object" === e && 0 === Object.keys(t).length) },
    axToNumber = t => isNaN(t) ? parseFloat(t) : t,
    axTheme = { set: (t, e = "") => { if (axIsEmpty(t)) return !1; let s = t => { t = t.trim(); let e = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/,
                        s = t.toLowerCase(),
                        i = []; if (e.test(s)) { if (4 === s.length) { let t = "#"; for (let e = 1; e < 4; e += 1) t += s.slice(e, e + 1).concat(s.slice(e, e + 1));
                            s = t } for (let t = 1; t < 7; t += 2) i.push(parseInt("0x" + s.slice(t, t + 2))) } return i },
                i = t => { let e, s, i = t[0] / 255,
                        o = t[1] / 255,
                        a = t[2] / 255,
                        n = Math.min(i, o, a),
                        r = Math.max(i, o, a),
                        l = (n + r) / 2,
                        h = r - n; if (r === n) e = 0, s = 0;
                    else { switch (s = l > .5 ? h / (2 - r - n) : h / (r + n), r) {
                            case i:
                                e = (o - a) / h + (o < a ? 6 : 0); break;
                            case o:
                                e = 2 + (a - i) / h; break;
                            case a:
                                e = 4 + (i - o) / h }
                        e = Math.round(60 * e) } return s = Math.round(100 * s), l = Math.round(100 * l), 4 === t.length ? [e, s, l, t[3]] : [e, s, l, 1] },
                o = t => { let e = axType(t),
                        o = []; if (!axIsEmpty(t))
                        if ("String" === e)
                            if (t = t.trim().toLowerCase(), t.startsWith("hsl")) o = t.replace(/^(hsl|hsla)\(/, "").replace(/\)$/, "").replace(/\s/g, "").split(",");
                            else { let e = [];
                                t.startsWith("#") ? e = s(t) : t.startsWith("rgb") && (e = t.replace(/^(rgb|rgba)\(/, "").replace(/\)$/, "").replace(/\s/g, "").split(",").map(Number)), o = i(e) }
                    else "Array" === e && (o = t); return 3 === o.length && o.push(1), o },
                a = axType(t),
                n = { primary: [], text: [], error: [], success: [], info: [], warning: [], question: [] }; if ("Object" === a)
                for (let e in t) t.hasOwnProperty(e) && t[e].length > 2 && (n[e] = o(t[e]));
            else n.primary = o(t);
            axIsEmpty(axLocalStorage.get("ax-theme-raw")) && axLocalStorage.set("ax-theme-raw", axGetColors()); let r = document.querySelector(":root"); for (let t in n) n.hasOwnProperty(t) && n[t].length > 2 && (r.style.setProperty(`--h-${t}`, n[t][0]), r.style.setProperty(`--s-${t}`, "string" == typeof n[t][1] && n[t][1].includes("%") ? n[t][1] : n[t][1] + "%"), r.style.setProperty(`--l-${t}`, "string" == typeof n[t][2] && n[t][2].includes("%") ? n[t][2] : n[t][2] + "%"), r.style.setProperty(`--a-${t}`, n[t][3]));
            e && axLocalStorage.set(e, n) }, get: () => axGetColors(), reset: () => {} };
axTheme.reset = (() => { let t = axLocalStorage.get("ax-theme-raw");
    axTheme.set(t) });
const axGetScrollObj = () => navigator.userAgent.indexOf("Firefox") > 0 ? { event: "DOMMouseScroll", detail: "detail" } : { event: "mousewheel", detail: "wheelDelta" },
    axGetClientObj = t => { let e = axIsMobi() ? t.targetTouches[0] : t; return e ? { x: e.clientX, y: e.clientY } : null },
    axIsScrollUp = (t, e = axGetScrollObj().detail) => { let s, i = t[e]; return s = navigator.userAgent.indexOf("Firefox") > 0 ? i > 0 : i < 0, s },
    axIsVnode = t => !getComputedStyle(t).display,
    axNumber = (t, e) => { let s = Object.assign({ places: 2, mode: "round", zero: !1 }, e),
            i = 0; if (!t || !Number(t)) return 0; { let e = Number(t),
                o = e + Number.EPSILON,
                a = Number(`1${"0".repeat(s.places)}`),
                n = e * a,
                r = o * a;
            i = "floor" === s.mode ? Math.floor(n) / a : "ceil" === s.mode ? Math.ceil(n) / a : Math.round(r) / a } return s.zero && (i = i.toFixed(s.places)), i },
    axTrim = (t, e = !1) => e ? t.replace(/\s+/g, "") : t.trim().replace(/\s+/gi, " "),
    axSplitToArr = (t, e = ",", s = "all") => { let i = axType(t),
            o = "",
            a = []; return "String" === i ? (o = "one" === s ? axTrim(t, !1) : "none" === s ? axTrim(t, !0) : t.trim(), a = o.split(e)) : "Array" === i && (a = t), a },
    axPreventDefault = t => { t.preventDefault ? t.preventDefault() : t.returnValue = !1 },
    axStrEnd = (t, e, s = "afterend", i = !0) => { if (!t || !e) return !1; if (t = t.trim(), t.includes(e)) { let o, a, n = e.length; return "beforebegin" === s ? (o = t.indexOf(e), i && (o += n), a = t.substring(0, o)) : "afterbegin" === s ? (o = t.indexOf(e), !i && (o += n), a = t.substring(o, t.length)) : "beforeend" === s ? (o = t.lastIndexOf(e), i && (o += n), a = t.substring(0, o)) : "afterend" === s ? (o = t.lastIndexOf(e), !i && (o += n), a = t.substring(o, t.length)) : a = "", a } return "" },
    axStrType = t => { if ("string" != typeof t) return console.error("Argument must be a string!"), !1;
        t = t.trim(); let e = t => { if (t >= "A" && t <= "Z") return !0 },
            s = ""; return t && (t.includes(" ") ? s = "level" : t.startsWith("#") ? s = "id" : t.startsWith(".") ? s = "class" : t.startsWith("[") && t.endsWith("]") ? s = "name" : (["H1", "H2", "H3", "H4", "H5", "H6"].includes(t) || [...t].every(t => e(t))) && (s = "node")), s },
    axStrToDom = t => { if ("string" != typeof t) return !1; let e; return t = t.trim(), t.startsWith("<tr") || t.endsWith("</tr>") ? (e = document.createElement("tr"), e.innerHTML = t, e) : (e = document.createElement("div"), e.innerHTML = t, e.firstElementChild) },
    axIdToDom = t => { let e = axType(t); if (t) { if ("String" === e) { let e = t.trim(); return axStrType(e) ? ("name" !== axStrType(e) || e.includes("=") || (e = e.slice(0, 1) + "name=" + e.slice(1)), document.querySelector(e)) : (console.warn("No node is found with this string!"), !1) } return !!e.includes("HTML") && t } return console.warn("Node selector is empty!"), !1 },
    axAllToDoms = t => { if (axIsEmpty(t)) return []; let e = [],
            s = axType(t); if (s.includes("HTML")) e.push(t);
        else if ("String" === s) { let s = axTrim(t),
                i = ",";
            s.includes(" ") && (i = " "), s.split(i).forEach(t => { let s = axIdToDom(t);
                s && e.push(s) }) } else "Array" === s ? t.forEach(t => { let s = axIdToDom(t);
            s && e.push(s) }) : "NodeList" === s && (e = [...t]); return e },
    axValueToArr = t => { let e = []; if (!axIsEmpty(t) || 0 === t)
            if (Array.isArray(t)) e = t;
            else if ("string" == typeof t) { let s = t.trim(),
                i = t.includes(",") ? "," : " ";
            s.includes(i) ? e = s.split(i) : e.push(t) } else e.push(t); return e },
    axUnique = (t, e) => { if (e) { let s = new Map; for (let i of t) s.has(i[e]) || s.set(i[e], i); return [...s.values()] } return [...new Set(t)] },
    axClass = { get: function(t) { return axValueToArr(t) }, add: function(t, e, s) { let i = axIdToDom(t),
                o = this.get(e); return !(!i || 0 === o.length) && (o.forEach(t => { let e = !s || s(t);
                e && i.classList.add(t) }), this) }, del: function(t, e, s) { let i = axIdToDom(t),
                o = this.get(e); return !(!i || 0 === o.length) && (o.forEach(t => { let e = !s || s(t);
                e && i.classList.remove(t) }), this) } },
    axArrToDom = (t, e) => { let s = t.split(","),
            i = [],
            o = /^[0-9]*$/,
            a = ""; return a = "string" == typeof e ? document.querySelector(e) : e, s.forEach(t => { if (!o.test(t.substr(0, 1)))
                if ("class" == axStrType(t)) i = a ? i.concat([...a.querySelectorAll(t)]) : i.concat([...document.querySelectorAll(t)]);
                else if ("id" == axStrType(t)) i.push(document.querySelector(t));
            else { if (!t) return i; { let e = document.querySelectorAll(t);
                    e && (i = a ? i.concat([...a.querySelectorAll(t)]) : i.concat([...document.querySelectorAll(t)])) } } }), i },
    axArrToFlat = t => { let e = [],
            s = [...t]; return s.forEach(t => { t.children ? e = [...e, t, ...axArrToFlat(t.children)] : e.push(t) }), e },
    axIncreaseId = (t, e = !0) => { let s, i = []; return e ? (t.forEach(t => { i.push(~~t.id) }), s = Math.max(...i) + 1) : s = t.length, s },
    axMultiValues = (t, e = "checkbox", s = "array", i, o = ",") => { let a, n = [],
            r = i ? axIdToDom(i) : ""; if ("NodeList" == axType(t) || "Array" == axType(t)) { if (e.includes("select") || "file" == e) return console.warn("Can not be an node array in this type!"), !1;
            a = t } else if ("object" == typeof t || axStrType(t) && "name" !== axStrType(t)) { let s = axIdToDom(t);
            e.includes("select") || "SELECT" == t.nodeName ? (e = "select", a = s.options) : "file" == e || "file" == s.type ? (e = "file", a = [s]) : a = [...s.querySelectorAll("input")] } else { let s = "";
            s = "name" === axStrType(t) ? t.replace("[", "[name=") : `[name=${t}]`, a = e.includes("select") ? r ? r.querySelector(s).options : document.querySelector(s).options : "file" == e ? r ? [r.querySelector(s)] : [document.querySelector(s)] : r ? [...r.querySelectorAll(s)] : [...document.querySelectorAll(s)] } for (let t = 0; t < a.length; t++) { let s, i = a[t];
            s = e.includes("select") ? i.selected : i.checked, "file" == e ? n = [...i.files] : s && n.push(i.value) } return "string" == s && (n = n.join(o)), n },
    axDebounce = (t, e = 200, s = !1) => { let i = null,
            o = function(o) { s && (o.stopPropagation(), o.preventDefault()), i && clearTimeout(i), i = setTimeout(() => { t.apply(this, arguments) }, e) }; return o.cancel = function() { i && clearTimeout(i) }, o },
    axThrottle = (t, e = 500, s = !1) => { let i = 0,
            o = null,
            a = function(a) { let n = (new Date).getTime();
                n - i > e ? (o && (clearTimeout(o), o = null), t.apply(this, arguments), i = n) : s && (a.stopPropagation(), a.preventDefault()) }; return a.cancel = function() { clearTimeout(o), o = null }, a },
    axMoveArr = (t, e, s) => { if (e > t.length || s > t.length || e < 0 || s < 0) return console.error("Exceeded array length!"), !1; let i = t[e]; return t.splice(e, 1), t.splice(s, 0, i), t },
    axIsVisible = t => { let e = axIdToDom(t),
            s = !0,
            i = "none" != getComputedStyle(e).display && "hidden" != getComputedStyle(e).visibility; for (; s && i;) e = e.parentNode, e && e != document.body ? i = "none" != getComputedStyle(e).display && "hidden" != getComputedStyle(e).visibility : s = !1; return i },
    axClampValue = (t = { value: value, min: min, max: max }) => t.hasOwnProperty("min") && t.hasOwnProperty("max") ? (t.value = axToNumber(t.value), t.min = axToNumber(t.min), t.max = axToNumber(t.max), t.value > t.max ? t.max : t.value < t.min ? t.min : t.value) : (console.error("Must include max and min properties!"), !1),
    axChildVisible = (t, e) => { let s = axIdToDom(e),
            i = axIdToDom(t),
            o = s.scrollTop,
            a = s.getBoundingClientRect().height; return i.offsetTop + i.offsetHeight > o && i.offsetTop < o + a },
    axUlToArr = (t, e = 0, s = !0) => { let i = axIdToDom(t),
            o = e; if (!t) return console.error(axError.notExist), !1; let a = () => { let t = []; return [...i.children].forEach(e => { t.push(r(e, o++)) }), t },
            n = (t, e) => { let s = [...t.attributes].filter(t => "label" !== t.name && "value" !== t.name);
                s.forEach(t => {
                    ["selected", "disabled", "readonly", "active", "checked", "expanded"].includes(t.name) ? e[t.name] = !0 : e[t.name] = t.value.trim() }) },
            r = (t, e) => { let i = t.firstElementChild,
                    a = { id: e, node: i };
                a.label = i.textContent.trim(), s ? a.value = i.hasAttribute("value") ? i.getAttribute("value") : a.label : i.hasAttribute("value") && (a.value = i.getAttribute("value")), n(i, a); let l = t.querySelector("ul") || t.querySelector("ol"); return l && (a.children = [], [...l.children].forEach(t => { a.children.push(r(t, o++)) })), a }; return { data: a(), index: o } },
    axSelectToArr = (t, e = 0, s = !0) => { let i = axIdToDom(t),
            o = e; if (!i) return console.error(axError.notExist), !1; let a = () => { let t = []; return [...i.children].forEach(e => { t.push(r(e, o++)) }), t },
            n = (t, e) => { let s = [...t.attributes].filter(t => "label" !== t.name && "value" !== t.name);
                s.forEach(t => {
                    ["selected", "disabled", "readonly", "active", "checked", "expanded"].includes(t.name) ? e[t.name] = !0 : e[t.name] = t.value.trim() }) },
            r = (t, e) => { let i = { id: e, node: t },
                    a = t.textContent.trim(),
                    l = t.hasAttribute("value") ? t.getAttribute("value").trim() : ""; return n(t, i), "OPTGROUP" == t.nodeName ? (i.label = t.getAttribute("label").trim(), i.value = i.label, i.children = [], [...t.children].forEach(t => { i.children.push(r(t, o++)) })) : (i.label = a || l.trim(), i.value = s ? l || i.label : l), i }; return { data: a(), index: o } },
    axTableToJson = t => { let e = axIdToDom(t),
            s = e.querySelector("tbody"),
            i = s.rows,
            o = []; return [...i].forEach(t => { let e = t.cells,
                s = [];
            [...e].forEach(t => { s.push(t.innerText.trim()) }), o.push(s) }), o },
    axArrToTree = t => { let e = t[0].pId; return t.forEach(e => { let s = t.filter(t => e.id == t.pId);
            s.length && (e.children = s) }), t.filter(t => t.pId == e) },
    axGetDoms = t => { let e = axType(t),
            s = [],
            i = t => { let e, s = axType(t); return "String" === s && axStrType(t) ? e = [...this.targetDom.querySelectorAll(t)] : s.includes("HTML") && (e = [t]), e }; return s = "Array" === e ? t.map(t => i(t)).flat(1 / 0) : i(t), s.filter(Boolean) },
    axFindItem = (t, e, s) => { let i, o = axType(t),
            a = Object.assign({ string: "label", number: "id", dom: "headerDom" }, s),
            n = (t, e) => { let s = Object.keys(t),
                    i = e.find(e => { let i = !0; for (let o of s)
                            if (e[o] != t[o]) { i = !1; break }
                        return i }); return i }; return i = "Object" === o ? e.find(e => e === t) || n(t, e) : "Array" === o ? e.find(e => e === t) : "Number" === o ? e[0].hasOwnProperty(a.number) ? e.find(e => String(e[a.number]) === String(t)) : e[t] : "String" === o ? t.startsWith("#") ? e.find(e => "#" + e[a.dom].id === t) : e.find(e => String(e[a.number]) === t || String(e[a.string]) === t) : !!o.includes("HTML") && e.find(e => e[a.dom] === t), i },
    axTreeMethod = { addPath: (t, e = -1, s = 0) => { if (!Array.isArray(t) || 0 === t.length) return !1; let i = 0,
                o = 0,
                a = !!t[0].hasOwnProperty("id"),
                n = s,
                r = (t, s, l = e) => { t.forEach(t => { a || (t.id = n, n++), t.floor = s, t.pId = t.pId || 0 === t.pId ? t.pId : e, t.path = l.toString() + ">" + t.id.toString(), s >= i && (i = s), isNaN(t.id) || t.id >= o && (o = t.id), t.children && t.children.length > 0 && (t.children.forEach(e => { e.pId = t.id }), r(t.children, s + 1, t.path)), t.path || (t.path = t.pId + ">" + t.id) }) }; return r(t, 1), { data: t, floorMax: i, idMax: o } }, remove: (t, e, s, i) => { if (1 !== t.floor) { let s = e.find(e => e.id == t.pId),
                    i = s.children,
                    o = i.indexOf(t);
                i.splice(o, 1) } else s && (s = s.filter(e => e != t)); return e = e.filter(e => e !== t && !e.path.includes(">" + t.id + ">")), t.wrapperDom.remove(), i && i(t, e), { flat: e, tree: s } }, createData: (t, e, s, i) => { let o = {},
                a = axType(t),
                n = axIncreaseId(s),
                r = "String" === a ? t : "新节点" + n; if ("Object" === a) { let s = i ? { path: e.path + ">" + t.id, floor: e.floor + 1 } : { path: e.path.replace(new RegExp("(.*)" + e.id), "$1" + t.id), floor: e.floor };!t.hasOwnProperty("id") && (t.id = n), o = Object.assign(t, s) } else o = i ? { id: n, label: r, pId: e.id, path: e.path + ">" + n, floor: e.floor + 1 } : { id: n, label: r, pId: e.pId, path: e.path.replace(new RegExp("(.*)" + e.id), "$1" + n), floor: e.floor }; return o }, existChildPush: (t, e, s = !0) => { s ? (e.children.unshift(t), e.bodyDom.insertAdjacentElement("afterBegin", t.wrapperDom)) : (e.children.push(t), e.bodyDom.insertAdjacentElement("beforeEnd", t.wrapperDom)) }, noExistChildPush: (t, e, s) => { e.children = [], e.children.push(t), e = s(e), e.bodyDom.appendChild(t.wrapperDom), e.wrapperDom.appendChild(e.bodyDom) }, getItemsFromPath(t) { let e = Object.assign({ connector: "/", prop: "label" }, t),
                s = e.path.split(">"),
                i = s.map(t => e.data.find(e => e.id == t)).filter(Boolean),
                o = i.map(t => t[e.prop]).join(e.connector); return { items: i, path: o } }, getFullData: async function(t = {}) { if (axIsEmpty(t.source)) return !1; let e = axType(t.source),
                s = Object.assign({ idStart: 0, rootStart: -1, replace: !1, ajaxData: {}, ajaxType: "post", async: !1, addPath: !0 }, t),
                i = [],
                o = {},
                a = t => { let e = t.nodeName,
                        i = []; return "SELECT" === e || "DATALIST" === e ? i = axSelectToArr(t, s.idStart, s.replace).data : "UL" !== e && "OL" !== e || (i = axUlToArr(t, s.idStart, s.replace).data), i },
                n = t => { let e = [],
                        s = axClone(t); return e = s[0].hasOwnProperty("pId") && s[0].hasOwnProperty("id") ? axArrToTree(s) : s, e }; if (!axIsEmpty(s.ajaxData) && (s.async = !0), s.async) { let t = s.source.loadDom ? axIdToDom(s.source.loadDom) : null;
                await axAjax({ url: s.source, data: axIsEmpty(s.ajaxData) ? "" : s.ajaxData, type: s.ajaxType, opened: t => { s.opened ? s.opened(t) : s.instance && s.xhrName && (s.instance[s.xhrName] = t.xhr) }, before: e => { s.before ? s.before(e) : t && t.setAttribute("loading", "") }, success: e => { if (axIsEmpty(e.content)) return console.warn("No data obtained!"), !1;
                        t && t.hasAttribute("loading") && t.removeAttribute("loading"), s.success && s.success(e), i = n(e.content) } }) } else e.includes("HTML") ? i = a(s.source) : "String" === e ? axStrType(s.source) && (i = a(axIdToDom(s.source))) : "Array" === e && (i = n(s.source)); return o = s.addPath ? this.addPath(i, s.rootStart, s.idStart) : i, s.callback && s.callback(o), o } },
    axDateMethod = { toSlash: function(t) { return t.replace("-", "/") }, toDate: function(t, e) { let s, i = axType(t); return "Date" === i ? s = new Date(t.valueOf()) : "String" === i ? s = new Date(this.toSlash(t)) : "Object" === i ? (s = new Date, t.hasOwnProperty("YYYY") && s.setFullYear(t.YYYY), t.hasOwnProperty("MM") && s.setMonth(t.MM), t.hasOwnProperty("DD") && s.setDate(t.DD), t.hasOwnProperty("hh") && s.setHours(t.hh), t.hasOwnProperty("mm") && s.setMinutes(t.mm), t.hasOwnProperty("ss") && s.setSeconds(t.ss)) : s = new Date, "date" === e ? (s.setHours(0), s.setMinutes(0), s.setSeconds(0)) : "month" === e ? (s.setDate(1), s.setHours(0), s.setMinutes(0), s.setSeconds(0)) : "year" === e && (s.setMonth(0), s.setDate(1), s.setHours(0), s.setMinutes(0), s.setSeconds(0)), s }, toObj: function(t, e = !1, s) { let i, o = axType(t),
                a = ""; if ("Object" === o) a = t;
            else if ("String" === o && !t.trim().includes(" ") && t.includes(":")) { let e = t.split(":");
                a = { hh: ~~e[0], mm: ~~e[1], ss: ~~e[2] } } else i = this.toDate(t), a = { YYYY: i.getFullYear(), MM: i.getMonth(), DD: i.getDate(), hh: i.getHours(), mm: i.getMinutes(), ss: i.getSeconds() }; return e && (!a.hasOwnProperty("hh") && (a.hh = 0), !a.hasOwnProperty("mm") && (a.mm = 0), !a.hasOwnProperty("ss") && (a.ss = 0)), "year" === s ? (Reflect.deleteProperty(a, "MM"), Reflect.deleteProperty(a, "DD"), Reflect.deleteProperty(a, "hh"), Reflect.deleteProperty(a, "mm"), Reflect.deleteProperty(a, "ss")) : "month" === s ? (Reflect.deleteProperty(a, "DD"), Reflect.deleteProperty(a, "hh"), Reflect.deleteProperty(a, "mm"), Reflect.deleteProperty(a, "ss")) : "date" === s && (Reflect.deleteProperty(a, "hh"), Reflect.deleteProperty(a, "mm"), Reflect.deleteProperty(a, "ss")), a }, strToTimeObj: function(t) { t = t.replace(" ", ""); let e = t.split(":"); return { hh: ~~e[0] || 0, mm: ~~e[1] || 0, ss: ~~e[2] || 0 } }, getDays: function(t) { let e = this.toDate(t),
                s = e.getFullYear(),
                i = e.getMonth(); return new Date(s, i + 1, 0).getDate() }, getChain: function(t, e = { YYYY: 0, MM: 0, DD: 0, hh: 0, mm: 0, ss: 0 }) { let s = this.toDate(t); return e.hasOwnProperty("ss") && s.setDate(s.getSeconds() + e.ss), e.hasOwnProperty("mm") && s.setDate(s.getMinutes() + e.mm), e.hasOwnProperty("hh") && s.setDate(s.getHours() + e.hh), e.hasOwnProperty("DD") && s.setDate(s.getDate() + e.DD), e.hasOwnProperty("MM") && s.setMonth(s.getMonth() + e.MM), e.hasOwnProperty("YYYY") && s.setFullYear(s.getFullYear() + e.YYYY), s }, fillZero: function(t) { let e = ~~t; return e < 10 ? "0" + e : e }, fillFormat: function(t, e) { let s, i, o, a, n, r, l, h = ["日", "一", "二", "三", "四", "五", "六"]; return t instanceof Date ? (s = t.getFullYear(), i = t.getMonth() + 1, o = t.getDate(), a = t.getHours(), n = t.getMinutes(), r = t.getSeconds(), l = t.getDay()) : (s = t.YYYY, i = t.MM + 1, o = t.DD, a = t.hh, n = t.mm, r = t.ss, t.hasOwnProperty("DD") && (l = new Date(t.YYYY, t.MM, t.DD).getDay())), e.includes("YYYY") && (e = e.replace("YYYY", s)), e.includes("MM") && (e = e.replace("MM", this.fillZero(i))), e.includes("DD") && (e = e.replace("DD", this.fillZero(o))), e.includes("hh") && (e = e.replace("hh", this.fillZero(a))), e.includes("mm") && (e = e.replace("mm", this.fillZero(n))), e.includes("ss") && (e = e.replace("ss", this.fillZero(r))), e.includes("WW") && void 0 !== l && (e = e.replace("WW", h[l])), e }, sort: function(t) { return t.sort((t, e) => this.toDate(t) - this.toDate(e)) }, trim: function(t) { return t.trim().replace(/\s+/gi, " ") }, getType: function(t) { let e = ""; return RegExp(/^(?=.*YYYY)(?=.*MM)(?=.*DD)(?=.*hh).*$/).test(t) ? e = "datetime" : RegExp(/^(?=.*YYYY)(?=.*MM)(?=.*DD).*$/).test(t) ? e = "date" : RegExp(/^(?=.*YYYY)(?=.*MM).*$/).test(t) ? e = "month" : RegExp(/^(?=.*YYYY).*$/).test(t) ? e = "year" : RegExp(/^(?=.*hh).*$/).test(t) && (e = "time"), e }, isSameDay: function(t, e) { let s = {...t },
                i = {...e }; return Reflect.deleteProperty(s, "hh"), Reflect.deleteProperty(s, "mm"), Reflect.deleteProperty(s, "ss"), Reflect.deleteProperty(i, "hh"), Reflect.deleteProperty(i, "mm"), Reflect.deleteProperty(i, "ss"), JSON.stringify(s) == JSON.stringify(i) } },
    axIsOutside = (t, e, s, i) => { if (!e) return !0; let o = axIdToDom(e); if (!o) return !0; let a, n, r, l, h = t.clientX,
            d = t.clientY; return a = s || o.getBoundingClientRect().left, n = i || o.getBoundingClientRect().top, r = a + o.offsetWidth, l = n + o.offsetHeight, h < a || h > r || d < n || d > l },
    axStyle = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t); return document.defaultView.getComputedStyle(s, e) },
    axListenAnimation = (t = { duration: duration, doing: doing, done: done }) => { if (!t.duration) return !1; let e = (new Date).getTime() + t.duration,
            s = () => { let i, o = (new Date).getTime();
                o >= e ? (t.done && t.done(s), i && cancelAnimationFrame(s)) : (t.doing && t.doing(s), i = requestAnimationFrame(s)) }; return s(), s },
    axGetStyleTransform = (t, e = ["translate", "scale", "rotate", "skew"], s = !1) => { let i = axIdToDom(t),
            o = axStyle(i),
            a = i.style.transform,
            n = { rotate: 0, scale: { x: 1, y: 1 }, translate: { x: 0, y: 0 }, skew: { x: 0, y: 0 } }; if (a) { let t = t => new RegExp(`${t}\\(([^\\)]+)\\)`),
                s = e => a.match(t(e)); if (e.includes("translate") && a.includes("translate") && s("translate"))
                if (s("translate")[1].includes(",")) { let t = s("translate")[1].split(",").map(t => parseInt(t));
                    n.translate = { x: t[0], y: t[1] } } else n.translate = { x: parseInt(s("translate")[1]), y: 0 };
            if (e.includes("scale") && a.includes("scale") && s("scale"))
                if (s("scale")[1].includes(",")) { let t = s("scale")[1].split(",").map(t => parseFloat(t));
                    n.scale = { x: t[0], y: t[1] } } else n.scale = { x: parseFloat(s("scale")[1]), y: parseFloat(s("scale")[1]) };
            if (e.includes("rotate") && a.includes("rotate") && s("rotate") && (n.rotate = parseFloat(s("rotate")[1])), e.includes("skew") && a.includes("skew") && s("skew"))
                if (s("skew")[1].includes(",")) { let t = s("skew")[1].split(",").map(t => parseFloat(t));
                    n.skew = { x: t[0], y: t[1] } } else n.skew = { x: parseFloat(s("skew")[1]), y: 0 } } return s && (n.translate = { x: parseInt(o.left), y: parseInt(o.top) }), n },
    axSetStyleTransform = (t, e, s = !1) => { let i = axIdToDom(t),
            o = i.style.transform,
            a = t => new RegExp(`${t}\\(([^\\)]+)\\)`, "gmi"); if (axIsEmpty(e)) return !1; for (let t in e)
            if (e.hasOwnProperty(t)) { let n = ""; "translate" === t ? s ? isNaN(e[t]) ? (i.style.left = `${e[t].x}px`, i.style.top = `${e[t].y}px`) : i.style.left = `${e[t]}px` : (n = isNaN(e[t]) ? `${t}(${e[t].x}px,${e[t].y}px)` : `${t}(${e[t]}px)`, o.includes(t) ? o.startsWith("translate") ? o = o.replace(a(t), n) : (o = o.replace(a(t), ""), o = `${n} ${o}`) : o = `${n} ${o}`) : ("scale" === t ? n = isNaN(e[t]) ? `${t}(${e[t].x},${e[t].y})` : `${t}(${e[t]})` : "rotate" === t ? n = `${t}(${e[t]}deg)` : "skew" === t && (n = isNaN(e[t]) ? `${t}(${e[t].x}deg,${e[t].y}deg)` : `${t}(${e[t]}deg)`), o.includes(t) ? o = o.replace(a(t), n) : o += ` ${n}`) }
        return i.style.transform = o, o },
    axTplEngine = (t, e) => { if (!t) return console.error("No html!"), !1; let s, i = /<#([^#>]+)?#>/g,
            o = /(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g,
            a = "let r=[];\n",
            n = 0,
            r = (t, e) => (a += e ? t.match(o) ? t + "\n" : "r.push(" + t + ");\n" : "" != t ? 'r.push("' + t.replace(/"/g, '\\"') + '");\n' : "", r); for (; s = i.exec(t);) r(t.slice(n, s.index))(s[1], !0), n = s.index + s[0].length; return r(t.substr(n, t.length - n)), a += 'return r.join("");', new Function(a.replace(/[\r\t\n]/g, "")).apply(e) },
    axClone = t => { let e = t => { if (null === t) return null; if ("object" != typeof t) return t; if (t.constructor === Date) return new Date(t); { let e = {}; for (let s in t)
                    if (null == t[s]) e[s] = null;
                    else if ("object" != typeof t[s] || t[s].nodeType) e[s] = t[s];
                else if (e[s] = axClone(t[s]), t[s] instanceof Array) { let i = []; for (let e of t[s]) i.push(axClone(e));
                    e[s] = i } return e } }; return Array.isArray(t) ? t.map(t => e(t)) : e(t) },
    axMerge = (t, e, s = { arrAppend: !1, clone: !1, attrAppend: !0 }) => { if ("object" != typeof t || "object" != typeof e) return e; if (!e) return t; let i = s.copy ? axClone(t) : t; for (let t in e) e.hasOwnProperty(t) && i.hasOwnProperty(t) ? i[t] ? "Array" != axType(e[t]) ? i[t] = axMerge(i[t], e[t], s) : s.arrAppend ? i[t].push(...e[t]) : i[t] = e[t] : i[t] = e[t] : e.hasOwnProperty(t) && !i.hasOwnProperty(t) && s.attrAppend && (i[t] = e[t]); return i },
    axStrToArr = (t, e, s) => { let i = [],
            o = {}; return axIsEmpty(e) || e.forEach((t, e) => { o[t] = axIsEmpty(s) ? "" : s[e] }), "[" == t.substr(0, 1) && "]" == t.substr(-1) ? i = JSON.parse(t) : -1 != t.replace(/\s*/g, "").indexOf("},{") ? i = JSON.parse("[" + t + "]") : "{" == t.replace(/\s*/g, "").substr(0, 1) && "}" == t.replace(/\s*/g, "").substr(-1) ? i = JSON.parse("[" + t + "]") : (i = t.split(","), i.forEach((t, s) => { if (t = t.trim(), "string" == typeof t && !axIsEmpty(e)) { let o = {};
                e.forEach((e, s) => { o[e] = 0 == s ? t : "" }), i.splice(s, 1, o) } })), i.forEach(t => { if (!axIsEmpty(o))
                for (let e in o) t.hasOwnProperty(e) ? t.hasOwnProperty(e) && !t[e] && (t[e] = o[e]) : t[e] = o[e] ? o[e] : "" }), i },
    axTplToArr = (t, e, s, i, o) => { let a = axIdToDom(t),
            n = []; if (i) { let t = a.querySelectorAll(i);
            t.forEach(t => { let i = {};
                e.forEach((e, a) => { let n = t.querySelector("[" + e + "]");
                    i[s[a]] = n ? n.getAttribute(e) ? n.getAttribute(e).trim() : n.innerHTML.trim() : o[a] || "" }), n.push(i) }) } else { let t = {};
            e.forEach((e, i) => { let n = a.querySelector("[" + e + "]");
                t[s[i]] = n ? n.getAttribute(e) ? n.getAttribute(e).trim() : n.innerHTML.trim() : o[i] || "" }), n.push(t) } return n },
    axDataset = (t, e) => { let s = t ? axIdToDom(t) : null,
            i = /^\d+(\.\d+)?$/,
            o = /^(-(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$/; if (s) { let t = [...s.attributes].filter(t => 0 == t.name.indexOf("data-")); if (!axIsEmpty(t)) { let s = axClone(e),
                    a = t => { for (let e in t) { let s = e.toLowerCase();
                            t[s] = t[e], "Object" === axType(t[e]) && a(t[e]), s != e && delete t[e] } };
                a(s); for (let e = 0; e < t.length; e++) { let a = t[e].value.trim(),
                        n = t[e].name; "true" == a ? a = JSON.parse("true") : "false" == a ? a = JSON.parse("false") : "null" == a ? a = null : "[" == a.substr(0, 1) && "]" == a.substr(-1) ? a = JSON.parse(a) : -1 != a.replace(/\s*/g, "").indexOf("},{") && (a = JSON.parse("[" + a + "]")), "string" == typeof a && (i.test(a) || o.test(a)) && (a = Number(a)); let r = n.split("-");
                    r.length - 1 == 1 ? s[r[1]] = a : r.length - 1 == 2 ? s[r[1]][r[2]] = a : r.length - 1 == 3 ? s[r[1]][r[2]][r[3]] = a : console.error("Three levels are supported!") } let n = (t, e) => { for (let s in t) { let i = s.toLowerCase(); "Object" === axType(t[s]) ? n(t[s], e[i]) : t[s] = e[i] } };
                n(e, s) } } return e },
    axAttrToJson = (t, e) => { let s = axIdToDom(t); if (!s) return console.warn("The attribute node does not exist!"), {}; let i = s.getAttribute(e); if (!e || !i) return {}; if (!i.includes(":")) return {}; let o = i.trim(); return o.startsWith("{") || (o = "{" + o + "}"), new Function("return " + o)() },
    axExtend = (t, e, s, i) => { if (!t) return console.error(axError.notExist), !1; let o = s ? axIdToDom(s) : null; return axMerge(t, e), o && axMerge(t, axAttrToJson(o, i)), t },
    axAddPlan = (t, e, s) => { let i = axType(t),
            o = [],
            a = t => { s.handlers.hasOwnProperty(t) || (s.handlers[t] = []); let i = e.toString().replace(/\s/g, "").replace(/\;/g, "").match(/{(\S*)}/)[1],
                    o = s.handlers[t].toString().replace(/\s/g, "").replace(/\;/g, "");!(o.indexOf(i) > -1) && s.handlers[t].push(e) }; if ("String" === i ? o = t.includes(",") ? t.split(",") : t.split(" ") : "Array" === i && (o = t), o.length > 0)
            for (let t of o) a(t) },
    axExePlan = (t, e, ...s) => { let i = axType(t),
            o = [],
            a = t => { if (!e.handlers.hasOwnProperty(t)) return console.warn(`The ${t} event is unregistered or unusable!`);
                e.handlers[t].forEach(t => { t.call(e, ...s) }) }; if ("String" === i ? o = t.includes(",") ? t.split(",") : t.split(" ") : "Array" === i && (o = t), o.length > 0)
            for (let t of o) a(t) },
    axDelPlan = (t, e, s) => { let i = axType(t),
            o = [],
            a = t => { if (!s.handlers.hasOwnProperty(t)) return console.warn(`The ${t} event is invalid or unusable!`); if (e) { let i = s.handlers[t].findIndex(t => t === e); if (void 0 === i) return console.warn(`The ${t} event is not bound!`);
                    s.handlers[t].splice(i, 1), 0 === s.handlers[t].length && delete s.handlers[t] } else delete s.handlers[t] }; if ("String" === i ? o = t.includes(",") ? t.split(",") : t.split(" ") : "Array" === i && (o = t), o.length > 0)
            for (let t of o) a(t) },
    axAddElem = (t, e, s) => { let i = t.toLowerCase().trim(),
            o = document.createElement(i),
            a = function(t, e) { if ("" === e || null == e) return !1; "template" === i ? t.innerHTML = e : Array.isArray(e) ? e.length > 0 && e.forEach(e => { a(t, e) }) : "object" == typeof e ? t.appendChild(e) : t.insertAdjacentHTML("beforeEnd", e) }; if (e)
            for (let t in e) e.hasOwnProperty(t) && o.setAttribute(t, e[t]); return a(o, s), o },
    axStrToFilter = (t, e, s) => { let i = `source.filter(item =>${t})`,
            o = new Function("source", "return " + i)(e); return s && s(o), o },
    axRangeReplace = (t, e, s, i, o) => { "string" != typeof t && (t = JSON.stringify(t)), "string" != typeof e && (t = JSON.stringify(e)); let a = ""; return a = s || i ? i ? s ? t.substring(0, s) + e + t.substring(i) : o ? t.substring(i - o) + e + t.substring(0, s) : e + t.substring(i) : o ? t.substring(0, s) + e + t.substring(s + o) : t.substring(0, s) + e : e, a },
    axArrange = (t, e, s = 0, i = [], o = []) => { let a = t.length; if (!(s + e > a)) { for (let n = s; n < a; n++) { if (1 === e) { o.push([...i, t[n]]), n + 1 < a && axArrange(t, e, n + 1, i, o); break }
                axArrange(t, e - 1, n + 1, [...i, t[n]], o) } return o } },
    axAjax = (t, e, s) => { if (!t) return console.error("There is no options!"), !1; let i = axAddElem("SPAN", { "ajax-message": "" }),
            o = e ? axIdToDom(e) : null;
        o && o.appendChild(i); let a = { url: "", selector: "", type: "post", async: !0, data: {}, delay: 6e4, contentType: "", headers: {}, responseType: "", catchable: !1, abort: () => { o ? (i.innerHTML = '<i class="ax-color-warning">中止了请求！</i>', o.setAttribute("ajax-result", "abort")) : console.error("中止了请求！") }, timeout: () => { o ? (i.innerHTML = '<i class="ax-color-error">请求超时了！</i>', o.setAttribute("ajax-result", "timeout")) : console.error("请求超时了！") }, loading: '<span class="ax-loading"><i></i></span>', opened: "", before: t => { o && (i.innerHTML = t.content, o.setAttribute("ajax-result", "before")) }, downloading: () => {}, uploading: () => {}, success: t => { o && (o.innerHTML = t.content, o.setAttribute("ajax-result", "success")) }, error: t => { o ? (i.innerHTML = `<i class="ax-color-error">错误状态：${t.status}</i>`, o.setAttribute("ajax-result", "error")) : console.error(`错误状态：${t.status}`) } }; for (let e in t) a[e] = t[e]; let n = "";
        n = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"); let r = ""; if (!axIsEmpty(a.data))
            if ("FormData" == axType(a.data)) r = a.data;
            else if ("Object" == axType(a.data))
            if (a.contentType.includes("json")) r = JSON.stringify(a.data);
            else { for (let t in a.data) r += "&" + t + "=" + a.data[t];
                a.contentType = "application/x-www-form-urlencoded" }
        else a.data = a.data.trim(), r = a.data.startsWith("&") ? a.data.slice(1) : a.data, a.contentType = "application/x-www-form-urlencoded"; if (a.headers["Content-Type"] = a.contentType, !a.contentType.includes("urlencoded") && "get" == a.type.toLowerCase()) return console.error("Please request data with post!"), !1; let l, h = () => { for (let t in a.headers) a.headers[t] && n.setRequestHeader(t, a.headers[t]) };
        n.timeout = a.delay, n.responseType = a.responseType; let d = () => { l && n.removeEventListener("timeout", l), n.abort(), !axIsEmpty(a.abort) && a.abort(o, n) },
            p = new Promise((t, e) => { let i = (t, e) => { let s = t.loaded,
                        i = t.total,
                        a = 0,
                        n = 0,
                        r = "0%",
                        l = new Date(t.timeStamp).getTime();
                    t.lengthComputable && (a = s / i, n = Math.round(100 * a), r = n + "%", e && e({ result: r, percent: n, current: s, total: i, ratio: a, time: l, dom: o })) };
                n.upload.onprogress = (t => { i(t, t => {!axIsEmpty(a.uploading) && a.uploading(t) }) }), n.onprogress = (t => { i(t, t => {!axIsEmpty(a.downloading) && a.downloading(t) }) }), n.onerror = (t => { let s = { content: n.response, status: n.status, dom: o, xhr: n };!axIsEmpty(a.error) && a.error(s), a.catchable && e(s) }), l = (() => { let t = { content: n.response, status: n.status, dom: o, xhr: n };
                    o && o.setAttribute("ajax-result", "timeout"), !axIsEmpty(a.timeout) && a.timeout(t), a.catchable && e(t) }), n.addEventListener("timeout", l), n.onreadystatechange = function() { if (n.readyState < 4) { let t = { content: a.loading, status: n.status, dom: o, xhr: n, abort: d };
                        1 === n.readyState && !axIsEmpty(a.opened) && a.opened(t), !axIsEmpty(a.before) && a.before(t), s && s(t) } else if (n.status >= 200 && n.status < 300 || 304 == n.status)
                        if (a.responseType && "text" != n.responseType) { o && o.setAttribute("ajax-result", "success"); let e = { content: n.response, status: n.status, dom: o, xhr: n };!axIsEmpty(a.success) && a.success(e), t(e) } else { let e = document.createElement("div"),
                                s = "",
                                i = /(<head\b[^<]*(?:(?!<\/head>)<[^<]*)*<\/head>)|(<\/?html.*?>)|(<\!DOCTYPE.*?html.*?>)|(<\/?body.*?>)/gi,
                                r = axStrEnd(a.url, "#"),
                                l = a.selector || r;
                            e.innerHTML = n.responseText, l && e.querySelector(l) ? s = e.querySelector(l).innerHTML : l && !e.querySelector(l) ? (console.warn(`The node of "${l}" is not exist!`), s = n.responseText.replace(i, "").trim()) : s = "{" == n.responseText.trim().substr(0, 1) || "[" == n.responseText.trim().substr(0, 1) ? JSON.parse(n.responseText.trim()) : n.responseText.replace(i, "").trim(), o && o.setAttribute("ajax-result", "success"); let h = { content: s, status: n.status, dom: o, xhr: n };!axIsEmpty(a.success) && a.success(h), t(h) }
                    else { let t = { content: n.response, status: n.status, dom: o, xhr: n };!axIsEmpty(a.error) && a.error(t), a.catchable && e(t) } }, "get" == a.type.toLowerCase() ? (n.open("get", a.url + "?now=" + (new Date).getTime() + "&" + r, a.async), h(), n.send()) : "post" == a.type.toLowerCase() && (n.open("post", a.url, a.async), h(), n.send(r)) }); return p.xhr = n, p.abort = d, p },
    axAjaxSubmit = (t, e, s, i = { type: type, success: success, loading: loading, delay: delay, before: before, error: error, opended: opended, other: other }) => {
        if (!t) return console.error("Url is required!"), !1;
        if (!e) return console.error("Form node is required!"), !1;
        i.type = i.type || "post", i.other = i.other || {};
        let o = axIdToDom(e),
            a = s ? axIdToDom(s) : null,
            n = a ? a.innerHTML : "",
            r = i.loading || "button",
            l = Object.assign(i.other, { formClass: "ax-form-submitting", buttonClass: "ax-button-submitting", buttonText: "正在提交", overlayClass: "ax-form-overlay", overlayShowClass: "ax-show", successText: "恭喜！提交成功！", errorText: "对不起，提交失败！" }),
            h = o.querySelector(".ax-form-overlay") ? o.querySelector(".ax-form-overlay") : axAddElem("div", { class: "ax-form-overlay" });
        if (o.classList.contains(l.formClass)) return !1;
        if (a && a.classList.contains(l.buttonClass)) return !1;
        let d, p = {};
        return o.querySelectorAll("[name]").forEach(function(t) { p[t.getAttribute("name")] = t.value.trim() }), d = axAjax({
            url: t,
            data: p,
            type: i.type,
            opened: t => { i.opened && i.opened(t) },
            before: t => {
                o.classList.add(l.formClass),
                    a && a.classList.add(l.buttonClass), "button" == r && a ? (a.innerHTML = l.buttonText, a.insertAdjacentHTML("afterbegin", '<i class="ax-btn-loading"></i>')) : (h.innerHTML = t.content, h.classList.add(l.overlayClass), o.querySelector(".ax-form-overlay") || o.appendChild(h)), i.before && i.before(t)
            },
            success: t => { setTimeout(() => { o.classList.remove(l.formClass), a && a.classList.remove(l.buttonClass), "button" == r && a ? a.innerHTML = n : h.classList.remove(l.overlayClass), new axMessage({ content: l.successText, result: "success", iconShow: !0 }), i.success && i.success(t) }, 0 === i.delay ? 0 : i.delay || 1e3) },
            error: t => { "button" == r && a ? a.innerHTML = n : h.classList.remove(l.overlayClass), new axMessage({ content: l.errorText, result: "error", iconShow: !0 }), i.error && i.error(t) }
        }), d
    },
    axOffset = t => { if (!t) return console.error(axError.notExist), !1; let e, s, i = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
            o = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop,
            a = axIdToDom(t); return e = a.getBoundingClientRect().left + i, s = a.getBoundingClientRect().top + o, { left: e, top: s } },
    axWidth = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t),
            { width: i, paddingLeft: o, paddingRight: a, marginLeft: n, marginRight: r, borderLeftWidth: l, borderRightWidth: h } = getComputedStyle(s); return i = parseInt(i, 10), o = parseInt(o, 10), a = parseInt(a, 10), n = parseInt(n, 10), r = parseInt(r, 10), l = parseInt(l, 10), h = parseInt(h, 10), "inner" == e ? i + o + a : "outer" == e ? i + o + a + n + r + l + h : i },
    axHeight = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t),
            { height: i, paddingTop: o, paddingBottom: a, marginTop: n, marginBottom: r, borderTopWidth: l, borderBottomWidth: h } = getComputedStyle(s); return i = parseInt(i, 10), o = parseInt(o, 10), a = parseInt(a, 10), n = parseInt(n, 10), r = parseInt(r, 10), l = parseInt(l, 10), h = parseInt(h, 10), "inner" == e ? i + o + a : "outer" == e ? i + o + a + n + r + l + h : i },
    axArrHeight = t => { if (!t) return console.error(axError.notExist), !1; let e = axIdToDom(t),
            { height: s, paddingTop: i, paddingBottom: o, marginTop: a, marginBottom: n, borderTopWidth: r, borderBottomWidth: l } = getComputedStyle(e); return s = parseInt(s, 10), i = parseInt(i, 10), o = parseInt(o, 10), a = parseInt(a, 10), n = parseInt(n, 10), r = parseInt(r, 10), l = parseInt(l, 10), { height: s, paddingTop: i, paddingBottom: o, marginTop: a, marginBottom: n, borderTopWidth: r, borderBottomWidth: l } },
    axSelector = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t),
            i = !0; if (e) { e = String(e).replace(/\s+/g, ""), e = String(e).split(","); for (let t = 0; t < e.length; t++) { if (!e[t]) { i = !0; break } if ("class" == axStrType(e[t])) { let o = e[t].replace(".", ""); if (s.classList.contains(o)) { i = !0; break }
                    i = !1 } else if ("id" == axStrType(e[t])) { let o = e[t].replace("#", ""); if (s.getAttribute("id") == o) { i = !0; break }
                    i = !1 } else { let o = e[t].toUpperCase(); if (s.nodeName == o) { i = !0; break }
                    i = !1 } } } else i = !0; return i },
    axNot = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t),
            i = !0; if (e) { e = String(e).replace(/\s+/g, ""), e = String(e).split(","); for (let t = 0; t < e.length; t++)
                if ("class" == axStrType(e[t])) { let o = e[t].replace(".", ""); if (s.classList.contains(o)) { i = !0; break }
                    i = !1 } else if ("id" == axStrType(e[t])) { let o = e[t].replace("#", ""); if (s.getAttribute("id") == o) { i = !0; break }
                i = !1 } else if (e) { let o = e[t].toUpperCase(); if (s.nodeName == o) { i = !0; break }
                i = !1 } else i = !1 } else i = !1; return i },
    axSiblings = (t, e, s, i) => { if (!t) return console.error(axError.notExist), !1; let o = axIdToDom(t); return [...o.parentNode.children].filter(t => e ? axSelector(t, s) && !axNot(t, i) : t !== o && axSelector(t, s) && !axNot(t, i)) },
    axChildren = (t, e, s) => { if (!t) return console.error(axError.notExist), !1; let i = axIdToDom(t); return [...i.children].filter(t => axSelector(t, e) && !axNot(t, s)) },
    axParents = (t, e, s, i, o = []) => { if (!t) return console.error("No node to start!"), !1; let a = axIdToDom(t),
            n = e ? axIdToDom(e) : null; return "BODY" !== a.parentElement.nodeName ? (s && o.indexOf(a) < 0 && o.push(a), n ? (i && o.indexOf(n) < 0 && o.push(n), a.parentElement !== n ? (o.push(a.parentElement), axParents(a.parentElement, n, s, i, o)) : o) : (o.push(a.parentElement), axParents(a.parentElement, n, s, i, o))) : o },
    axCurves = { linear: t => t, easeIn: t => t * t * t, easeOut: t => (t - 1) * (t - 1) * (t - 1) + 1, easeInOut: t => t < .5 ? 2 * t * t : -2(t - 1) * (t - 1) + 1, easeOutIn: t => t < .5 ? Math.sqrt(.5 * t) : 1 - Math.sqrt(.5 * (1 - t)) },
    axSlideDown = (t, e, s, i, o = "easeOut") => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t),
            n = t => t / 3 + 250,
            r = a.style.cssText; if (e = e || "block", "none" === window.getComputedStyle(a).display) { a.style.cssText = `${r}display: ${e};`; const { height: t, paddingTop: l, paddingBottom: h, marginTop: d, marginBottom: p } = axArrHeight(a); let c;
            c = void 0 !== i && "number" == typeof i ? i : n(t), a.style.cssText = `${r}display: ${e}; padding-top: 0; padding-bottom: 0;margin-top: 0; margin-bottom: 0;`; const u = (new Date).getTime(),
                m = () => { const i = (new Date).getTime() - u,
                        n = i / c,
                        g = axCurves[o](n),
                        f = 0 + t * g,
                        x = 0 + l * g,
                        ...
                        b = 0 + d * g,
                        v = 0 + p * g;
                    i <= c && Math.ceil(f) < t ? a.style.cssText = `${r}overflow:hidden;display: ${e}; padding-top: ${x}px; padding-bottom: ${y}px;margin-top: ${b}px; margin-bottom: ${v}px; height: ${f}px` : a.style.cssText = `${r}display: ${e};`; const D = requestAnimationFrame(m);
                    (Math.ceil(f) >= t || !t) && (cancelAnimationFrame(D), s && s()) };
            m() } return a },
    axHeightDown = (t, e, s, i, o = "easeOut") => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t),
            n = t => t / 3 + 250; const r = e && e.height ? e.height : axArrHeight(a).height,
            l = e && e.paddingTop ? e.paddingTop : axArrHeight(a).paddingTop,
            h = e && e.paddingBottom ? e.paddingBottom : axArrHeight(a).paddingBottom,
            d = e && e.marginTop ? e.marginTop : axArrHeight(a).marginTop,
            p = e && e.marginBottom ? e.marginBottom : axArrHeight(a).marginBottom; let c;
        c = void 0 !== i && "number" == typeof i ? i : n(r), a.style.overflow = "hidden", a.style.height = 0, l && (a.style.paddingTop = 0), h && (a.style.paddingBottom = 0), d && (a.style.marginTop = 0), p && (a.style.marginBottom = 0); const u = (new Date).getTime(),
            m = () => { const t = (new Date).getTime() - u,
                    e = t / c,
                    i = axCurves[o](e),
                    n = 0 + r * i,
                    g = 0 + l * i,
                    ...
                    x = 0 + d * i,
                    y = 0 + p * i;
                t <= c && Math.ceil(n) < r ? (a.style.height = n + "px", l && (a.style.paddingTop = g + "px"), h && (a.style.paddingBottom = f + "px"), d && (a.style.marginTop = x + "px"), p && (a.style.marginBottom = y + "px")) : (a.style.height = r + "px", l && (a.style.paddingTop = l + "px"), h && (a.style.paddingBottom = h + "px"), d && (a.style.marginTop = d + "px"), p && (a.style.marginBottom = p + "px")); const b = requestAnimationFrame(m);
                (Math.ceil(n) >= r || !r) && (cancelAnimationFrame(b), s && s()) }; return m(), a },
    axSlideUp = (t, e, s, i, o = "easeOut") => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t),
            n = t => t / 3 + 250,
            r = a.style.cssText; if (e = e || "block", "none" !== window.getComputedStyle(a).display) { const { height: t, paddingTop: l, paddingBottom: h, marginTop: d, marginBottom: p } = axArrHeight(a); let c;
            c = void 0 !== i && "number" == typeof i ? i : n(t), a.style.cssText = `${r}display: ${e}; padding-top: 0; padding-bottom: 0;margin-top: 0; margin-bottom: 0;`; const u = (new Date).getTime(),
                m = () => { const i = (new Date).getTime() - u,
                        n = i / c,
                        g = axCurves[o](n),
                        ...
                        b = d + -d * g,
                        v = p + -p * g;
                    i <= c && Math.floor(f) > 0 ? a.style.cssText = `${r}overflow:hidden;display: ${e}; padding-top: ${x}px; padding-bottom: ${y}px;margin-top: ${b}px; margin-bottom: ${v}px; height: ${f}px` : a.style.cssText = `${r}display: none`; const D = requestAnimationFrame(m);
                    (Math.floor(f) <= 0 || !t) && (cancelAnimationFrame(D), s && s()) };
            m() } return a },
    axHeightUp = (t, e, s, i, o = "easeOut") => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t),
            n = t => t / 3 + 250; const r = e && e.height ? e.height : axArrHeight(a).height,
            l = e && e.paddingTop ? e.paddingTop : axArrHeight(a).paddingTop,
            h = e && e.paddingBottom ? e.paddingBottom : axArrHeight(a).paddingBottom,
            d = e && e.marginTop ? e.marginTop : axArrHeight(a).marginTop,
            p = e && e.marginBottom ? e.marginBottom : axArrHeight(a).marginBottom; let c;
        c = void 0 !== i && "number" == typeof i ? i : n(r), a.style.overflow = "hidden"; const u = (new Date).getTime(),
            m = () => { const t = (new Date).getTime() - u,
                    e = t / c,
                    i = axCurves[o](e),
                    n = r + -r * i,
                    ...
                    x = d + -d * i,
                    y = p + -p * i;
                t <= c && Math.floor(n) > 0 ? (a.style.height = n + "px", l && (a.style.paddingTop = g + "px"), h && (a.style.paddingBottom = f + "px"), d && (a.style.marginTop = x + "px"), p && (a.style.marginBottom = y + "px")) : (a.style.height = 0, l && (a.style.paddingTop = 0), h && (a.style.paddingBottom = 0), d && (a.style.marginTop = 0), p && (a.style.marginBottom = 0)); const b = requestAnimationFrame(m);
                (Math.floor(n) <= 0 || !r) && (cancelAnimationFrame(b), s && s()) }; return m(), a },
    axSlideToggle = (t, e, s, i, o, a = "easeOut") => { if (!t) return console.error(axError.notExist), !1; let n = axIdToDom(t); return e = e || "block", "none" === window.getComputedStyle(n).display ? axSlideDown(n, e, s, o, a) : axSlideUp(n, e, i, o, a), n },
    axFadeIn = (t, e, s, i = 200, o = "linear") => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t); if (e = e || "block", a) { let t = window.getComputedStyle(a).display,
                s = window.getComputedStyle(a).opacity; if ("none" === t) { a.style.display = e, a.style.opacity = 0; let t = (new Date).getTime(),
                    s = () => { let e = (new Date).getTime() - t,
                            n = e / i,
                            r = axCurves[o](n);
                        a.style.opacity = e <= i && r <= 1 ? r : 1; let l = requestAnimationFrame(s);
                        r >= 1 && cancelAnimationFrame(l) };
                s() } else if ("none" !== t && 1 !== Number(s)) { let t = (new Date).getTime(),
                    e = () => { let n = (new Date).getTime() - t,
                            r = n / i,
                            l = axCurves[o](r) + Number(s);
                        a.style.opacity = n <= i && l <= 1 ? l : 1; let h = requestAnimationFrame(e);
                        l >= 1 && cancelAnimationFrame(h) };
                e() } } return s && s(), a },
    axFadeOut = (t, e, s = 200, i = "linear") => { if (!t) return console.error(axError.notExist), !1; let o = axIdToDom(t); if (o) { let t = window.getComputedStyle(o).display,
                e = window.getComputedStyle(o).opacity; if ("none" !== t || 0 !== Number(e)) { o.style.opacity = e; let t = (new Date).getTime(),
                    a = () => { let n = (new Date).getTime() - t,
                            r = n / s,
                            l = Number(e) - axCurves[i](r);
                        n <= s && l > 0 ? o.style.opacity = l : (o.style.opacity = 0, o.style.display = "none"); let h = requestAnimationFrame(a);
                        l <= 0 && cancelAnimationFrame(h) };
                a() } } return e && e(), o },
    axFadeToggle = (t, e, s, i, o = 200, a = "linear") => { if (!t) return console.error(axError.notExist), !1; let n = axIdToDom(t); if (n) { let t = window.getComputedStyle(n).display,
                r = window.getComputedStyle(n).opacity; "none" === t ? axFadeIn(n, e, s, o, a) : Number(r) <= .5 ? axFadeIn(n, e, s, o, a) : (Number(r), axFadeOut(n, i, o, a)) } return n },
    axShow = (t, e, s) => { if (!t) return console.error(axError.notExist), !1; let i = axIdToDom(t); "visible" == e ? i.style.visibility = "visible" : i.style.display = e || "block", s && s() },
    axHide = (t, e, s) => { if (!t) return console.error(axError.notExist), !1; let i = axIdToDom(t); "hidden" == e ? i.style.visibility = "hidden" : i.style.display = "none", s && s() },
    axToggle = (t, e, s, i, o) => { if (!t) return console.error(axError.notExist), !1; let a = axIdToDom(t);
        axIsVisible(a) ? axHide(a, s, o) : axShow(a, e, i) },
    axScrollTo = (t, e = {}) => { let s, i = e.parent ? axIdToDom(e.parent) : null,
            o = i || window,
            a = ~~e.offset || 0,
            n = e.curve || "easeOut",
            r = "number" == typeof t ? "" : axIdToDom(t),
            l = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop,
            h = i ? i.scrollTop : l,
            d = (new Date).getTime();
        i && "static" === axStyle(i).position && (i.style.position = "relative"), s = r ? i ? r.offsetTop - i.scrollTop : r.getBoundingClientRect().top : "number" == typeof t ? t - h : -h; let p = e.duration && "number" == typeof e.duration ? e.duration : Math.abs(s) / 4 + 1e3,
            c = () => { let t = (new Date).getTime() - d,
                    e = t / p,
                    i = h + (s - a) * axCurves[n](e);
                o.scrollTo(0, i), c.timer = requestAnimationFrame(c), t >= p && (o.scrollTo(0, i), cancelAnimationFrame(c.timer)) }; return c(), t },
    ...
    axImage = { load: getComputedStyle(document.documentElement).getPropertyValue("--load").trim().split('"')[1], loadW: getComputedStyle(document.documentElement).getPropertyValue("--load-w").trim().split('"')[1], blank: getComputedStyle(document.documentElement).getPropertyValue("--blank").trim().split('"')[1], avatar: getComputedStyle(document.documentElement).getPropertyValue("--avatar").trim().split('"')[1], empty: getComputedStyle(document.documentElement).getPropertyValue("--empty").trim().split('"')[1], none: getComputedStyle(document.documentElement).getPropertyValue("--none").trim().split('"')[1] },
    axGetColors = () => { let t = getComputedStyle(document.documentElement),
            e = e => [t.getPropertyValue(`--h-${e}`), t.getPropertyValue(`--s-${e}`), t.getPropertyValue(`--l-${e}`), t.getPropertyValue(`--a-${e}`)].map(t => { let e = t.trim(); return e.includes("%") ? e : Number(e) }); return { primary: e("primary"), text: e("text"), success: e("success"), error: e("error"), info: e("info"), warning: e("warning"), question: e("question") } },
    axResult = (t, e) => { if (!t) return console.error(axError.notExist), !1; let s = axIdToDom(t),
            i = ""; switch (e) {
            case "success":
                i = '<path class="svg-line svg-out" d="M7.238500000000002,43.3493A36.1108,36.1108 0,1,1 79.4601,43.3493A36.1108,36.1108 0,1,1 7.238500000000002,43.3493"></path>\n            <path class="svg-line svg-in-1" d="M26.316,42.859L37.9984,54.5414L60.3826,32.1572"></path>', s.querySelector("svg").classList.add("svg-success"); break;
            case "error":
                i = '<path class="svg-line svg-out" d="M7.238500000000002,43.3493A36.1108,36.1108 0,1,1 79.4601,43.3493A36.1108,36.1108 0,1,1 7.238500000000002,43.3493"></path>\n            <path class="svg-line svg-in-1" d="M28.774,57.9246L57.9247,28.7739"></path>\n            <path class="svg-line svg-in-2" d="M57.9246,57.9246L28.7739,28.7739"></path>', s.querySelector("svg").classList.add("svg-error"); break;
            case "question":
                i = '<path class="svg-line svg-out" d="M7.238500000000002,43.3493A36.1108,36.1108 0,1,1 79.4601,43.3493A36.1108,36.1108 0,1,1 7.238500000000002,43.3493"></path>\n            <path class="svg-line svg-in-1" d="M32.3757 35.7255c-0.2203,-11.823 12.5789,-14.1087 18.4056,-9.4189 5.4663,4.3995 4.7426,12.804 -3.1088,17.9938 -3.0015,1.9839 -3.0003,3.8403 -3.0003,10.1707"></path>\n            <circle class="svg-circle svg-in-2" cx="44.6612" cy="60.5502" r="2.1166"></circle>', s.querySelector("svg").classList.add("svg-question"); break;
            case "info":
                i = '<path class="svg-line svg-out" d="M7.238500000000002,43.3493A36.1108,36.1108 0,1,1 79.4601,43.3493A36.1108,36.1108 0,1,1 7.238500000000002,43.3493"></path>\n            <path class="svg-line svg-in-1" d="M43.3493,65.0602L43.3493,30.9723"></path>\n            <circle class="svg-circle svg-in-2" cx="43.3492" cy="23.5856" r="2.1166"></circle>', s.querySelector("svg").classList.add("svg-info") }
        s.classList.add("ax-result-show"), -1 == s.querySelector("svg").innerHTML.indexOf("svg-in-1") && s.querySelector("svg").insertAdjacentHTML("beforeend", i) },
    axCreateContent = (t, e, s) => { let i, o = t.content,
            a = {}; if (t.url)
            if ("async" === t.type) { let n = "",
                    r = ""; "id" == axStrType(t.url) ? (n = t.url.match(/(\S*)\#/)[1], r = "#" + t.url.match(/\#(\S*)/)[1]) : n = t.url, a = axAjax({ url: n, selector: r, type: t.ajaxType || "post", opened: t => { e.contentXhr = t.xhr }, before: t => { i = t.content }, success: t => { i = "function" == typeof o ? o(t.content) : t.content, s && s.call(e, i) } }) } else "iframe" === t.type ? (i = `<iframe src="${t.url}" frameborder="0" width="100%" height="100%"></iframe>`, t.footerShow = !1) : "picture" === t.type ? i = `\n            <div class="ax-media-container"><img src="${t.url}" /></div>\n            <div class="ax-media-title">${t.name}</div>\n            ${o}\n            ` : "video" === t.type ? i = `\n                <div class="ax-media-container"><video src="${t.url}" controls="controls" ></video></div>\n                <div class="ax-media-title">${t.name}</div>\n                ${o}\n                ` : "audio" === t.type && (i = `\n                <div class="ax-media-container"><audio src="${t.url}" controls="controls" ></audio></div>\n                <div class="ax-media-title">${t.name}</div>\n                ${o}\n                `), s && s.call(e, i);
        else i = "html" == t.type ? "string" == typeof o && "id" == axStrType(o) ? document.querySelector(o).innerHTML : "function" == typeof o ? o.call(e) : o : o || "没有任何内容！", s && s.call(e, i); return a.content = i, s && s(i), a },
    axBreakpoints = (t, e) => { if (axIsEmpty(t)) return !1; let s = [],
            i = {},
            o = document.body.clientWidth,
            a = (t, e) => { t.startsWith("ceil") ? axCeil[t.split("-")[1]] > o && s.push(e) : t.startsWith("client") ? t.split("-")[1] === axClient() && s.push(e) : t.startsWith("width") ? t.split("-")[1] > o && s.push(e) : t.startsWith("mobile") ? t.split("-")[1] == axIsMobi() && s.push(e) : t > o && s.push(e) }; for (let t in e) e.hasOwnProperty(t) && (Reflect.deleteProperty(e[t], "breakpoint"), a(t, e[t])); if (0 === s.length) return !1;
        i = Object.assign(...s), axExtend(t, i) },
    axFooterBtns = t => { let e = t.footerBreak ? '<div class="ax-break-line"></div>' : "",
            s = ""; if (t.note && (t.note = `<div class="ax-note">${t.note}</div>`), t.footerShow)
            if ("right" == t.footerType) { let i = "",
                    o = "",
                    a = "";
                t.confirm.text && (o = `<a href="###" class="ax-btn ax-primary ${t.confirm.classname}"  confirm>${t.confirm.icon}${t.confirm.text}</a>`), t.cancel.text && (i = `<a href="###" class="ax-btn ax-plain ax-ignore ${t.cancel.classname}"  cancel>${t.cancel.icon}${t.cancel.text}</a>`), t.diy.text && t.diy.callback ? a = `<a href="###" class="ax-btn ax-plain ${t.diy.classname}"  diy>${t.diy.icon}${t.diy.text}</a>` : t.diy.text && !t.diy.callback && (a = `<a href="${t.diy.url}" target="${t.diy.url}" class="ax-btn ax-plain ${t.diy.classname}"  diy>${t.diy.icon}${t.diy.text}</a>`), s = `\n                                        ${e}\n                                        <div class="ax-padding">\n                                              <div class="ax-row">\n                                                  <div class="ax-col">\n                                                  ${t.note}\n                                                  </div>\n                                                  <div class="ax-btns">${a}${i}${o}</div>\n                                              </div>\n                                          </div>\n                          ` } else if ("line" == t.footerType) { let e = "",
                i = "",
                o = "";
            t.confirm.text && (i = `<a href="###" class="ax-col ax-col-12 ${t.confirm.classname}"  confirm>${t.confirm.icon}${t.confirm.text}</a>`), t.cancel.text && (e = `<a href="###" class="ax-col ax-col-12 ${t.cancel.classname}"  cancel>${t.cancel.icon}${t.cancel.text}</a><span class="ax-gutter-line"></span>`), t.diy.text && t.diy.callback ? o = `<a href="###" class="ax-col ax-col-12 ${t.diy.classname}"  diy>${t.diy.icon}${t.diy.text}</a><span class="ax-gutter-line"></span>` : t.diy.text && !t.diy.callback && (o = `<a href="${t.diy.url}" target="${t.diy.url}" class="ax-col ax-col-12 ${t.diy.classname}"  diy>${t.diy.icon}${t.diy.text}</a><span class="ax-gutter-line"></span>`), s = `\n                          <div class="ax-break-line"></div>\n                          <div class="ax-row">${o}${e}${i}</div>${t.note}\n                          ` } else { let i = "",
                o = "",
                a = "";
    ...
    axLocalTime = (t, e) => { let s, i, o, a, n; if (t) { if (t = t.trim(), i = new Date(t), o = i instanceof Date && !isNaN(i.getTime()), !o) return console.error('Date format must be "YYYY-MM-DD" or "YYYY/MM/DD"');
            s = t.replace(/-/g, "/"), a = new Date(s).getTime(), n = -1 !== s.indexOf(":") ? 0 : 6e4 * new Date(s).getTimezoneOffset() } else a = (new Date).getTime(), n = 0; return e ? a - n : a },
    axCreateData = (t, e = ["src", "cover", "caption", "type"], s = ["media", "cover", "caption", "type"], i = "figure", o = ["", "", "", "image"], a) => { let n = [],
            r = ""; return "String" === axType(t) && "id" == axStrType(t) ? n = axTplToArr(t, e, s, i, o) : ("Array" === axType(t) || "Object" === axType(t) ? r = JSON.stringify(t) : "String" === axType(t) && (r = t), n = axStrToArr(r, s, o)), n = n.filter(t => t[s[0]]), a && a(n), n },
    axSort = (t, e, s) => { let i = [];
        Array.isArray(e) ? i = e.filter(t => t.order) : e.order && i.push(e); let o = (t, e, i) => { if (0 == i.length) return 0; let a, n, r, l = i.shift(),
                h = l.col,
                d = l.order,
                p = l.attr || "label"; return "table" == s ? "number" == typeof h ? (n = t.children.filter(t => t.index === h)[0][p], r = e.children.filter(t => t.index === h)[0][p]) : (n = t.children.find(t => t.name === h)[p], r = e.children.find(t => t.name === h)[p]) : (n = t[h], r = e[h]), a = isNaN(n - r) ? "desc" === d ? r.localeCompare(n, "zh-CN-u-kf-lower") : n.localeCompare(r, "zh-CN-u-kf-lower") : "desc" === d ? r - n : n - r, n === r ? o(t, e, i) : a }; return t.sort((t, e) => o(t, e, [...i])) },
    axSerialize = (t, e = "string", s = ",") => { let i, o, a = []; if (i = Array.isArray(t) ? t : [...axIdToDom(t).querySelectorAll("[name]")].filter(t => ["INPUT", "SELECT", "TEXTAREA"].includes(t.nodeName) && t.name && !t.name.includes("_ax_alt")), i.forEach(t => { let e = a.find(e => e.name == t.name);
                e ? "checkbox" != t.type && "radio" != t.type || e.dom.push(t) : a.push({ name: t.name, type: t.type, dom: [t] }) }), a.forEach(t => { "file" == t.type ? t.value = axMultiValues(t.dom[0], "file", "array") : "checkbox" == t.type ? t.value = axMultiValues(t.dom, "checkbox", "string", "", s) : "radio" == t.type ? t.value = axMultiValues(t.dom, "radio", "string") : t.type.includes("select") ? t.value = axMultiValues(t.dom[0], "select", "string", "", s) : t.value = t.dom[0].value }), "string" == e) { let t = "";
            a.forEach(e => { t += "&" + e.name + "=" + e.value }), o = t } else if ("json" == e) { let t = {};
            a.forEach(e => { t[e.name] = e.value }), o = t } else "array" == e && (a.forEach(t => { delete t.type, delete t.dom }), o = a); return o },
    axArrSearch = (t, e, s, i) => { if (axIsEmpty(t) || axIsEmpty(e) || !s || 0 === s.length) return []; let o = Object.assign({ fuzzy: !0, separator: " ", limit: 0, reorder: !1, ignore: !0 }, i),
            a = axSplitToArr(t, o.separator),
            n = axSplitToArr(e, ","),
            r = [],
            l = "(" + a.join("|") + ")",
            h = new RegExp(l, `${o.ignore?"i":""}g`); for (let t of s) { let e = n.map(e => t[e]).join("■"),
                s = e.match(h),
                i = {};
            s && (i = { source: t, weight: s.length, keys: [...new Set(s)] }, o.fuzzy ? r.push(i) : [...new Set(s)].length === a.length && r.push(i)) } return o.reorder && r.sort((t, e) => e.weight - t.weight), o.limit && r.length > o.limit && r.splice(o.limit), r };
class axObserve { constructor(t, e) { if (this.dataType = axType(t), "Object" !== this.dataType && "Array" !== this.dataType) return { instance: this, proxy: t }; if (this.options = axExtend({ deep: !1, accept: !0, once: !1, methods: ["set", "deleteProperty"], callback: "" }, e), this.handlers = {}, this.completeIndex = 0, this.reacts = 0, this.proxys = [], this.data = t, this.fullMethods = { get: (t, e, s) => { let i = t[e]; return this.options.callback && this.options.callback({ target: t, key: e, proxy: s, value: i, type: "get" }), this.handlers.hasOwnProperty(e) && this.emit(e, { target: t, key: e, proxy: s, value: i, type: "get" }), Reflect.get(t, e, s) }, set: (t, e, s, i) => { if (JSON.stringify(t[e]) == JSON.stringify(s)) return !0; let o = axType(s),
                        a = t[e],
                        n = void 0 === t[e] ? "add" : "edit"; return "Object" !== o && "Array" !== o || !this.options.deep || (s = this.proxy(s)), this.options.accept && Reflect.set(t, e, s, i), this.options.callback && this.options.callback({ target: t, key: e, proxy: i, value: s, raw: a, type: n }), this.handlers.hasOwnProperty(e) && this.emit(e, { target: t, key: e, proxy: i, value: s, raw: a, type: n }), this.reacts++, this.complete(this.reacts), !0 }, deleteProperty: (t, e) => { let s = t[e]; return this.options.accept && Reflect.deleteProperty(t, e), this.options.callback && this.options.callback({ target: t, key: e, value: s, type: "delete" }), this.handlers.hasOwnProperty(e) && this.emit(e, { target: t, key: e, value: s, type: "delete" }), this.reacts++, this.complete(this.reacts), !0 } }, this.methods = {}, this.options.methods.forEach(t => { this.methods[t] = this.fullMethods[t] }), this.options.deep)
            for (let e in t)
                if (t.hasOwnProperty(e)) { let s = axType(t[e]); "Object" !== s && "Array" !== s || (t[e] = this.proxy(t[e])) }
        return { instance: this, proxy: this.proxy(t) } }
    complete(t) { setTimeout(() => { if (t === this.reacts) { if (this.options.once && 0 !== this.completeIndex) return !1;
                this.options.callback && this.options.callback({ target: this.data, proxy: this.proxys[0], type: "complete" }), this.handlers.hasOwnProperty("complete") && this.emit("complete", { target: this.data, proxy: this.proxys[0], type: "complete" }), this.completeIndex++ } }, 0) }
    proxy(t) { let e = new Proxy(t, this.methods); return 0 === this.proxys.length && this.proxys.push(e), e }
    on(t, e) { return axAddPlan(t, e, this), this }
    emit(t, ...e) { axExePlan(t, this, ...e) }
    off(t, e) { return axDelPlan(t, e, this), this } }
class AXINSTANCE { constructor() { this.data = [], this.destroyFun = (t => { if (!t) return !1;
            t.instance.hasOwnProperty("destroyed") && t.instance.destroyed || !t.instance.__proto__.destroy || (t.instance.destroy(), t.log = `destroy(${(new Date).toLocaleString()})`) }), this.initFun = (t => { if (!t) return !1;
            t.instance.hasOwnProperty("destroyed") && !t.instance.destroyed || !t.instance.__proto__.init || (t.instance.init(), t.log = `init(${(new Date).toLocaleString()})`) }) }
    push(t, e, s) { if (!t) return !1; let i = { name: e, instance: t, type: s || "", log: `push(${(new Date).toLocaleString()})` };
        this.data.some(e => e.instance === t) || this.data.push(i) }
    find(t, e, s = !1) { if (!t) return !1; let i; return i = e ? this.data.find(i => i.instance.hasOwnProperty("destroyed") ? i.name === t && i.type === e && i.instance.destroyed === s : i.name === t && i.type === e) : this.data.find(e => e.instance.hasOwnProperty("destroyed") ? e.name === t && e.instance.destroyed === s : e.name === t), i ? i.instance : i }
    findAll(t, e = !1) { let s = []; return s = t ? this.data.filter(s => s.instance.hasOwnProperty("destroyed") ? s.type === t && s.instance.destroyed === e : s.type === t) : i.instance.hasOwnProperty("destroyed") ? this.data.filter(t => t.instance.destroyed === e) : this.data, s.length > 0 ? s.map(t => t.instance) : s }
    destroy(t, e, s) { if (!t) return !1; let i;
        i = e ? this.data.find(s => s.name === t && s.type === e) : this.data.find(e => e.name === t), this.destroyFun(i), s && s(i) }
    destroyAll(t, e) { if (!t) return this.data.forEach(t => { this.destroyFun(t) }), e && e(this.data), !1; { let s = this.data.filter(e => e.type === t);
            s.forEach(t => { this.destroyFun(t) }), e && e(s) } }
    clear(t) { this.data.forEach(t => { this.destroyFun(t) }), this.data.length = 0, t && t() }
    init(t, e, s) { if (!t) return !1; let i;
        i = e ? this.data.find(s => s.name === t && s.type === e) : this.data.find(e => e.name === t), this.initFun(i), s && s(i) }
    initAll(t, e) { if (!t) return this.data.forEach(t => { this.initFun(t) }), e && e(this.data), !1; { let s = this.data.filter(e => e.type === t);
            s.forEach(t => { this.initFun(t) }), e && e(s) } } }
const axInstance = new AXINSTANCE;
class axCage {
    constructor(t, e) {
        if (!t) return !1;
        if (this.targetDom = axIdToDom(t), !this.targetDom || 0 === this.targetDom.children.length) return !1;
        this.options = axExtend({ insName: "", init: !0, unbound: { attr: "unbound", selector: "" }, dampingRatio: .5, duration: 300, drift: { enable: !1, timeTHR: 200, distTHR: 20, coef: 2 }, scale: { enable: !1, min: 1, max: 5 }, completedTHR: 20, breakpoints: {}, onInit: "", onCompleted: "", onStart: "", onMove: "", onEnd: "", onScaled: "", onScaledMin: "", onScaledMax: "", onTranslated: "", onRefactored: "", onResized: "", onFitted: "", onSlided: "", onUpdated: "", onDestroy: "" }, e, this.targetDom, this.constructor.name);
        let s = this;
        this.handlers = {}, this.isMobi = axIsMobi(), this.events = this.isMobi ? ["touchstart", "touchmove", "touchend"] : ["mousedown", "mousemove", "mouseup"], this.started = !1, this.scrollObj = axGetScrollObj(), this.startFun = function(t) { if (t.stopPropagation(), s.unbounds.length > 0 && s.unbounds.includes(t.target)) return !1;
            t.preventDefault(), s.startValue = {...s.getCoordValue(t) }; let e = s.slides.find(t => t.dom === this),
                i = {...s.startValue };
            s.distStart = { x: i.x - e.last.x, y: i.y - e.last.y }, s.startTime = t.timeStamp, s.started = !0, this.setAttribute("active", ""), e.active = !0, this.style.transitionDuration = "0ms", s.handlers.hasOwnProperty("start") && s.emit("start", e), s.options.onStart && s.options.onStart.call(s, e) }, this.moveFun = function(t) {
            if (t.stopPropagation(), !s.isMobi && !s.started) return !1;
            if (s.unbounds.length > 0 && s.unbounds.includes(t.target)) return !1;
            t.preventDefault();
            let e = s.getCoordValue(t);
            JSON.stringify(e) != JSON.stringify(s.startValue) && s.targetDom.setAttribute("moving", "");
            let i = s.slides.find(t => t.dom === this),
                o = t => i.range[t][0] + (i.now[t] - i.range[t][0]) * Math.pow(s.options.dampingRatio, 2),
                a = t => i.range[t][1] + (i.now[t] - i.range[t][1]) * Math.pow(s.options.dampingRatio, 2);
            i.now = { x: e.x - s.distStart.x, y: e.y - s.distStart.y }, i.now.y < i.range.y[0] ? (i.now.y = o("y"), Math.abs(i.now.y - i.range.y[0]) >= s.options.completedTHR && (s.handlers.hasOwnProperty("completed") && s.emit("completed", "top"), s.options.onCompleted && s.options.onCompleted.call(s, "top"))) : i.now.y > i.range.y[1] && (i.now.y = a("y"), Math.abs(i.now.y - i.range.y[1]) >= s.options.completedTHR && (s.handlers.hasOwnProperty("completed") && s.emit("completed", "bottom"), s.options.onCompleted && s.options.onCompleted.call(s, "bottom"))), i.now.x < i.range.x[0] ? (i.now.x = o("x"),
                Math.abs(i.now.x - i.range.x[0]) >= s.options.completedTHR && (s.handlers.hasOwnProperty("completed") && s.emit("completed", "left"), s.options.onCompleted && s.options.onCompleted.call(s, "left"))) : i.now.x > i.range.x[1] && (i.now.x = a("x"), Math.abs(i.now.x - i.range.x[1]) >= s.options.completedTHR && (s.handlers.hasOwnProperty("completed") && s.emit("completed", "right"), s.options.onCompleted && s.options.onCompleted.call(s, "right"))), s.setValues({ item: i, value: i.now, apply: !1 }), s.handlers.hasOwnProperty("move") && s.emit("move", i), s.options.onMove && s.options.onMove.call(s, i)
        }, this.endFun = function(t) { if (t.stopPropagation(), s.targetDom.removeAttribute("moving"), !s.isMobi && !s.started) return !1;
            t.preventDefault(), s.started = !1; let e = s.slides.find(t => t.active),
                i = s.computeHYP({...e.now }, {...e.last }),
                o = i.HYP,
                a = i.SIN,
                n = i.COS;
            e.last = {...e.now }, e.dom.style.cssText = e.dom.style.cssText.replace("transition-duration: 0ms", ""); let r, l = t.timeStamp - s.startTime; if (s.options.drift.enable && l < s.options.drift.timeTHR && o > s.options.drift.distTHR) { let t = (s.options.drift.timeTHR - l) * s.options.drift.coef;
                r = { x: ~~(e.last.x + a * t), y: ~~(e.last.y + n * t) } } else r = e.now;
            s.slideTo({ item: e, value: r }), e.dom.removeAttribute("active"), Reflect.deleteProperty(e, "active"), s.handlers.hasOwnProperty("end") && s.emit("end", e), s.options.onEnd && s.options.onEnd.call(s, e) }, this.scrollFun = axThrottle(function(t) { if (t.stopPropagation(), t.preventDefault(), s.unbounds.length > 0 && s.unbounds.includes(this)) return !1; let e = s.slides.find(t => t.dom === this),
                i = axIsScrollUp(t, s.scrollObj.detail);
            i ? (e.scale++, e.scale >= s.options.scale.max && (e.scale = s.options.scale.max)) : (e.scale--, e.scale <= s.options.scale.min && (e.scale = s.options.scale.min)), (e.scale <= s.options.scale.max || e.scale >= s.options.scale.min) && (e.scale = axNumber(e.scale, { places: 0, mode: "floor" }), this.style.transitionDuration = s.options.duration + "ms", s.setValues({ type: "scale", item: e, value: e.scale }), setTimeout(() => { s.updateItem(e) }, s.options.duration)) }, s.options.duration, !0), this.slidedEvent = function(t) { t.stopPropagation(), s.response(this) }, this.mutationObs = new MutationObserver(t => { t.forEach(t => { if ("attributes" === t.type && t.target !== this.targetDom) { let e = this.slides.find(e => e.dom === t.target),
                        s = this.getValues(e);
                    s[0] == e.scale && s[3] == e.scale || (this.handlers.hasOwnProperty("scaled") && this.emit("scaled", e, s[0]), this.options.onScaled && this.options.onScaled.call(this, e, s[0]), e.scale === this.options.scale.min ? (e.boundary = "min", this.handlers.hasOwnProperty("scaledMin") && this.emit("scaledMin", e, this.options.scale.min), this.options.onScaledMin && this.options.onScaledMin.call(this, e, this.options.scale.min)) : e.scale === this.options.scale.max ? (e.boundary = "max", this.handlers.hasOwnProperty("scaledMax") && this.emit("scaledMax", e, this.options.scale.max), this.options.onScaledMax && this.options.onScaledMax.call(this, e, this.options.scale.max)) : Reflect.deleteProperty(e, "boundary")), s[4] == e.now.x && s[5] == e.now.y || (this.handlers.hasOwnProperty("translated") && this.emit("translated", e, { x: s[4], y: s[5] }), this.options.onTranslated && this.options.onTranslated.call(this, e, { x: s[4], y: s[5] })) } "childList" === t.type && t.target === this.targetDom && (this.options.unbound && this.getUnbounds(), this.handlers.hasOwnProperty("refactored") && this.emit("refactored", ""), this.options.onRefactored && this.options.onRefactored.call(this)) }) }), this.slideDomSizeObserver = new ResizeObserver(axDebounce(t => { for (let e of t) this.response(e.target), this.handlers.hasOwnProperty("resized") && this.emit("resized", e, e.target), this.options.onResized && this.options.onResized.call(this, e, e.target) })), this.targetDomSizeObserver = new ResizeObserver(axDebounce(t => { for (let e of t) this.response(), this.handlers.hasOwnProperty("resized") && this.emit("resized", e, this.targetDom), this.options.onResized && this.options.onResized.call(this, e, this.targetDom) })), this.options.init ? this.init() : this.destroyed = !0
    }
    init(t) { return axInstance.push(this, this.options.insName, "cage"), !axIsEmpty(this.options.breakpoints) && axBreakpoints(this.options, this.options.breakpoints), this.destroyed = !1, this.getUnbounds(), this.slides = [...this.targetDom.children].map(t => ({ dom: t, last: { x: 0, y: 0 }, now: { x: 0, y: 0 }, difference: { x: 0, y: 0 }, size: { width: 0, height: 0 }, offset: { x: 0, y: 0 }, shape: "", range: { x: [], y: [] }, scale: 1 })), this.setAttribute(), this.updateTarget(), this.distStart = { x: 0, y: 0 }, this.addTargetEvent(), this.slides.forEach(t => { this.addItemEvent(t.dom) }), this.handlers.hasOwnProperty("init") && this.emit("init", ""), this.options.onInit && this.options.onInit.call(this), t && t.call(this), this }
    computeHYP(t, e) { let s = {...t },
            i = {...e },
            o = Math.abs(s.x - i.x),
            a = Math.abs(s.y - i.y),
            n = Math.sqrt(o * o + a * a),
            r = n ? (s.x - i.x) / n : 0,
            l = n ? (s.y - i.y) / n : 0; return { HYP: n, SIN: r, COS: l } }
    setAttribute() {!this.targetDom.classList.contains("ax-cage") && this.targetDom.classList.add("ax-cage"), "hidden" !== axStyle(this.targetDom).overflow && (this.targetDom.style.overflow = "hidden"), "static" === axStyle(this.targetDom).position && (this.targetDom.style.position = "relative") }
    getUnbounds() { this.unbounds = this.getDomsFromArg(this.options.unbound.selector), this.unbounds.forEach(t => t.setAttribute(this.options.unbound.attr, "")) }
    getDomsFromArg(t) { let e = []; if (t) { let s = axType(t); "String" === s ? e = [...this.targetDom.querySelectorAll(t)] : "Array" === s ? e = t : s.includes("HTML") && e.push(t) } return e }
    fitTo(t) { if (this.destroyed) return this; let e = Object.assign({ item: this.slides[0], placement: "left-top", duration: this.options.duration }, t),
            s = axType(e.item),
            i = s.includes("HTML") ? this.slides.find(t => t.dom === e.item) : "String" === s ? this.targetDom.querySelector(e.item) : e.item,
            o = {},
            a = this.getScaleOffset(i); if (!i || this.unbounds.includes(i.dom)) return !1; switch (e.placement) {
            case "right-top":
                o = { x: i.difference.x, y: 0 }; break;
            case "left-bottom":
                o = { x: 0, y: i.difference.y }; break;
            case "right-bottom":
                o = {...i.difference }; break;
            case "left":
                o = { x: 0, y: i.now.y }; break;
            case "right":
                o = { x: i.difference.x, y: i.now.y }; break;
            case "top":
                o = { x: i.now.x, y: 0 }; break;
            case "bottom":
                o = { x: i.now.x, y: i.difference.y }; break;
            default:
    ...
    getEdgeValue(t, e) { let s, i = axType(t); if (i.includes("HTML") || "String" === i) { let e = axIdToDom(t);!e || (s = { x: -e.offsetLeft, y: -e.offsetTop }) } else s = {...t }; return !axIsEmpty(s) && s.hasOwnProperty("x") && s.hasOwnProperty("y") && (s.x < e.range.x[0] ? s.x = e.range.x[0] : s.x > e.range.x[1] && (s.x = e.range.x[1]), s.y < e.range.y[0] ? s.y = e.range.y[0] : s.y > e.range.y[1] && (s.y = e.range.y[1])), s }
    slideTo(t) { if (this.destroyed) return this; let e = Object.assign({ item: this.slides[0] }, t),
            s = axType(e.item),
            i = s.includes("HTML") ? this.slides.find(t => t.dom === e.item) : "String" === s ? this.targetDom.querySelector(e.item) : e.item; if (!i || this.unbounds.includes(i.dom)) return !1; let o = this.getEdgeValue(e.value, i),
            a = this.computeHYP(i.now, o).HYP / this.hypotenuse,
            n = e.duration || 0 == e.duration ? `${e.duration}ms` : a > 1 ? Math.trunc(this.options.duration * a) + "ms" : `${this.options.duration}ms`; if (JSON.stringify(o) == JSON.stringify(i.now)) return !1;
        i.dom.style.transitionDuration = n, this.setValues({ value: o, item: i }), setTimeout(() => { this.handlers.hasOwnProperty("slided") && this.emit("slided", { raw: e.value, correction: o, item: i }), this.options.onSlided && this.options.onSlided.call(this, { raw: e.value, correction: o, item: i }), e.callback && e.callback.call(this, { raw: e.value, correction: o, item: i }) }, parseInt(n)) }
    getCoordValue(t) { return this.isMobi ? { x: t.changedTouches[0].clientX, y: t.changedTouches[0].clientY } : { x: t.clientX, y: t.clientY } }
    updateTarget() { let t = axStyle(this.targetDom),
            e = this.targetDom.getBoundingClientRect().height - (parseInt(t.borderTopWidth) + parseInt(t.borderBottomWidth) + parseInt(t.paddingTop) + parseInt(t.paddingBottom)),
            s = this.targetDom.getBoundingClientRect().width - (parseInt(t.borderLeftWidth) + parseInt(t.borderRightWidth) + parseInt(t.paddingLeft) + parseInt(t.paddingRight)),
            i = this.computeHYP({ x: 0, y: 0 }, { x: s, y: e }).HYP;
        this.targetHeight != e && (this.targetHeight = e), this.targetWidth != s && (this.targetWidth = s), this.hypotenuse != i && (this.hypotenuse = i) }
    updateItem(t = this.slides[0]) { let e = axType(t),
            s = e.includes("HTML") ? this.slides.find(e => e.dom === t) : "String" === e ? this.targetDom.querySelector(t) : t; if (!s || this.unbounds.includes(s.dom)) return !1;
        s.size.height = s.dom.getBoundingClientRect().height, s.size.width = s.dom.getBoundingClientRect().width, s.difference = { x: this.targetWidth - s.size.width, y: this.targetHeight - s.size.height }, s.offset = { x: s.dom.offsetLeft, y: s.dom.offsetTop }, s.difference.x > 0 && s.difference.y > 0 ? s.shape = "baby" : s.difference.y > 0 && s.difference.x <= 0 ? s.shape = "river" : s.difference.x > 0 && s.difference.y <= 0 ? s.shape = "chimney" : s.shape = "cover", this.fixedTranslate(s) }
    getScaleOffset(t) { return t.scale > this.options.scale.min ? { x: t.size.width / t.scale / 2 * (t.scale - 1), y: t.size.height / t.scale / 2 * (t.scale - 1) } : { x: 0, y: 0 } }
    fixedTranslate(t) { let e = this.getValues(t),
            s = { x: e[4], y: e[5] },
            i = this.getScaleOffset(t),
            o = e => { t.offset[e] - i[e] + s[e] < 0 ? s[e] = -t.offset[e] + i[e] : t.offset[e] - i[e] + s[e] > t.difference[e] && (s[e] = t.difference[e] - t.offset[e] + i[e]), t.range[e] = [0 - t.offset[e] + i[e], t.difference[e] - t.offset[e] + i[e]] },
            a = e => { s[e] < t.difference[e] - t.offset[e] + i[e] ? s[e] = t.difference[e] - t.offset[e] + i[e] : s[e] > -t.offset[e] + i[e] && (s[e] = -t.offset[e] + i[e]), t.range[e] = [t.difference[e] - t.offset[e] + i[e], -t.offset[e] + i[e]] }; switch (t.shape) {
            case "baby":
                o("x"), o("y"); break;
            case "river":
                o("y"), a("x"); break;
            ...
            default:
                a("x"), a("y") }
        JSON.stringify(s) != JSON.stringify(t.now) && this.setValues({ value: s, item: t }) }
    response(t = "all") { if (this.destroyed) return this; if ("all" === t) this.updateTarget(), this.slides.forEach(t => { this.updateItem(t) });
        else if ("parent" === t) this.updateTarget();
        else if ("chidren" === t) this.slides.forEach(t => { this.updateItem(t) });
        else { let e = axType(t),
                s = e.includes("HTML") ? this.slides.find(e => e.dom === t) : "String" === e ? this.targetDom.querySelector(t) : t;
            s && this.updateItem(s) } }
    getValues(t = this.slides[0]) { let e = axType(t),
            s = e.includes("HTML") ? this.slides.find(e => e.dom === t) : "String" === e ? this.targetDom.querySelector(t) : t; if (!s) return !1; let i = axStyle(s.dom).transform; return "none" === i ? [1, 0, 0, 1, 0, 0] : i.replace(/[^0-9.\-,]/g, "").split(",").map(t => Number(t)) }
    setValues(t) { if (this.destroyed) return this; let e = Object.assign({ item: this.slides[0], type: "translate", apply: !0 }, t),
            s = axType(e.item),
            i = s.includes("HTML") ? this.slides.find(t => t.dom === e.item) : "String" === s ? this.targetDom.querySelector(e.item) : e.item; if (!i || this.unbounds.includes(i.dom)) return !1; let o = this.getValues(i),
            a = [...o],
            n = axType(e.value),
            r = {}; if ("Object" === n) r = {...e.value };
        else if ("Number" === n) r = { x: e.value, y: e.value };
        else { let t = ~~e.value;
            t || (t = "scale" === e.type ? 1 : 0), r = { x: t, y: t } } "zero" === e.type ? (a[0] = 1, a[3] = 1, a[4] = 0, a[5] = 0) : "scale" === e.type ? (a[0] = r.x, a[3] = r.y) : (a[4] = r.x, a[5] = r.y), JSON.stringify(a) != JSON.stringify(o) && (i.dom.style.transform = `matrix(${a.join()})`, e.apply && ("zero" === e.type ? (i.last = { x: 0, y: 0 }, i.now = { x: 0, y: 0 }, i.scale = 1) : "scale" === e.type ? i.scale = r.x || r.y : (i.last = {...r }, i.now = {...r }))) }
    reset() { if (this.destroyed) return this;
        this.slides.forEach(t => { this.setValues({ type: "zero", item: t }), t.dom.style.cssText = t.dom.style.cssText.replace("transition-duration: 0ms", "") }), this.targetDom.removeAttribute("moving"), this.started = !1 }
    addItemEvent(t) { t.addEventListener(this.events[0], this.startFun), t.addEventListener(this.events[1], this.moveFun), t.addEventListener(this.events[2], this.endFun), !this.isMobi && this.options.scale.enable && t.addEventListener(this.scrollObj.event, this.scrollFun), this.mutationObs.observe(t, { attributes: !0, attributeFilter: ["style"] }), t.addEventListener("transitionend", this.slidedEvent), this.slideDomSizeObserver.observe(t) }
    removeItemEvent(t) { t.removeEventListener(this.events[0], this.startFun), t.removeEventListener(this.events[1], this.moveFun), t.removeEventListener(this.events[2], this.endFun), !this.isMobi && this.options.scale.enable && t.removeEventListener(this.scrollObj.event, this.scrollFun), t.removeEventListener("transitionend", this.slidedEvent), this.slideDomSizeObserver.unobserve(t) }
    addTargetEvent() { this.isMobi ? this.targetDom.addEventListener("touchcancel", this.endFun) : this.targetDom.addEventListener("mouseleave", this.endFun), this.mutationObs.observe(this.targetDom, { childList: !0 }), this.targetDomSizeObserver.observe(this.targetDom) }
    removeTargetEvent() { this.isMobi || this.targetDom.removeEventListener("mouseleave", this.endFun), this.targetDomSizeObserver.unobserve(this.targetDom) }
    add(t, e) { let s = axGetDoms(t),
            i = []; return 0 !== s.length && (i = s.filter(Boolean).map(t => { let e = this.slides.find(e => e.dom === t),
                s = null; return e && e.disabled ? (Reflect.deleteProperty(e, "disabled"), e.dom.removeAttribute("disabled"), s = t, this.addItemEvent(t)) : (s = { dom: t, last: { x: 0, y: 0 }, now: { x: 0, y: 0 }, difference: { x: 0, y: 0 }, size: { width: 0, height: 0 }, offset: { x: 0, y: 0 }, shape: "", range: { x: [], y: [] }, scale: 1 }, this.addItemEvent(t), this.slides.push(s)), s }), this.handlers.hasOwnProperty("add") && this.emit("add", i), this.options.onAdd && this.options.onAdd.call(this, i), e && e.call(this, i), this) }
    remove(t, e) { let s = axGetDoms(t),
            i = this.slides.filter(t => !t.disabled && s.includes(t.dom)); return 0 !== s.length && (i.forEach(t => { t.disabled = !0, t.dom.setAttribute("disabled", ""), this.removeItemEvent(t.dom) }), this.handlers.hasOwnProperty("remove") && this.emit("remove", i), this.options.onRemove && this.options.onRemove.call(this, i), e && e.call(this, i), this) }
    update(t, e) { return this.destroyed ? this : (this.options = axExtend(this.options, t), this.reset(), this.options.init && this.init(), this.handlers.hasOwnProperty("updated") && this.emit("updated", ""), this.options.onUpdated && this.options.onUpdated.call(this), e && e.call(this), this) }
    destroy(t) { return this.destroyed ? this : (this.reset(), this.slides.forEach(t => { this.removeItemEvent(t.dom) }), this.removeTargetEvent(), this.destroyed = !0, this.handlers.hasOwnProperty("destroy") && this.emit("destroy", ""), this.options.onDestroy && this.options.onDestroy.call(this), t && t.call(this), this) }
    on(t, e) { return axAddPlan(t, e, this), this }
    emit(t, ...e) { axExePlan(t, this, ...e) }
    off(t, e) { return axDelPlan(t, e, this), this }
}
class axTow { constructor(t, e) { return this.targetDom = axIdToDom(t), !!this.targetDom && (this.options = axExtend({ insName: "", parent: document, onInit: "", onStart: null, onMove: null, onEnd: null, onDestroy: "" }, e, this.targetDom, this.constructor.name), this.parentDom = axIdToDom(this.options.parent), !!this.parentDom && (this.handlers = {}, this.coord = { x: 0, y: 0 }, this.diff = { x: 0, y: 0 }, this.startFun = (t => { this.coord = axGetClientObj(t), this.parentDom.addEventListener(axEventMap[1], this.moveFun, { passive: !1 }), this.parentDom.addEventListener(axEventMap[2], this.endFun, { passive: !1 }); let e = { target: t.target, coord: this.coord, diff: this.diff, originEvent: t };
            this.handlers.hasOwnProperty("start") && this.emit("start", e), this.options.onStart && this.options.onStart.call(this, e) }), this.moveFun = (t => { let e = axGetClientObj(t);
            this.diff = { x: e.x - this.coord.x, y: e.y - this.coord.y }; let s = { target: t.target, coord: e, diff: this.diff, originEvent: t };
            this.handlers.hasOwnProperty("move") && this.emit("move", s), this.options.onMove && this.options.onMove.call(this, s) }), this.endFun = (t => { this.coord = axGetClientObj(t); let e = { target: t.target, coord: this.coord, diff: this.diff, originEvent: t };
            this.handlers.hasOwnProperty("end") && this.emit("end", e), this.options.onEnd && this.options.onEnd.call(this, e), this.setCompleted() }), this.cancelFun = (t => { this.setCompleted(), this.handlers.hasOwnProperty("cancel") && this.emit("cancel", { target: t.target, coord: this.coord, diff: this.diff }), this.options.onCancel && this.options.onCancel.call(this, { target: t.target, coord: this.coord, diff: this.diff }) }), void this.init())) }
    init() { return axInstance.push(this, this.options.insName, "tow"), this.destroyed = !1, this.targetDom.removeEventListener(axEventMap[0], this.startFun), this.targetDom.addEventListener(axEventMap[0], this.startFun, { passive: !1 }), this.parentDom.addEventListener(axEventMap[3], this.cancelFun, { passive: !1 }), this.handlers.hasOwnProperty("init") && this.emit("init", ""), this.options.onInit && this.options.onInit.call(this), this }
    setCompleted() { this.diff = { x: 0, y: 0 }, this.parentDom.removeEventListener(axEventMap[1], this.moveFun), this.parentDom.removeEventListener(axEventMap[2], this.endFun) }
    destroy(t) { return this.destroyed ? this : (this.setCompleted(), this.targetDom.removeEventListener(axEventMap[0], this.startFun), this.parentDom.removeEventListener(axEventMap[3], this.cancelFun), this.destroyed = !0, this.handlers.hasOwnProperty("destroy") && this.emit("destroy", ""), this.options.onDestroy && this.options.onDestroy.call(this), t && t.call(this), this) }
    on(t, e) { return axAddPlan(t, e, this), this }
    emit(t, ...e) { axExePlan(t, this, ...e) }
    off(t, e) { return axDelPlan(t, e, this), this } }(function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self, t.axSwiper = e()) })(this, function() {
        function t(t) { return null !== t && "object" == typeof t && "constructor" in t && t.constructor === Object }

        function e(s, i) { void 0 === s && (s = {}), void 0 === i && (i = {}), Object.keys(i).forEach(o => { void 0 === s[o] ? s[o] = i[o] : t(i[o]) && t(s[o]) && Object.keys(i[o]).length > 0 && e(s[o], i[o]) }) }

        function s() { const t = "undefined" != typeof document ? document : {}; return e(t, Be), t }

        function i() { const t = "undefined" != typeof window ? window : {}; return e(t, Ve), t }

        function o(t) { const e = t.__proto__;
            Object.defineProperty(t, "__proto__", { get: () => e, set(t) { e.__proto__ = t } }) }

        function a(t) { void 0 === t && (t = []); const e = []; return t.forEach(t => { Array.isArray(t) ? e.push(...a(t)) : e.push(t) }), e }

        function n(t, e) { return Array.prototype.filter.call(t, e) }

        function r(t) { const e = []; for (let s = 0; s < t.length; s += 1) - 1 === e.indexOf(t[s]) && e.push(t[s]); return e }

        function l(t, e) { if ("string" != typeof t) return [t]; const s = [],
                i = e.querySelectorAll(t); for (let t = 0; t < i.length; t += 1) s.push(i[t]); return s }

        function h(t, e) { const o = i(),
                a = s(); let n = []; if (!e && t instanceof Fe) return t; if (!t) return new Fe(n); if ("string" == typeof t) { const s = t.trim(); if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) { let t = "div";
                    0 === s.indexOf("<li") && (t = "ul"), 0 === s.indexOf("<tr") && (t = "tbody"), 0 !== s.indexOf("<td") && 0 !== s.indexOf("<th") || (t = "tr"), 0 === s.indexOf("<tbody") && (t = "table"), 0 === s.indexOf("<option") && (t = "select"); const e = a.createElement(t);
                    e.innerHTML = s; for (let t = 0; t < e.childNodes.length; t += 1) n.push(e.childNodes[t]) } else n = l(t.trim(), e || a) } else if (t.nodeType || t === o || t === a) n.push(t);
            else if (Array.isArray(t)) { if (t instanceof Fe) return t;
                n = t } return new Fe(r(n)) }

        function d() { for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++) e[s] = arguments[s]; const i = a(e.map(t => t.split(" "))); return this.forEach(t => { t.classList.add(...i) }), this }

        function p() { for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++) e[s] = arguments[s]; const i = a(e.map(t => t.split(" "))); return this.forEach(t => { t.classList.remove(...i) }), this }

        function c() { for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++) e[s] = arguments[s]; const i = a(e.map(t => t.split(" ")));
            this.forEach(t => { i.forEach(e => { t.classList.toggle(e) }) }) }

        function u() { for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++) e[s] = arguments[s]; const i = a(e.map(t => t.split(" "))); return n(this, t => i.filter(e => t.classList.contains(e)).length > 0).length > 0 }

        function m(t, e) { if (1 === arguments.length && "string" == typeof t) return this[0] ? this[0].getAttribute(t) : void 0; for (let s = 0; s < this.length; s += 1)
                if (2 === arguments.length) this[s].setAttribute(t, e);
                else
                    for (const e in t) this[s][e] = t[e], this[s].setAttribute(e, t[e]);
            return this }

        function g(t) { for (let e = 0; e < this.length; e += 1) this[e].removeAttribute(t); return this }

        function f(t) { for (let e = 0; e < this.length; e += 1) this[e].style.transform = t; return this }

        function x(t) { for (let e = 0; e < this.length; e += 1) this[e].style.transitionDuration = "string" != typeof t ? `${t}ms` : t; return this }

        function y() {
            function t(t) { const e = t.target; if (!e) return; const s = t.target.dom7EventData || []; if (s.indexOf(t) < 0 && s.unshift(t), h(e).is(n)) r.apply(e, s);
                else { const t = h(e).parents(); for (let e = 0; e < t.length; e += 1) h(t[e]).is(n) && r.apply(t[e], s) } }

            function e(t) { const e = t && t.target && t.target.dom7EventData || [];
                e.indexOf(t) < 0 && e.unshift(t), r.apply(this, e) } for (var s = arguments.length, i = new Array(s), o = 0; o < s; o++) i[o] = arguments[o]; let [a, n, r, l] = i; "function" == typeof i[1] && ([a, r, l] = i, n = void 0), l || (l = !1); const d = a.split(" "); let p; for (let s = 0; s < this.length; s += 1) { const i = this[s]; if (n)
                    for (p = 0; p < d.length; p += 1) { const e = d[p];
                        i.dom7LiveListeners || (i.dom7LiveListeners = {}), i.dom7LiveListeners[e] || (i.dom7LiveListeners[e] = []), i.dom7LiveListeners[e].push({ listener: r, proxyListener: t }), i.addEventListener(e, t, l) } else
                        for (p = 0; p < d.length; p += 1) { const t = d[p];
                            i.dom7Listeners || (i.dom7Listeners = {}), i.dom7Listeners[t] || (i.dom7Listeners[t] = []), i.dom7Listeners[t].push({ listener: r, proxyListener: e }), i.addEventListener(t, e, l) } } return this }

        function b() { for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++) e[s] = arguments[s]; let [i, o, a, n] = e; "function" == typeof e[1] && ([i, a, n] = e, o = void 0), n || (n = !1); const r = i.split(" "); for (let t = 0; t < r.length; t += 1) { const e = r[t]; for (let t = 0; t < this.length; t += 1) { const s = this[t]; let i; if (!o && s.dom7Listeners ? i = s.dom7Listeners[e] : o && s.dom7LiveListeners && (i = s.dom7LiveListeners[e]), i && i.length)
                        for (let t = i.length - 1; t >= 0; t -= 1) { const o = i[t];
                            a && o.listener === a ? (s.removeEventListener(e, o.proxyListener, n), i.splice(t, 1)) : a && o.listener && o.listener.dom7proxy && o.listener.dom7proxy === a ? (s.removeEventListener(e, o.proxyListener, n), i.splice(t, 1)) : a || (s.removeEventListener(e, o.proxyListener, n), i.splice(t, 1)) } } } return this }

        function v() { const t = i(); for (var e = arguments.length, s = new Array(e), o = 0; o < e; o++) s[o] = arguments[o]; const a = s[0].split(" "),
                n = s[1]; for (let e = 0; e < a.length; e += 1) { const i = a[e]; for (let e = 0; e < this.length; e += 1) { const o = this[e]; if (t.CustomEvent) { const e = new t.CustomEvent(i, { detail: n, bubbles: !0, cancelable: !0 });
                        o.dom7EventData = s.filter((t, e) => e > 0), o.dispatchEvent(e), o.dom7EventData = [], delete o.dom7EventData } } } return this }

        function D(t) {
            function e(i) { i.target === this && (t.call(this, i), s.off("transitionend", e)) } const s = this; return t && s.on("transitionend", e), this }

        function w(t) { if (this.length > 0) { if (t) { const t = this.styles(); return this[0].offsetWidth + parseFloat(t.getPropertyValue("margin-right")) + parseFloat(t.getPropertyValue("margin-left")) } return this[0].offsetWidth } return null }

        function T(t) { if (this.length > 0) { if (t) { const t = this.styles(); return this[0].offsetHeight + parseFloat(t.getPropertyValue("margin-top")) + parseFloat(t.getPropertyValue("margin-bottom")) } return this[0].offsetHeight } return null }

        function S() { if (this.length > 0) { const t = i(),
                    e = s(),
                    o = this[0],
                    a = o.getBoundingClientRect(),
                    n = e.body,
                    r = o.clientTop || n.clientTop || 0,
                    l = o.clientLeft || n.clientLeft || 0,
                    h = o === t ? t.scrollY : o.scrollTop,
                    d = o === t ? t.scrollX : o.scrollLeft; return { top: a.top + h - r, left: a.left + d - l } } return null }

        function E() { const t = i(); return this[0] ? t.getComputedStyle(this[0], null) : {} }

        function A(t, e) { const s = i(); let o; if (1 === arguments.length) { if ("string" != typeof t) { for (o = 0; o < this.length; o += 1)
                        for (const e in t) this[o].style[e] = t[e]; return this } if (this[0]) return s.getComputedStyle(this[0], null).getPropertyValue(t) } if (2 === arguments.length && "string" == typeof t) { for (o = 0; o < this.length; o += 1) this[o].style[t] = e; return this } return this }

        function C(t) { return t ? (this.forEach((e, s) => { t.apply(e, [e, s]) }), this) : this }

        function I(t) { const e = n(this, t); return h(e) }

        function k(t) { if (void 0 === t) return this[0] ? this[0].innerHTML : null; for (let e = 0; e < this.length; e += 1) this[e].innerHTML = t; return this }

        function M(t) { if (void 0 === t) return this[0] ? this[0].textContent.trim() : null; for (let e = 0; e < this.length; e += 1) this[e].textContent = t; return this }

        function L(t) { const e = i(),
                o = s(),
                a = this[0]; let n, r; if (!a || void 0 === t) return !1; if ("string" == typeof t) { if (a.matches) return a.matches(t); if (a.webkitMatchesSelector) return a.webkitMatchesSelector(t); if (a.msMatchesSelector) return a.msMatchesSelector(t); for (n = h(t), r = 0; r < n.length; r += 1)
                    if (n[r] === a) return !0;
                return !1 } if (t === o) return a === o; if (t === e) return a === e; if (t.nodeType || t instanceof Fe) { for (n = t.nodeType ? [t] : t, r = 0; r < n.length; r += 1)
                    if (n[r] === a) return !0;
                return !1 } return !1 }

        function P() { let t, e = this[0]; if (e) { for (t = 0; null !== (e = e.previousSibling);) 1 === e.nodeType && (t += 1); return t } }

        function $(t) { if (void 0 === t) return this; const e = this.length; if (t > e - 1) return h([]); if (t < 0) { const s = e + t; return h(s < 0 ? [] : [this[s]]) } return h([this[t]]) }

        function O() { let t; const e = s(); for (let s = 0; s < arguments.length; s += 1) { t = s < 0 || arguments.length <= s ? void 0 : arguments[s]; for (let s = 0; s < this.length; s += 1)
                    if ("string" == typeof t) { const i = e.createElement("div"); for (i.innerHTML = t; i.firstChild;) this[s].appendChild(i.firstChild) } else if (t instanceof Fe)
                    for (let e = 0; e < t.length; e += 1) this[s].appendChild(t[e]);
                else this[s].appendChild(t) } return this }

        function N(t) { const e = s(); let i, o; for (i = 0; i < this.length; i += 1)
                if ("string" == typeof t) { const s = e.createElement("div"); for (s.innerHTML = t, o = s.childNodes.length - 1; o >= 0; o -= 1) this[i].insertBefore(s.childNodes[o], this[i].childNodes[0]) } else if (t instanceof Fe)
                for (o = 0; o < t.length; o += 1) this[i].insertBefore(t[o], this[i].childNodes[0]);
            else this[i].insertBefore(t, this[i].childNodes[0]); return this }

        function z(t) { return this.length > 0 ? t ? this[0].nextElementSibling && h(this[0].nextElementSibling).is(t) ? h([this[0].nextElementSibling]) : h([]) : this[0].nextElementSibling ? h([this[0].nextElementSibling]) : h([]) : h([]) }

        function H(t) { const e = []; let s = this[0]; if (!s) return h([]); for (; s.nextElementSibling;) { const i = s.nextElementSibling;
                t ? h(i).is(t) && e.push(i) : e.push(i), s = i } return h(e) }

        function q(t) { if (this.length > 0) { const e = this[0]; return t ? e.previousElementSibling && h(e.previousElementSibling).is(t) ? h([e.previousElementSibling]) : h([]) : e.previousElementSibling ? h([e.previousElementSibling]) : h([]) } return h([]) }

        function R(t) { const e = []; let s = this[0]; if (!s) return h([]); for (; s.previousElementSibling;) { const i = s.previousElementSibling;
                t ? h(i).is(t) && e.push(i) : e.push(i), s = i } return h(e) }

        function B(t) { const e = []; for (let s = 0; s < this.length; s += 1) null !== this[s].parentNode && (t ? h(this[s].parentNode).is(t) && e.push(this[s].parentNode) : e.push(this[s].parentNode)); return h(e) }

        function V(t) { const e = []; for (let s = 0; s < this.length; s += 1) { let i = this[s].parentNode; for (; i;) t ? h(i).is(t) && e.push(i) : e.push(i), i = i.parentNode } return h(e) }

        function F(t) { let e = this; return void 0 === t ? h([]) : (e.is(t) || (e = e.parents(t).eq(0)), e) }

        function j(t) { const e = []; for (let s = 0; s < this.length; s += 1) { const i = this[s].querySelectorAll(t); for (let t = 0; t < i.length; t += 1) e.push(i[t]) } return h(e) }

        function Y(t) { const e = []; for (let s = 0; s < this.length; s += 1) { const i = this[s].children; for (let s = 0; s < i.length; s += 1) t && !h(i[s]).is(t) || e.push(i[s]) } return h(e) }

        function U() { for (let t = 0; t < this.length; t += 1) this[t].parentNode && this[t].parentNode.removeChild(this[t]); return this }

        function W(t) { const e = t;
            Object.keys(e).forEach(t => { try { e[t] = null } catch (t) {} try { delete e[t] } catch (t) {} }) }

        function X(t, e) { return void 0 === e && (e = 0), setTimeout(t, e) }

        function G() { return Date.now() }

        function _(t) { const e = i(); let s; return e.getComputedStyle && (s = e.getComputedStyle(t, null)), !s && t.currentStyle && (s = t.currentStyle), s || (s = t.style), s }

        function J(t, e) { void 0 === e && (e = "x"); const s = i(); let o, a, n; const r = _(t); return s.WebKitCSSMatrix ? (a = r.transform || r.webkitTransform, a.split(",").length > 6 && (a = a.split(", ").map(t => t.replace(",", ".")).join(", ")), n = new s.WebKitCSSMatrix("none" === a ? "" : a)) : (n = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), o = n.toString().split(",")), "x" === e && (a = s.WebKitCSSMatrix ? n.m41 : 16 === o.length ? parseFloat(o[12]) : parseFloat(o[4])), "y" === e && (a = s.WebKitCSSMatrix ? n.m42 : 16 === o.length ? parseFloat(o[13]) : parseFloat(o[5])), a || 0 }

        function Z(t) { return "object" == typeof t && null !== t && t.constructor && "Object" === Object.prototype.toString.call(t).slice(8, -1) }

        function K(t) { return "undefined" != typeof window && void 0 !== window.HTMLElement ? t instanceof HTMLElement : t && (1 === t.nodeType || 11 === t.nodeType) }

        function Q() { const t = Object(arguments.length <= 0 ? void 0 : arguments[0]),
                e = ["__proto__", "constructor", "prototype"]; for (let s = 1; s < arguments.length; s += 1) { const i = s < 0 || arguments.length <= s ? void 0 : arguments[s]; if (null != i && !K(i)) { const s = Object.keys(Object(i)).filter(t => e.indexOf(t) < 0); for (let e = 0, o = s.length; e < o; e += 1) { const o = s[e],
                            a = Object.getOwnPropertyDescriptor(i, o);
                        void 0 !== a && a.enumerable && (Z(t[o]) && Z(i[o]) ? i[o].__swiper__ ? t[o] = i[o] : Q(t[o], i[o]) : !Z(t[o]) && Z(i[o]) ? (t[o] = {}, i[o].__swiper__ ? t[o] = i[o] : Q(t[o], i[o])) : t[o] = i[o]) } } } return t }

        function tt(t, e, s) { t.style.setProperty(e, s) }

        function et(t) { let { swiper: e, targetPosition: s, side: o } = t; const a = i(),
                n = -e.translate; let r, l = null; const h = e.params.speed;
            e.wrapperEl.style.scrollSnapType = "none", a.cancelAnimationFrame(e.cssModeFrameID); const d = s > n ? "next" : "prev",
                p = (t, e) => "next" === d && t >= e || "prev" === d && t <= e,
                c = () => { r = (new Date).getTime(), null === l && (l = r); const t = Math.max(Math.min((r - l) / h, 1), 0),
                        i = .5 - Math.cos(t * Math.PI) / 2; let d = n + i * (s - n); if (p(d, s) && (d = s), e.wrapperEl.scrollTo({
                            [o]: d }), p(d, s)) return e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.scrollSnapType = "", setTimeout(() => { e.wrapperEl.style.overflow = "", e.wrapperEl.scrollTo({
                            [o]: d }) }), void a.cancelAnimationFrame(e.cssModeFrameID);
                    e.cssModeFrameID = a.requestAnimationFrame(c) };
            c() }

        function st() { const t = i(),
                e = s(); return { smoothScroll: e.documentElement && "scrollBehavior" in e.documentElement.style, touch: !!("ontouchstart" in t || t.DocumentTouch && e instanceof t.DocumentTouch), passiveListener: function() { let e = !1; try { const s = Object.defineProperty({}, "passive", {get() { e = !0 } });
                        t.addEventListener("testPassiveListener", null, s) } catch (t) {} return e }(), gestures: "ongesturestart" in t } }

        function it() { return Ye || (Ye = st()), Ye }

        function ot(t) { let { userAgent: e } = void 0 === t ? {} : t; const s = it(),
                o = i(),
                a = o.navigator.platform,
                n = e || o.navigator.userAgent,
                r = { ios: !1, android: !1 },
                l = o.screen.width,
                h = o.screen.height,
                d = n.match(/(Android);?[\s\/]+([\d.]+)?/); let p = n.match(/(iPad).*OS\s([\d_]+)/); const c = n.match(/(iPod)(.*OS\s([\d_]+))?/),
                u = !p && n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                m = "Win32" === a; let g = "MacIntel" === a; const f = ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"]; return !p && g && s.touch && f.indexOf(`${l}x${h}`) >= 0 && (p = n.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), g = !1), d && !m && (r.os = "android", r.android = !0), (p || u || c) && (r.os = "ios", r.ios = !0), r }

        function at(t) { return void 0 === t && (t = {}), Ue || (Ue = ot(t)), Ue }

        function nt() {
            function t() { const t = e.navigator.userAgent.toLowerCase(); return t.indexOf("safari") >= 0 && t.indexOf("chrome") < 0 && t.indexOf("android") < 0 } const e = i(); return { isSafari: t(), isWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent) } }

        function rt() { return We || (We = nt()), We }

        function lt(t) { let { swiper: e, on: s, emit: o } = t; const a = i(); let n = null,
                r = null; const l = () => { e && !e.destroyed && e.initialized && (o("beforeResize"), o("resize")) },
                h = () => { e && !e.destroyed && e.initialized && (n = new ResizeObserver(t => { r = a.requestAnimationFrame(() => { const { width: s, height: i } = e; let o = s,
                                a = i;
                            t.forEach(t => { let { contentBoxSize: s, contentRect: i, target: n } = t;
                                n && n !== e.el || (o = i ? i.width : (s[0] || s).inlineSize, a = i ? i.height : (s[0] || s).blockSize) }), o === s && a === i || l() }) }), n.observe(e.el)) },
                d = () => { r && a.cancelAnimationFrame(r), n && n.unobserve && e.el && (n.unobserve(e.el), n = null) },
                p = () => { e && !e.destroyed && e.initialized && o("orientationchange") };
            s("init", () => { e.params.resizeObserver && void 0 !== a.ResizeObserver ? h() : (a.addEventListener("resize", l), a.addEventListener("orientationchange", p)) }), s("destroy", () => { d(), a.removeEventListener("resize", l), a.removeEventListener("orientationchange", p) }) }

        function ht(t) {
            let { swiper: e, extendParams: s, on: o, emit: a } = t;
            const n = [],
                r = i(),
                l = function(t, e) { void 0 === e && (e = {}); const s = r.MutationObserver || r.WebkitMutationObserver,
                        i = new s(t => { if (1 === t.length) return void a("observerUpdate", t[0]); const e = function() { a("observerUpdate", t[0]) };
                            r.requestAnimationFrame ? r.requestAnimationFrame(e) : r.setTimeout(e, 0) });
                    i.observe(t, { attributes: void 0 === e.attributes || e.attributes, childList: void 0 === e.childList || e.childList, characterData: void 0 === e.characterData || e.characterData }), n.push(i) },
                h = () => {
                    if (e.params.observer) {
                        if (e.params.observeParents) { const t = e.$el.parents(); for (let e = 0; e < t.length; e += 1) l(t[e]) }
                        l(e.$el[0], { childList: e.params.observeSlideChildren }), l(e.$wrapperEl[0], { attributes: !1 })
                    }
                },
                d = () => { n.forEach(t => { t.disconnect() }), n.splice(0, n.length) };
            s({ observer: !1, observeParents: !1, observeSlideChildren: !1 }), o("init", h), o("destroy", d)
        }

        function dt() { const t = this; let e, s; const i = t.$el;
        ...
        function pt() {
            function t(t) { return s.isHorizontal() ? t : { width: "height", "margin-top": "margin-left", "margin-bottom ": "margin-right", "margin-left": "margin-top", "margin-right": "margin-bottom", "padding-left": "padding-top", "padding-right": "padding-bottom", marginRight: "marginBottom" }[t] }

            function e(e, s) { return parseFloat(e.getPropertyValue(t(s)) || 0) } const s = this,
                i = s.params,
                { $wrapperEl: o, size: a, rtlTranslate: n, wrongRTL: r } = s,
                l = s.virtual && i.virtual.enabled,
                h = l ? s.virtual.slides.length : s.slides.length,
                d = o.children(`.${s.params.slideClass}`),
                p = l ? s.virtual.slides.length : d.length; let c = []; const u = [],
                m = []; let g = i.slidesOffsetBefore; "function" == typeof g && (g = i.slidesOffsetBefore.call(s)); let f = i.slidesOffsetAfter; "function" == typeof f && (f = i.slidesOffsetAfter.call(s)); const x = s.snapGrid.length,
                y = s.slidesGrid.length; let b = i.spaceBetween,
                v = -g,
                D = 0,
                w = 0; if (void 0 === a) return; "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * a), s.virtualSize = -b, n ? d.css({ marginLeft: "", marginBottom: "", marginTop: "" }) : d.css({ marginRight: "", marginBottom: "", marginTop: "" }), i.centeredSlides && i.cssMode && (tt(s.wrapperEl, "--swiper-centered-offset-before", ""), tt(s.wrapperEl, "--swiper-centered-offset-after", "")); const T = i.grid && i.grid.rows > 1 && s.grid; let S;
            T && s.grid.initSlides(p); const E = "auto" === i.slidesPerView && i.breakpoints && Object.keys(i.breakpoints).filter(t => void 0 !== i.breakpoints[t].slidesPerView).length > 0; for (let o = 0; o < p; o += 1) { S = 0; const n = d.eq(o); if (T && s.grid.updateSlide(o, n, p, t), "none" !== n.css("display")) { if ("auto" === i.slidesPerView) { E && (d[o].style[t("width")] = ""); const a = getComputedStyle(n[0]),
                            r = n[0].style.transform,
                            l = n[0].style.webkitTransform; if (r && (n[0].style.transform = "none"), l && (n[0].style.webkitTransform = "none"), i.roundLengths) S = s.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0);
                        else { const t = e(a, "width"),
                                s = e(a, "padding-left"),
                                i = e(a, "padding-right"),
                                o = e(a, "margin-left"),
                                r = e(a, "margin-right"),
                                l = a.getPropertyValue("box-sizing"); if (l && "border-box" === l) S = t + o + r;
                            else { const { clientWidth: e, offsetWidth: a } = n[0];
                                S = t + s + i + o + r + (a - e) } }
                        r && (n[0].style.transform = r), l && (n[0].style.webkitTransform = l), i.roundLengths && (S = Math.floor(S)) } else S = (a - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (S = Math.floor(S)), d[o] && (d[o].style[t("width")] = `${S}px`);
                    d[o] && (d[o].swiperSlideSize = S), m.push(S), i.centeredSlides ? (v = v + S / 2 + D / 2 + b, 0 === D && 0 !== o && (v = v - a / 2 - b), 0 === o && (v = v - a / 2 - b), Math.abs(v) < .001 && (v = 0), i.roundLengths && (v = Math.floor(v)), w % i.slidesPerGroup == 0 && c.push(v), u.push(v)) : (i.roundLengths && (v = Math.floor(v)), (w - Math.min(s.params.slidesPerGroupSkip, w)) % s.params.slidesPerGroup == 0 && c.push(v), u.push(v), v = v + S + b), s.virtualSize += S + b, D = S, w += 1 } } if (s.virtualSize = Math.max(s.virtualSize, a) + f, n && r && ("slide" === i.effect || "coverflow" === i.effect) && o.css({ width: `${s.virtualSize+i.spaceBetween}px` }), i.setWrapperSize && o.css({
                    [t("width")]: `${s.virtualSize+i.spaceBetween}px` }), T && s.grid.updateWrapperSize(S, c, t), !i.centeredSlides) { const t = []; for (let e = 0; e < c.length; e += 1) { let o = c[e];
                    i.roundLengths && (o = Math.floor(o)), c[e] <= s.virtualSize - a && t.push(o) }
                c = t, Math.floor(s.virtualSize - a) - Math.floor(c[c.length - 1]) > 1 && c.push(s.virtualSize - a) } if (0 === c.length && (c = [0]), 0 !== i.spaceBetween) { const e = s.isHorizontal() && n ? "marginLeft" : t("marginRight");
                d.filter((t, e) => !i.cssMode || e !== d.length - 1).css({
                    [e]: `${b}px` }) } if (i.centeredSlides && i.centeredSlidesBounds) { let t = 0;
                m.forEach(e => { t += e + (i.spaceBetween ? i.spaceBetween : 0) }), t -= i.spaceBetween; const e = t - a;
                c = c.map(t => t < 0 ? -g : t > e ? e + f : t) } if (i.centerInsufficientSlides) { let t = 0; if (m.forEach(e => { t += e + (i.spaceBetween ? i.spaceBetween : 0) }), t -= i.spaceBetween, t < a) { const e = (a - t) / 2;
                    c.forEach((t, s) => { c[s] = t - e }), u.forEach((t, s) => { u[s] = t + e }) } } if (Object.assign(s, { slides: d, snapGrid: c, slidesGrid: u, slidesSizesGrid: m }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) { tt(s.wrapperEl, "--swiper-centered-offset-before", `${-c[0]}px`), tt(s.wrapperEl, "--swiper-centered-offset-after", `${s.size/2-m[m.length-1]/2}px`); const t = -s.snapGrid[0],
                    e = -s.slidesGrid[0];
                s.snapGrid = s.snapGrid.map(e => e + t), s.slidesGrid = s.slidesGrid.map(t => t + e) } if (p !== h && s.emit("slidesLengthChange"), c.length !== x && (s.params.watchOverflow && s.checkOverflow(), s.emit("snapGridLengthChange")), u.length !== y && s.emit("slidesGridLengthChange"), i.watchSlidesProgress && s.updateSlidesOffset(), !(l || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) { const t = `${i.containerModifierClass}backface-hidden`,
                    e = s.$el.hasClass(t);
                p <= i.maxBackfaceHiddenSlides ? e || s.$el.addClass(t) : e && s.$el.removeClass(t) } }

        function ct(t) { const e = this,
                s = [],
                i = e.virtual && e.params.virtual.enabled; let o, a = 0; "number" == typeof t ? e.setTransition(t) : !0 === t && e.setTransition(e.params.speed); const n = t => i ? e.slides.filter(e => parseInt(e.getAttribute("data-swiper-slide-index"), 10) === t)[0] : e.slides.eq(t)[0]; if ("auto" !== e.params.slidesPerView && e.params.slidesPerView > 1)
                if (e.params.centeredSlides) e.visibleSlides.each(t => { s.push(t) });
                else
                    for (o = 0; o < Math.ceil(e.params.slidesPerView); o += 1) { const t = e.activeIndex + o; if (t > e.slides.length && !i) break;
                        s.push(n(t)) } else s.push(n(e.activeIndex));
            for (o = 0; o < s.length; o += 1)
                if (void 0 !== s[o]) { const t = s[o].offsetHeight;
                    a = t > a ? t : a }(a || 0 === a) && e.$wrapperEl.css("height", `${a}px`) }

        function ut() { const t = this,
                e = t.slides; for (let s = 0; s < e.length; s += 1) e[s].swiperSlideOffset = t.isHorizontal() ? e[s].offsetLeft : e[s].offsetTop }

        function mt(t) { void 0 === t && (t = this && this.translate || 0); const e = this,
                s = e.params,
                { slides: i, rtlTranslate: o, snapGrid: a } = e; if (0 === i.length) return;
            void 0 === i[0].swiperSlideOffset && e.updateSlidesOffset(); let n = -t;
            o && (n = t), i.removeClass(s.slideVisibleClass), e.visibleSlidesIndexes = [], e.visibleSlides = []; for (let t = 0; t < i.length; t += 1) { const r = i[t]; let l = r.swiperSlideOffset;
                s.cssMode && s.centeredSlides && (l -= i[0].swiperSlideOffset); const h = (n + (s.centeredSlides ? e.minTranslate() : 0) - l) / (r.swiperSlideSize + s.spaceBetween),
                    d = (n - a[0] + (s.centeredSlides ? e.minTranslate() : 0) - l) / (r.swiperSlideSize + s.spaceBetween),
                    p = -(n - l),
                    c = p + e.slidesSizesGrid[t],
                    u = p >= 0 && p < e.size - 1 || c > 1 && c <= e.size || p <= 0 && c >= e.size;
                u && (e.visibleSlides.push(r), e.visibleSlidesIndexes.push(t), i.eq(t).addClass(s.slideVisibleClass)), r.progress = o ? -h : h, r.originalProgress = o ? -d : d }
            e.visibleSlides = h(e.visibleSlides) }

        function gt(t) { const e = this; if (void 0 === t) { const s = e.rtlTranslate ? -1 : 1;
                t = e && e.translate && e.translate * s || 0 } const s = e.params,
                i = e.maxTranslate() - e.minTranslate(); let { progress: o, isBeginning: a, isEnd: n } = e; const r = a,
                l = n;
            0 === i ? (o = 0, a = !0, n = !0) : (o = (t - e.minTranslate()) / i, a = o <= 0, n = o >= 1), Object.assign(e, { progress: o, isBeginning: a, isEnd: n }), (s.watchSlidesProgress || s.centeredSlides && s.autoHeight) && e.updateSlidesProgress(t), a && !r && e.emit("reachBeginning toEdge"), n && !l && e.emit("reachEnd toEdge"), (r && !a || l && !n) && e.emit("fromEdge"), e.emit("progress", o) }

        function ft() { const t = this,
                { slides: e, params: s, $wrapperEl: i, activeIndex: o, realIndex: a } = t,
                n = t.virtual && s.virtual.enabled; let r;
            e.removeClass(`${s.slideActiveClass} ${s.slideNextClass} ${s.slidePrevClass} ${s.slideDuplicateActiveClass} ${s.slideDuplicateNextClass} ${s.slideDuplicatePrevClass}`), r = n ? t.$wrapperEl.find(`.${s.slideClass}[data-swiper-slide-index="${o}"]`) : e.eq(o), r.addClass(s.slideActiveClass), s.loop && (r.hasClass(s.slideDuplicateClass) ? i.children(`.${s.slideClass}:not(.${s.slideDuplicateClass})[data-swiper-slide-index="${a}"]`).addClass(s.slideDuplicateActiveClass) : i.children(`.${s.slideClass}.${s.slideDuplicateClass}[data-swiper-slide-index="${a}"]`).addClass(s.slideDuplicateActiveClass)); let l = r.nextAll(`.${s.slideClass}`).eq(0).addClass(s.slideNextClass);
            s.loop && 0 === l.length && (l = e.eq(0), l.addClass(s.slideNextClass)); let h = r.prevAll(`.${s.slideClass}`).eq(0).addClass(s.slidePrevClass);
        ...
        function xt(t) { const e = this,
                s = e.rtlTranslate ? e.translate : -e.translate,
                { slidesGrid: i, snapGrid: o, params: a, activeIndex: n, realIndex: r, snapIndex: l } = e; let h, d = t; if (void 0 === d) { for (let t = 0; t < i.length; t += 1) void 0 !== i[t + 1] ? s >= i[t] && s < i[t + 1] - (i[t + 1] - i[t]) / 2 ? d = t : s >= i[t] && s < i[t + 1] && (d = t + 1) : s >= i[t] && (d = t);
                a.normalizeSlideIndex && (d < 0 || void 0 === d) && (d = 0) } if (o.indexOf(s) >= 0) h = o.indexOf(s);
            else { const t = Math.min(a.slidesPerGroupSkip, d);
                h = t + Math.floor((d - t) / a.slidesPerGroup) } if (h >= o.length && (h = o.length - 1), d === n) return void(h !== l && (e.snapIndex = h, e.emit("snapIndexChange"))); const p = parseInt(e.slides.eq(d).attr("data-swiper-slide-index") || d, 10);
            Object.assign(e, { snapIndex: h, realIndex: p, previousIndex: n, activeIndex: d }), e.emit("activeIndexChange"), e.emit("snapIndexChange"), r !== p && e.emit("realIndexChange"), (e.initialized || e.params.runCallbacksOnInit) && e.emit("slideChange") }

        function yt(t) { const e = this,
                s = e.params,
                i = h(t).closest(`.${s.slideClass}`)[0]; let o, a = !1; if (i)
                for (let t = 0; t < e.slides.length; t += 1)
                    if (e.slides[t] === i) { a = !0, o = t; break }
            if (!i || !a) return e.clickedSlide = void 0, void(e.clickedIndex = void 0);
            e.clickedSlide = i, e.virtual && e.params.virtual.enabled ? e.clickedIndex = parseInt(h(i).attr("data-swiper-slide-index"), 10) : e.clickedIndex = o, s.slideToClickedSlide && void 0 !== e.clickedIndex && e.clickedIndex !== e.activeIndex && e.slideToClickedSlide() }

        function bt(t) { void 0 === t && (t = this.isHorizontal() ? "x" : "y"); const e = this,
                { params: s, rtlTranslate: i, translate: o, $wrapperEl: a } = e; if (s.virtualTranslate) return i ? -o : o; if (s.cssMode) return o; let n = J(a[0], t); return i && (n = -n), n || 0 }

        function vt(t, e) { const s = this,
                { rtlTranslate: i, params: o, $wrapperEl: a, wrapperEl: n, progress: r } = s; let l = 0,
                h = 0; const d = 0; let p;
            s.isHorizontal() ? l = i ? -t : t : h = t, o.roundLengths && (l = Math.floor(l), h = Math.floor(h)), o.cssMode ? n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -l : -h : o.virtualTranslate || a.transform(`translate3d(${l}px, ${h}px, ${d}px)`), s.previousTranslate = s.translate, s.translate = s.isHorizontal() ? l : h; const c = s.maxTranslate() - s.minTranslate();
            p = 0 === c ? 0 : (t - s.minTranslate()) / c, p !== r && s.updateProgress(t), s.emit("setTranslate", s.translate, e) }

        function Dt() { return -this.snapGrid[0] }

        function wt() { return -this.snapGrid[this.snapGrid.length - 1] }

        function Tt(t, e, s, i, o) { void 0 === t && (t = 0), void 0 === e && (e = this.params.speed), void 0 === s && (s = !0), void 0 === i && (i = !0); const a = this,
                { params: n, wrapperEl: r } = a; if (a.animating && n.preventInteractionOnTransition) return !1; const l = a.minTranslate(),
                h = a.maxTranslate(); let d; if (d = i && t > l ? l : i && t < h ? h : t, a.updateProgress(d), n.cssMode) { const t = a.isHorizontal(); if (0 === e) r[t ? "scrollLeft" : "scrollTop"] = -d;
                else { if (!a.support.smoothScroll) return et({ swiper: a, targetPosition: -d, side: t ? "left" : "top" }), !0;
                    r.scrollTo({
        ...
        function St(t, e) { const s = this;
            s.params.cssMode || s.$wrapperEl.transition(t), s.emit("setTransition", t, e) }

        function Et(t) { let { swiper: e, runCallbacks: s, direction: i, step: o } = t; const { activeIndex: a, previousIndex: n } = e; let r = i; if (r || (r = a > n ? "next" : a < n ? "prev" : "reset"), e.emit(`transition${o}`), s && a !== n) { if ("reset" === r) return void e.emit(`slideResetTransition${o}`);
                e.emit(`slideChangeTransition${o}`), "next" === r ? e.emit(`slideNextTransition${o}`) : e.emit(`slidePrevTransition${o}`) } }

        function At(t, e) { void 0 === t && (t = !0); const s = this,
                { params: i } = s;
            i.cssMode || (i.autoHeight && s.updateAutoHeight(), Et({ swiper: s, runCallbacks: t, direction: e, step: "Start" })) }

        function Ct(t, e) { void 0 === t && (t = !0); const s = this,
                { params: i } = s;
            s.animating = !1, i.cssMode || (s.setTransition(0), Et({ swiper: s, runCallbacks: t, direction: e, step: "End" })) }

        function It(t, e, s, i, o) { if (void 0 === t && (t = 0), void 0 === e && (e = this.params.speed), void 0 === s && (s = !0), "number" != typeof t && "string" != typeof t) throw new Error(`The 'index' argument cannot have type other than 'number' or 'string'. [${typeof t}] given.`); if ("string" == typeof t) { const e = parseInt(t, 10),
                    s = isFinite(e); if (!s) throw new Error(`The passed-in 'index' (string) couldn't be converted to 'number'. [${t}] given.`);
                t = e } const a = this; let n = t;
            n < 0 && (n = 0); const { params: r, snapGrid: l, slidesGrid: h, previousIndex: d, activeIndex: p, rtlTranslate: c, wrapperEl: u, enabled: m } = a; if (a.animating && r.preventInteractionOnTransition || !m && !i && !o) return !1; const g = Math.min(a.params.slidesPerGroupSkip, n); let f = g + Math.floor((n - g) / a.params.slidesPerGroup);
            f >= l.length && (f = l.length - 1), (p || r.initialSlide || 0) === (d || 0) && s && a.emit("beforeSlideChangeStart"); const x = -l[f]; if (a.updateProgress(x), r.normalizeSlideIndex)
                for (let t = 0; t < h.length; t += 1) { const e = -Math.floor(100 * x),
                        s = Math.floor(100 * h[t]),
                        i = Math.floor(100 * h[t + 1]);
                    void 0 !== h[t + 1] ? e >= s && e < i - (i - s) / 2 ? n = t : e >= s && e < i && (n = t + 1) : e >= s && (n = t) }
            if (a.initialized && n !== p) { if (!a.allowSlideNext && x < a.translate && x < a.minTranslate()) return !1; if (!a.allowSlidePrev && x > a.translate && x > a.maxTranslate() && (p || 0) !== n) return !1 } let y; if (y = n > p ? "next" : n < p ? "prev" : "reset", c && -x === a.translate || !c && x === a.translate) return a.updateActiveIndex(n), r.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== r.effect && a.setTranslate(x), "reset" !== y && (a.transitionStart(s, y), a.transitionEnd(s, y)), !1; if (r.cssMode) { const t = a.isHorizontal(),
                    s = c ? x : -x; if (0 === e) { const e = a.virtual && a.params.virtual.enabled;
                    e && (a.wrapperEl.style.scrollSnapType = "none", a._immediateVirtual = !0), u[t ? "scrollLeft" : "scrollTop"] = s, e && requestAnimationFrame(() => { a.wrapperEl.style.scrollSnapType = "", a._swiperImmediateVirtual = !1 }) } else { if (!a.support.smoothScroll) return et({ swiper: a, targetPosition: s, side: t ? "left" : "top" }), !0;
                    u.scrollTo({
        ...
        function kt(t, e, s, i) { void 0 === t && (t = 0), void 0 === e && (e = this.params.speed), void 0 === s && (s = !0); const o = this; let a = t; return o.params.loop && (a += o.loopedSlides), o.slideTo(a, e, s, i) }

        function Mt(t, e, s) { void 0 === t && (t = this.params.speed), void 0 === e && (e = !0); const i = this,
                { animating: o, enabled: a, params: n } = i; if (!a) return i; let r = n.slidesPerGroup; "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && (r = Math.max(i.slidesPerViewDynamic("current", !0), 1)); const l = i.activeIndex < n.slidesPerGroupSkip ? 1 : r; if (n.loop) { if (o && n.loopPreventsSlide) return !1;
                i.loopFix(), i._clientLeft = i.$wrapperEl[0].clientLeft } return n.rewind && i.isEnd ? i.slideTo(0, t, e, s) : i.slideTo(i.activeIndex + l, t, e, s) }

        function Lt(t, e, s) {
            function i(t) { return t < 0 ? -Math.floor(Math.abs(t)) : Math.floor(t) }
            void 0 === t && (t = this.params.speed), void 0 === e && (e = !0); const o = this,
                { params: a, animating: n, snapGrid: r, slidesGrid: l, rtlTranslate: h, enabled: d } = o; if (!d) return o; if (a.loop) { if (n && a.loopPreventsSlide) return !1;
                o.loopFix(), o._clientLeft = o.$wrapperEl[0].clientLeft } const p = h ? o.translate : -o.translate,
                c = i(p),
                u = r.map(t => i(t)); let m = r[u.indexOf(c) - 1]; if (void 0 === m && a.cssMode) { let t;
                r.forEach((e, s) => { c >= e && (t = s) }), void 0 !== t && (m = r[t > 0 ? t - 1 : t]) } let g = 0; if (void 0 !== m && (g = l.indexOf(m), g < 0 && (g = o.activeIndex - 1), "auto" === a.slidesPerView && 1 === a.slidesPerGroup && a.slidesPerGroupAuto && (g = g - o.slidesPerViewDynamic("previous", !0) + 1, g = Math.max(g, 0))), a.rewind && o.isBeginning) { const i = o.params.virtual && o.params.virtual.enabled && o.virtual ? o.virtual.slides.length - 1 : o.slides.length - 1; return o.slideTo(i, t, e, s) } return o.slideTo(g, t, e, s) }

        function Pt(t, e, s) { void 0 === t && (t = this.params.speed), void 0 === e && (e = !0); const i = this; return i.slideTo(i.activeIndex, t, e, s) }

        function $t(t, e, s, i) { void 0 === t && (t = this.params.speed), void 0 === e && (e = !0), void 0 === i && (i = .5); const o = this; let a = o.activeIndex; const n = Math.min(o.params.slidesPerGroupSkip, a),
                r = n + Math.floor((a - n) / o.params.slidesPerGroup),
                l = o.rtlTranslate ? o.translate : -o.translate; if (l >= o.snapGrid[r]) { const t = o.snapGrid[r],
                    e = o.snapGrid[r + 1];
                l - t > (e - t) * i && (a += o.params.slidesPerGroup) } else { const t = o.snapGrid[r - 1],
                    e = o.snapGrid[r];
                l - t <= (e - t) * i && (a -= o.params.slidesPerGroup) } return a = Math.max(a, 0), a = Math.min(a, o.slidesGrid.length - 1), o.slideTo(a, t, e, s) }

        function Ot() { const t = this,
                { params: e, $wrapperEl: s } = t,
                i = "auto" === e.slidesPerView ? t.slidesPerViewDynamic() : e.slidesPerView; let o, a = t.clickedIndex; if (e.loop) { if (t.animating) return;
                o = parseInt(h(t.clickedSlide).attr("data-swiper-slide-index"), 10), e.centeredSlides ? a < t.loopedSlides - i / 2 || a > t.slides.length - t.loopedSlides + i / 2 ? (t.loopFix(), a = s.children(`.${e.slideClass}[data-swiper-slide-index="${o}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), X(() => { t.slideTo(a) })) : t.slideTo(a) : a > t.slides.length - i ? (t.loopFix(), a = s.children(`.${e.slideClass}[data-swiper-slide-index="${o}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), X(() => { t.slideTo(a) })) : t.slideTo(a) } else t.slideTo(a) }

        function Nt() { const t = this,
                e = s(),
                { params: i, $wrapperEl: o } = t,
                a = o.children().length > 0 ? h(o.children()[0].parentNode) : o;
            a.children(`.${i.slideClass}.${i.slideDuplicateClass}`).remove(); let n = a.children(`.${i.slideClass}`); if (i.loopFillGroupWithBlank) { const t = i.slidesPerGroup - n.length % i.slidesPerGroup; if (t !== i.slidesPerGroup) { for (let s = 0; s < t; s += 1) { const t = h(e.createElement("div")).addClass(`${i.slideClass} ${i.slideBlankClass}`);
                        a.append(t) }
                    n = a.children(`.${i.slideClass}`) } } "auto" !== i.slidesPerView || i.loopedSlides || (i.loopedSlides = n.length), t.loopedSlides = Math.ceil(parseFloat(i.loopedSlides || i.slidesPerView, 10)), t.loopedSlides += i.loopAdditionalSlides, t.loopedSlides > n.length && (t.loopedSlides = n.length); const r = [],
                l = [];
            n.each((e, s) => { const i = h(e);
                s < t.loopedSlides && l.push(e), s < n.length && s >= n.length - t.loopedSlides && r.push(e), i.attr("data-swiper-slide-index", s) }); for (let t = 0; t < l.length; t += 1) a.append(h(l[t].cloneNode(!0)).addClass(i.slideDuplicateClass)); for (let t = r.length - 1; t >= 0; t -= 1) a.prepend(h(r[t].cloneNode(!0)).addClass(i.slideDuplicateClass)) }

        function zt() { const t = this;
            t.emit("beforeLoopFix"); const { activeIndex: e, slides: s, loopedSlides: i, allowSlidePrev: o, allowSlideNext: a, snapGrid: n, rtlTranslate: r } = t; let l;
            t.allowSlidePrev = !0, t.allowSlideNext = !0; const h = -n[e],
                d = h - t.getTranslate(); if (e < i) { l = s.length - 3 * i + e, l += i; const o = t.slideTo(l, 0, !1, !0);
                o && 0 !== d && t.setTranslate((r ? -t.translate : t.translate) - d) } else if (e >= s.length - i) { l = -s.length + e + i, l += i; const o = t.slideTo(l, 0, !1, !0);
                o && 0 !== d && t.setTranslate((r ? -t.translate : t.translate) - d) }
            t.allowSlidePrev = o, t.allowSlideNext = a, t.emit("loopFix") }

        function Ht() { const t = this,
                { $wrapperEl: e, params: s, slides: i } = t;
            e.children(`.${s.slideClass}.${s.slideDuplicateClass},.${s.slideClass}.${s.slideBlankClass}`).remove(), i.removeAttr("data-swiper-slide-index") }

        function qt(t) { const e = this; if (e.support.touch || !e.params.simulateTouch || e.params.watchOverflow && e.isLocked || e.params.cssMode) return; const s = "container" === e.params.touchEventsTarget ? e.el : e.wrapperEl;
            s.style.cursor = "move", s.style.cursor = t ? "grabbing" : "grab" }

        function Rt() { const t = this;
        ...
        function Bt(t, e) {
            function o(e) { if (!e || e === s() || e === i()) return null;
                e.assignedSlot && (e = e.assignedSlot); const a = e.closest(t); return a || o(e.getRootNode().host) } return void 0 === e && (e = this), o(e) }

        function Vt(t) { const e = this,
                o = s(),
                a = i(),
                n = e.touchEventsData,
                { params: r, touches: l, enabled: d } = e; if (!d) return; if (e.animating && r.preventInteractionOnTransition) return;!e.animating && r.cssMode && r.loop && e.loopFix(); let p = t;
            p.originalEvent && (p = p.originalEvent); let c = h(p.target); if ("wrapper" === r.touchEventsTarget && !c.closest(e.wrapperEl).length) return; if (n.isTouchEvent = "touchstart" === p.type, !n.isTouchEvent && "which" in p && 3 === p.which) return; if (!n.isTouchEvent && "button" in p && p.button > 0) return; if (n.isTouched && n.isMoved) return; const u = !!r.noSwipingClass && "" !== r.noSwipingClass;
            u && p.target && p.target.shadowRoot && t.path && t.path[0] && (c = h(t.path[0])); const m = r.noSwipingSelector ? r.noSwipingSelector : `.${r.noSwipingClass}`,
                g = !(!p.target || !p.target.shadowRoot); if (r.noSwiping && (g ? Bt(m, p.target) : c.closest(m)[0])) return void(e.allowClick = !0); if (r.swipeHandler && !c.closest(r.swipeHandler)[0]) return;
            l.currentX = "touchstart" === p.type ? p.targetTouches[0].pageX : p.pageX, l.currentY = "touchstart" === p.type ? p.targetTouches[0].pageY : p.pageY; const f = l.currentX,
                x = l.currentY,
                y = r.edgeSwipeDetection || r.iOSEdgeSwipeDetection,
                b = r.edgeSwipeThreshold || r.iOSEdgeSwipeThreshold; if (y && (f <= b || f >= a.innerWidth - b)) { if ("prevent" !== y) return;
                axPreventDefault(t) } if (Object.assign(n, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), l.startX = f, l.startY = x, n.touchStartTime = G(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== p.type) { let t = !0;
                c.is(n.focusableElements) && (t = !1, "SELECT" === c[0].nodeName && (n.isTouched = !1)), o.activeElement && h(o.activeElement).is(n.focusableElements) && o.activeElement !== c[0] && o.activeElement.blur(); const s = t && e.allowTouchMove && r.touchStartPreventDefault;!r.touchStartForcePreventDefault && !s || c[0].isContentEditable || axPreventDefault(p) }
            e.params.freeMode && e.params.freeMode.enabled && e.freeMode && e.animating && !r.cssMode && e.freeMode.onTouchStart(), e.emit("touchStart", p) }

        function Ft(t) { const e = s(),
                i = this,
                o = i.touchEventsData,
                ...
                u = "touchmove" === d.type ? p.pageY : d.pageY; if (d.preventedByNestedSwiper) return n.startX = c, void(n.startY = u); if (!i.allowTouchMove) return h(d.target).is(o.focusableElements) || (i.allowClick = !1), void(o.isTouched && (Object.assign(n, { startX: c, startY: u, currentX: c, currentY: u }), o.touchStartTime = G())); if (o.isTouchEvent && a.touchReleaseOnEdges && !a.loop)
                if (i.isVertical()) { if (u < n.startY && i.translate <= i.maxTranslate() || u > n.startY && i.translate >= i.minTranslate()) return o.isTouched = !1, void(o.isMoved = !1) } else if (c < n.startX && i.translate <= i.maxTranslate() || c > n.startX && i.translate >= i.minTranslate()) return; if (o.isTouchEvent && e.activeElement && d.target === e.activeElement && h(d.target).is(o.focusableElements)) return o.isMoved = !0, void(i.allowClick = !1); if (o.allowTouchCallbacks && i.emit("touchMove", d), d.targetTouches && d.targetTouches.length > 1) return;
            n.currentX = c, n.currentY = u; const m = n.currentX - n.startX,
                g = n.currentY - n.startY; if (i.params.threshold && Math.sqrt(m ** 2 + g ** 2) < i.params.threshold) return; if (void 0 === o.isScrolling) { let t;
                i.isHorizontal() && n.currentY === n.startY || i.isVertical() && n.currentX === n.startX ? o.isScrolling = !1 : m * m + g * g >= 25 && (t = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, o.isScrolling = i.isHorizontal() ? t > a.touchAngle : 90 - t > a.touchAngle) } if (o.isScrolling && i.emit("touchMoveOpposite", d), void 0 === o.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (o.startMoving = !0)), o.isScrolling) return void(o.isTouched = !1); if (!o.startMoving) return;
            i.allowClick = !1, !a.cssMode && d.cancelable && axPreventDefault(d), a.touchMoveStopPropagation && !a.nested && d.stopPropagation(), o.isMoved || (a.loop && !a.cssMode && i.loopFix(), o.startTranslate = i.getTranslate(), i.setTransition(0), i.animating && i.$wrapperEl.trigger("webkitTransitionEnd transitionend"), o.allowMomentumBounce = !1, !a.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", d)), i.emit("sliderMove", d), o.isMoved = !0; let f = i.isHorizontal() ? m : g;
            n.diff = f, f *= a.touchRatio, r && (f = -f), i.swipeDirection = f > 0 ? "prev" : "next", o.currentTranslate = f + o.startTranslate; let x = !0,
                y = a.resistanceRatio; if (a.touchReleaseOnEdges && (y = 0), f > 0 && o.currentTranslate > i.minTranslate() ? (x = !1, a.resistance && (o.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + o.startTranslate + f) ** y)) : f < 0 && o.currentTranslate < i.maxTranslate() && (x = !1, a.resistance && (o.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - o.startTranslate - f) ** y)), x && (d.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && o.currentTranslate < o.startTranslate && (o.currentTranslate = o.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && o.currentTranslate > o.startTranslate && (o.currentTranslate = o.startTranslate), i.allowSlidePrev || i.allowSlideNext || (o.currentTranslate = o.startTranslate), a.threshold > 0) { if (!(Math.abs(f) > a.threshold || o.allowThresholdMove)) return void(o.currentTranslate = o.startTranslate); if (!o.allowThresholdMove) return o.allowThresholdMove = !0, n.startX = n.currentX, n.startY = n.currentY, o.currentTranslate = o.startTranslate, void(n.diff = i.isHorizontal() ? n.currentX - n.startX : n.currentY - n.startY) }
            a.followFinger && !a.cssMode && ((a.freeMode && a.freeMode.enabled && i.freeMode || a.watchSlidesProgress) && (i.updateActiveIndex(), i.updateSlidesClasses()), i.params.freeMode && a.freeMode.enabled && i.freeMode && i.freeMode.onTouchMove(), i.updateProgress(o.currentTranslate), i.setTranslate(o.currentTranslate)) }

        function jt(t) { const e = this,
                s = e.touchEventsData,
                { params: i, touches: o, rtlTranslate: a, slidesGrid: n, enabled: r } = e; if (!r) return; let l = t; if (l.originalEvent && (l = l.originalEvent), s.allowTouchCallbacks && e.emit("touchEnd", l), s.allowTouchCallbacks = !1, !s.isTouched) return s.isMoved && i.grabCursor && e.setGrabCursor(!1), s.isMoved = !1, void(s.startMoving = !1);
            i.grabCursor && s.isMoved && s.isTouched && (!0 === e.allowSlideNext || !0 === e.allowSlidePrev) && e.setGrabCursor(!1); const h = G(),
                d = h - s.touchStartTime; if (e.allowClick) { const t = l.path || l.composedPath && l.composedPath();
                e.updateClickedSlide(t && t[0] || l.target), e.emit("tap click", l), d < 300 && h - s.lastClickTime < 300 && e.emit("doubleTap doubleClick", l) } if (s.lastClickTime = G(), X(() => { e.destroyed || (e.allowClick = !0) }), !s.isTouched || !s.isMoved || !e.swipeDirection || 0 === o.diff || s.currentTranslate === s.startTranslate) return s.isTouched = !1, s.isMoved = !1, void(s.startMoving = !1); let p; if (s.isTouched = !1, s.isMoved = !1, s.startMoving = !1, p = i.followFinger ? a ? e.translate : -e.translate : -s.currentTranslate, i.cssMode) return; if (e.params.freeMode && i.freeMode.enabled) return void e.freeMode.onTouchEnd({ currentPos: p }); let c = 0,
                u = e.slidesSizesGrid[0]; for (let t = 0; t < n.length; t += t < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) { const e = t < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
                void 0 !== n[t + e] ? p >= n[t] && p < n[t + e] && (c = t, u = n[t + e] - n[t]) : p >= n[t] && (c = t, u = n[n.length - 1] - n[n.length - 2]) } let m = null,
                g = null;
            i.rewind && (e.isBeginning ? g = e.params.virtual && e.params.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (m = 0)); const f = (p - n[c]) / u,
                x = c < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup; if (d > i.longSwipesMs) { if (!i.longSwipes) return void e.slideTo(e.activeIndex); "next" === e.swipeDirection && (f >= i.longSwipesRatio ? e.slideTo(i.rewind && e.isEnd ? m : c + x) : e.slideTo(c)), "prev" === e.swipeDirection && (f > 1 - i.longSwipesRatio ? e.slideTo(c + x) : null !== g && f < 0 && Math.abs(f) > i.longSwipesRatio ? e.slideTo(g) : e.slideTo(c)) } else { if (!i.shortSwipes) return void e.slideTo(e.activeIndex); const t = e.navigation && (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl);
                t ? l.target === e.navigation.nextEl ? e.slideTo(c + x) : e.slideTo(c) : ("next" === e.swipeDirection && e.slideTo(null !== m ? m : c + x), "prev" === e.swipeDirection && e.slideTo(null !== g ? g : c)) } }

        function Yt() { const t = this,
                { params: e, el: s } = t; if (s && 0 === s.offsetWidth) return;
            e.breakpoints && t.setBreakpoint(); const { allowSlideNext: i, allowSlidePrev: o, snapGrid: a } = t;
            t.allowSlideNext = !0, t.allowSlidePrev = !0, t.updateSize(), t.updateSlides(), t.updateSlidesClasses(), ("auto" === e.slidesPerView || e.slidesPerView > 1) && t.isEnd && !t.isBeginning && !t.params.centeredSlides ? t.slideTo(t.slides.length - 1, 0, !1, !0) : t.slideTo(t.activeIndex, 0, !1, !0), t.autoplay && t.autoplay.running && t.autoplay.paused && t.autoplay.run(), t.allowSlidePrev = o, t.allowSlideNext = i, t.params.watchOverflow && a !== t.snapGrid && t.checkOverflow() }

        function Ut(t) { const e = this;
            e.enabled && (e.allowClick || (e.params.preventClicks && axPreventDefault(t), e.params.preventClicksPropagation && e.animating && (t.stopPropagation(), t.stopImmediatePropagation()))) }

        function Wt() { const t = this,
                { wrapperEl: e, rtlTranslate: s, enabled: i } = t; if (!i) return; let o;
            t.previousTranslate = t.translate, t.isHorizontal() ? t.translate = -e.scrollLeft : t.translate = -e.scrollTop, 0 === t.translate && (t.translate = 0), t.updateActiveIndex(), t.updateSlidesClasses(); const a = t.maxTranslate() - t.minTranslate();
            o = 0 === a ? 0 : (t.translate - t.minTranslate()) / a, o !== t.progress && t.updateProgress(s ? -t.translate : t.translate), t.emit("setTranslate", t.translate, !1) }

        function Xt() {}

        function Gt() { const t = this,
                e = s(),
                { params: i, support: o } = t;
            t.onTouchStart = Vt.bind(t), t.onTouchMove = Ft.bind(t), t.onTouchEnd = jt.bind(t), i.cssMode && (t.onScroll = Wt.bind(t)), t.onClick = Ut.bind(t), o.touch && !ts && (e.addEventListener("touchstart", Xt), ts = !0), es(t, "on") }

        function _t() { const t = this;
            es(t, "off") }

        function Jt() {
            const t = this,
                { activeIndex: e, initialized: s, loopedSlides: i = 0, params: o, $el: a } = t,
                n = o.breakpoints;
            if (!n || n && 0 === Object.keys(n).length) return;
            const r = t.getBreakpoint(n, t.params.breakpointsBase, t.el);
            if (!r || t.currentBreakpoint === r) return;
            const l = r in n ? n[r] : void 0,
                h = l || t.originalParams,
                d = is(t, o),
                p = is(t, h),
                c = o.enabled;
            d && !p ? (a.removeClass(`${o.containerModifierClass}grids ${o.containerModifierClass}grid-column`), t.emitContainerClasses()) : !d && p && (a.addClass(`${o.containerModifierClass}grids`), (h.grid.fill && "column" === h.grid.fill || !h.grid.fill && "column" === o.grid.fill) && a.addClass(`${o.containerModifierClass}grid-column`), t.emitContainerClasses());
            const u = h.direction && h.direction !== o.direction,
                m = o.loop && (h.slidesPerView !== o.slidesPerView || u);
            u && s && t.changeDirection(), Q(t.params, h);
            const g = t.params.enabled;
            Object.assign(t, {
                allowTouchMove: t.params.allowTouchMove,
                allowSlideNext: t.params.allowSlideNext,
                allowSlidePrev: t.params.allowSlidePrev
            }), c && !g ? t.disable() : !c && g && t.enable(), t.currentBreakpoint = r, t.emit("_beforeBreakpoint", h), m && s && (t.loopDestroy(), t.loopCreate(), t.updateSlides(), t.slideTo(e - i + t.loopedSlides, 0, !1)), t.emit("breakpoint", h)
        }

        function Zt(t, e, s) { if (void 0 === e && (e = "window"), !t || "container" === e && !s) return; let o = !1; const a = i(),
                n = "window" === e ? a.innerHeight : s.clientHeight,
                r = Object.keys(t).map(t => { if ("string" == typeof t && 0 === t.indexOf("@")) { const e = parseFloat(t.substr(1)),
                            s = n * e; return { value: s, point: t } } return { value: t, point: t } });
            r.sort((t, e) => parseInt(t.value, 10) - parseInt(e.value, 10)); for (let t = 0; t < r.length; t += 1) { const { point: i, value: n } = r[t]; "window" === e ? a.matchMedia(`(min-width: ${n}px)`).matches && (o = i) : n <= s.clientWidth && (o = i) } return o || "max" }

        function Kt(t, e) { const s = []; return t.forEach(t => { "object" == typeof t ? Object.keys(t).forEach(i => { t[i] && s.push(e + i) }) : "string" == typeof t && s.push(e + t) }), s }

        function Qt() { const t = this,
                { classNames: e, params: s, rtl: i, $el: o, device: a, support: n } = t,
            ...
            e.push(...r), o.addClass([...e].join(" ")), t.emitContainerClasses() }

        function te() { const t = this,
                { $el: e, classNames: s } = t;
            e.removeClass(s.join(" ")), t.emitContainerClasses() }

        function ee(t, e, s, o, a, n) {
            function r() { n && n() } const l = i(); let d; const p = h(t).parent("picture")[0];
            p || t.complete && a ? r() : e ? (d = new l.Image, d.onload = r, d.onerror = r, o && (d.sizes = o), s && (d.srcset = s), e && (d.src = e)) : r() }

        function se() {
            function t() { null != e && e && !e.destroyed && (void 0 !== e.imagesLoaded && (e.imagesLoaded += 1), e.imagesLoaded === e.imagesToLoad.length && (e.params.updateOnImagesReady && e.update(), e.emit("imagesReady"))) } const e = this;
            e.imagesToLoad = e.$el.find("img"); for (let s = 0; s < e.imagesToLoad.length; s += 1) { const i = e.imagesToLoad[s];
                e.loadImage(i, i.currentSrc || i.getAttribute("src"), i.srcset || i.getAttribute("srcset"), i.sizes || i.getAttribute("sizes"), !0, t) } }

        function ie() { const t = this,
                { isLocked: e, params: s } = t,
                { slidesOffsetBefore: i } = s; if (i) { const e = t.slides.length - 1,
                    s = t.slidesGrid[e] + t.slidesSizesGrid[e] + 2 * i;
                t.isLocked = t.size > s } else t.isLocked = 1 === t.snapGrid.length;!0 === s.allowSlideNext && (t.allowSlideNext = !t.isLocked), !0 === s.allowSlidePrev && (t.allowSlidePrev = !t.isLocked), e && e !== t.isLocked && (t.isEnd = !1), e !== t.isLocked && t.emit(t.isLocked ? "lock" : "unlock") }

        function oe(t, e) { return function(s) { void 0 === s && (s = {}); const i = Object.keys(s)[0],
                    o = s[i]; "object" == typeof o && null !== o ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === t[i] && (t[i] = { auto: !0 }), i in t && "enabled" in o ? (!0 === t[i] && (t[i] = { enabled: !0 }), "object" != typeof t[i] || "enabled" in t[i] || (t[i].enabled = !0), t[i] || (t[i] = { enabled: !1 }), Q(e, s)) : Q(e, s)) : Q(e, s) } }

        function ae(t) {
            function e(t, e) { const s = l.params.virtual; if (s.cache && l.virtual.cache[e]) return l.virtual.cache[e]; const i = s.renderSlide ? h(s.renderSlide.call(l, t, e)) : h(`<div class="${l.params.slideClass}" data-swiper-slide-index="${e}">${t}</div>`); return i.attr("data-swiper-slide-index") || i.attr("data-swiper-slide-index", e), s.cache && (l.virtual.cache[e] = i), i }

            function s(t) {
                function s() { l.updateSlides(), l.updateProgress(), l.updateSlidesClasses(), l.lazy && l.params.lazy.enabled && l.lazy.load(), c("virtualUpdate") } const { slidesPerView: i, slidesPerGroup: o, centeredSlides: a } = l.params, { addSlidesBefore: n, addSlidesAfter: r } = l.params.virtual, { from: h, to: d, slides: p, slidesGrid: u, offset: m } = l.virtual;
                l.params.cssMode || l.updateActiveIndex(); const g = l.activeIndex || 0; let f, x, y;
                f = l.rtlTranslate ? "right" : l.isHorizontal() ? "left" : "top", a ? (x = Math.floor(i / 2) + o + r, y = Math.floor(i / 2) + o + n) : (x = i + (o - 1) + r, y = o + n); const b = Math.max((g || 0) - y, 0),
                    v = Math.min((g || 0) + x, p.length - 1),
                    D = (l.slidesGrid[b] || 0) - (l.slidesGrid[0] || 0); if (Object.assign(l.virtual, { from: b, to: v, offset: D, slidesGrid: l.slidesGrid }), h === b && d === v && !t) return l.slidesGrid !== u && D !== m && l.slides.css(f, `${D}px`), l.updateProgress(), void c("virtualUpdate"); if (l.params.virtual.renderExternal) return l.params.virtual.renderExternal.call(l, { offset: D, from: b, to: v, slides: function() { const t = []; for (let e = b; e <= v; e += 1) t.push(p[e]); return t }() }), void(l.params.virtual.renderExternalUpdate ? s() : c("virtualUpdate")); const w = [],
                    T = []; if (t) l.$wrapperEl.find(`.${l.params.slideClass}`).remove();
                else
                    for (let t = h; t <= d; t += 1)(t < b || t > v) && l.$wrapperEl.find(`.${l.params.slideClass}[data-swiper-slide-index="${t}"]`).remove(); for (let e = 0; e < p.length; e += 1) e >= b && e <= v && (void 0 === d || t ? T.push(e) : (e > d && T.push(e), e < h && w.push(e)));
                T.forEach(t => { l.$wrapperEl.append(e(p[t], t)) }), w.sort((t, e) => e - t).forEach(t => { l.$wrapperEl.prepend(e(p[t], t)) }), l.$wrapperEl.children(".swiper-slide").css(f, `${D}px`), s() }

            function i(t) { if ("object" == typeof t && "length" in t)
                    for (let e = 0; e < t.length; e += 1) t[e] && l.virtual.slides.push(t[e]);
                else l.virtual.slides.push(t);
                s(!0) }

            function o(t) { const e = l.activeIndex; let i = e + 1,
                    o = 1; if (Array.isArray(t)) { for (let e = 0; e < t.length; e += 1) t[e] && l.virtual.slides.unshift(t[e]);
                    i = e + t.length, o = t.length } else l.virtual.slides.unshift(t); if (l.params.virtual.cache) { const t = l.virtual.cache,
                        e = {};
                    Object.keys(t).forEach(s => { const i = t[s],
                            a = i.attr("data-swiper-slide-index");
                        a && i.attr("data-swiper-slide-index", parseInt(a, 10) + o), e[parseInt(s, 10) + o] = i }), l.virtual.cache = e }
                s(!0), l.slideTo(i, 0) }

            function a(t) { if (null == t) return; let e = l.activeIndex; if (Array.isArray(t))
                    for (let s = t.length - 1; s >= 0; s -= 1) l.virtual.slides.splice(t[s], 1), l.params.virtual.cache && delete l.virtual.cache[t[s]], t[s] < e && (e -= 1), e = Math.max(e, 0);
                else l.virtual.slides.splice(t, 1), l.params.virtual.cache && delete l.virtual.cache[t], t < e && (e -= 1), e = Math.max(e, 0);
                s(!0), l.slideTo(e, 0) }

            function n() { l.virtual.slides = [], l.params.virtual.cache && (l.virtual.cache = {}), s(!0), l.slideTo(0, 0) } let r, { swiper: l, extendParams: d, on: p, emit: c } = t;
            d({ virtual: { enabled: !1, slides: [], cache: !0, renderSlide: null, renderExternal: null, renderExternalUpdate: !0, addSlidesBefore: 0, addSlidesAfter: 0 } }), l.virtual = { cache: {}, from: void 0, to: void 0, slides: [], offset: 0, slidesGrid: [] }, p("beforeInit", () => { l.params.virtual.enabled && (l.virtual.slides = l.params.virtual.slides, l.classNames.push(`${l.params.containerModifierClass}virtual`), l.params.watchSlidesProgress = !0, l.originalParams.watchSlidesProgress = !0, l.params.initialSlide || s()) }), p("setTranslate", () => { l.params.virtual.enabled && (l.params.cssMode && !l._immediateVirtual ? (clearTimeout(r), r = setTimeout(() => { s() }, 100)) : s()) }), p("init update resize", () => { l.params.virtual.enabled && l.params.cssMode && tt(l.wrapperEl, "--swiper-virtual-size", `${l.virtualSize}px`) }), Object.assign(l.virtual, { appendSlide: i, prependSlide: o, removeSlide: a, removeAllSlides: n, update: s }) }

        function ne(t) {
            function e(t) { if (!n.enabled) return; const { rtlTranslate: e } = n; let s = t;
                s.originalEvent && (s = s.originalEvent); const i = s.keyCode || s.charCode,
                    o = n.params.keyboard.pageUpDown,
                    a = o && 33 === i,
                    r = o && 34 === i,
                    l = 37 === i,
                    h = 39 === i,
                    u = 38 === i,
                    m = 40 === i; if (!n.allowSlideNext && (n.isHorizontal() && h || n.isVertical() && m || r)) return !1; if (!n.allowSlidePrev && (n.isHorizontal() && l || n.isVertical() && u || a)) return !1; if (!(s.shiftKey || s.altKey || s.ctrlKey || s.metaKey || p.activeElement && p.activeElement.nodeName && ("input" === p.activeElement.nodeName.toLowerCase() || "textarea" === p.activeElement.nodeName.toLowerCase()))) { if (n.params.keyboard.onlyInViewport && (a || r || l || h || u || m)) { let t = !1; if (n.$el.parents(`.${n.params.slideClass}`).length > 0 && 0 === n.$el.parents(`.${n.params.slideActiveClass}`).length) return; const s = n.$el,
                            i = s[0].clientWidth,
                            o = s[0].clientHeight,
                            a = c.innerWidth,
                            r = c.innerHeight,
                            l = n.$el.offset();
                        e && (l.left -= n.$el[0].scrollLeft); const h = [
                            [l.left, l.top],
                            [l.left + i, l.top],
                            [l.left, l.top + o],
                            [l.left + i, l.top + o]
                        ]; for (let e = 0; e < h.length; e += 1) { const s = h[e]; if (s[0] >= 0 && s[0] <= a && s[1] >= 0 && s[1] <= r) { if (0 === s[0] && 0 === s[1]) continue;
                                t = !0 } } if (!t) return }
                    n.isHorizontal() ? ((a || r || l || h) && axPreventDefault(s), ((r || h) && !e || (a || l) && e) && n.slideNext(), ((a || l) && !e || (r || h) && e) && n.slidePrev()) : ((a || r || u || m) && axPreventDefault(s), (r || m) && n.slideNext(), (a || u) && n.slidePrev()), d("keyPress", i) } }

            function o() { n.keyboard.enabled || (h(p).on("keydown", e), n.keyboard.enabled = !0) }

            function a() { n.keyboard.enabled && (h(p).off("keydown", e), n.keyboard.enabled = !1) } let { swiper: n, extendParams: r, on: l, emit: d } = t; const p = s(),
                c = i();
            n.keyboard = { enabled: !1 }, r({ keyboard: { enabled: !1, onlyInViewport: !0, pageUpDown: !0 } }), l("init", () => { n.params.keyboard.enabled && o() }), l("destroy", () => { n.keyboard.enabled && a() }), Object.assign(n.keyboard, { enable: o, disable: a }) }

        function re(t) {
            function e(t) { const e = 10,
                    s = 40,
                    i = 800; let o = 0,
                    a = 0,
                    n = 0,
                    r = 0; return "detail" in t && (a = t.detail), "wheelDelta" in t && (a = -t.wheelDelta / 120), "wheelDeltaY" in t && (a = -t.wheelDeltaY / 120), "wheelDeltaX" in t && (o = -t.wheelDeltaX / 120), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (o = a, a = 0), n = o * e, r = a * e, "deltaY" in t && (r = t.deltaY), "deltaX" in t && (n = t.deltaX), t.shiftKey && !n && (n = r, r = 0), (n || r) && t.deltaMode && (1 === t.deltaMode ? (n *= s, r *= s) : (n *= i, r *= i)), n && !o && (o = n < 1 ? -1 : 1), r && !a && (a = r < 1 ? -1 : 1), { spinX: o, spinY: a, pixelX: n, pixelY: r } }

            function s() { c.enabled && (c.mouseEntered = !0) }

            function o() { c.enabled && (c.mouseEntered = !1) }

            function a(t) { return !(c.params.mousewheel.thresholdDelta && t.delta < c.params.mousewheel.thresholdDelta) && (!(c.params.mousewheel.thresholdTime && G() - b < c.params.mousewheel.thresholdTime) && (t.delta >= 6 && G() - b < 60 || (t.direction < 0 ? c.isEnd && !c.params.loop || c.animating || (c.slideNext(), g("scroll", t.raw)) : c.isBeginning && !c.params.loop || c.animating || (c.slidePrev(), g("scroll", t.raw)), b = (new f.Date).getTime(), !1))) }

            function n(t) { const e = c.params.mousewheel; if (t.direction < 0) { if (c.isEnd && !c.params.loop && e.releaseOnEdges) return !0 } else if (c.isBeginning && !c.params.loop && e.releaseOnEdges) return !0; return !1 }

            function r(t) { let s = t,
                    i = !0; if (!c.enabled) return; const o = c.params.mousewheel;
                c.params.cssMode && axPreventDefault(s); let r = c.$el; if ("container" !== c.params.mousewheel.eventsTarget && (r = h(c.params.mousewheel.eventsTarget)), !c.mouseEntered && !r[0].contains(s.target) && !o.releaseOnEdges) return !0;
                s.originalEvent && (s = s.originalEvent); let l = 0; const d = c.rtlTranslate ? -1 : 1,
                    p = e(s); if (o.forceToAxis)
                    if (c.isHorizontal()) { if (!(Math.abs(p.pixelX) > Math.abs(p.pixelY))) return !0;
                        l = -p.pixelX * d } else { if (!(Math.abs(p.pixelY) > Math.abs(p.pixelX))) return !0;
                        l = -p.pixelY }
                else l = Math.abs(p.pixelX) > Math.abs(p.pixelY) ? -p.pixelX * d : -p.pixelY; if (0 === l) return !0;
                o.invert && (l = -l); let u = c.getTranslate() + l * o.sensitivity; if (u >= c.minTranslate() && (u = c.minTranslate()), u <= c.maxTranslate() && (u = c.maxTranslate()), i = !!c.params.loop || !(u === c.minTranslate() || u === c.maxTranslate()), i && c.params.nested && s.stopPropagation(), c.params.freeMode && c.params.freeMode.enabled) { const t = { time: G(), delta: Math.abs(l), direction: Math.sign(l) },
                        e = y && t.time < y.time + 500 && t.delta <= y.delta && t.direction === y.direction; if (!e) { y = void 0, c.params.loop && c.loopFix(); let i = c.getTranslate() + l * o.sensitivity; const a = c.isBeginning,
                            n = c.isEnd; if (i >= c.minTranslate() && (i = c.minTranslate()), i <= c.maxTranslate() && (i = c.maxTranslate()), c.setTransition(0), c.setTranslate(i), c.updateProgress(), c.updateActiveIndex(), c.updateSlidesClasses(), (!a && c.isBeginning || !n && c.isEnd) && c.updateSlidesClasses(), c.params.freeMode.sticky) { clearTimeout(x), x = void 0, v.length >= 15 && v.shift(); const e = v.length ? v[v.length - 1] : void 0,
                                s = v[0]; if (v.push(t), e && (t.delta > e.delta || t.direction !== e.direction)) v.splice(0);
                            else if (v.length >= 15 && t.time - s.time < 500 && s.delta - t.delta >= 1 && t.delta <= 6) { const e = l > 0 ? .8 : .2;
                                y = t, v.splice(0), x = X(() => { c.slideToClosest(c.params.speed, !0, void 0, e) }, 0) }
                            x || (x = X(() => { const e = .5;
                                y = t, v.splice(0), c.slideToClosest(c.params.speed, !0, void 0, e) }, 500)) } if (e || g("scroll", s), c.params.autoplay && c.params.autoplayDisableOnInteraction && c.autoplay.stop(), i === c.minTranslate() || i === c.maxTranslate()) return !0 } } else { const e = { time: G(), delta: Math.abs(l), direction: Math.sign(l), raw: t };
                    v.length >= 2 && v.shift(); const s = v.length ? v[v.length - 1] : void 0; if (v.push(e), s ? (e.direction !== s.direction || e.delta > s.delta || e.time > s.time + 150) && a(e) : a(e), n(e)) return !0 } return axPreventDefault(s), !1 }

            function l(t) { let e = c.$el; "container" !== c.params.mousewheel.eventsTarget && (e = h(c.params.mousewheel.eventsTarget)), e[t]("mouseenter", s), e[t]("mouseleave", o), e[t]("wheel", r) }

            function d() { return c.params.cssMode ? (c.wrapperEl.removeEventListener("wheel", r), !0) : !c.mousewheel.enabled && (l("on"), c.mousewheel.enabled = !0, !0) }

            function p() { return c.params.cssMode ? (c.wrapperEl.addEventListener(event, r), !0) : !!c.mousewheel.enabled && (l("off"), c.mousewheel.enabled = !1, !0) } let { swiper: c, extendParams: u, on: m, emit: g } = t; const f = i(); let x;
            u({ mousewheel: { enabled: !1, releaseOnEdges: !1, invert: !1, forceToAxis: !1, sensitivity: 1, eventsTarget: "container", thresholdDelta: null, thresholdTime: null } }), c.mousewheel = { enabled: !1 }; let y, b = G(); const v = [];
            m("init", () => {!c.params.mousewheel.enabled && c.params.cssMode && p(), c.params.mousewheel.enabled && d() }), m("destroy", () => { c.params.cssMode && d(), c.mousewheel.enabled && p() }), Object.assign(c.mousewheel, { enable: d, disable: p }) }

        function le(t, e, i, o) { const a = s(); return t.params.createElements && Object.keys(o).forEach(s => { if (!i[s] && !0 === i.auto) { let n = t.$el.children(`.${o[s]}`)[0];
                    n || (n = a.createElement("div"), n.className = o[s], t.$el.append(n)), i[s] = n, e[s] = n } }), i }

        function he(t) {
            function e(t) { let e; return t && (e = h(t), l.params.uniqueNavElements && "string" == typeof t && e.length > 1 && 1 === l.$el.find(t).length && (e = l.$el.find(t))), e }

            function s(t, e) { const s = l.params.navigation;
                t && t.length > 0 && (t[e ? "addClass" : "removeClass"](s.disabledClass), t[0] && "BUTTON" === t[0].tagName && (t[0].disabled = e), l.params.watchOverflow && l.enabled && t[l.isLocked ? "addClass" : "removeClass"](s.lockClass)) }

            function i() { if (l.params.loop) return; const { $nextEl: t, $prevEl: e } = l.navigation;
                s(e, l.isBeginning && !l.params.rewind), s(t, l.isEnd && !l.params.rewind) }

            function o(t) { axPreventDefault(t), (!l.isBeginning || l.params.loop || l.params.rewind) && l.slidePrev() }

            function a(t) { axPreventDefault(t), (!l.isEnd || l.params.loop || l.params.rewind) && l.slideNext() }

            function n() { const t = l.params.navigation; if (l.params.navigation = le(l, l.originalParams.navigation, l.params.navigation, { nextEl: "ax-next", prevEl: "ax-prev" }), !t.nextEl && !t.prevEl) return; const s = e(t.nextEl),
                    i = e(t.prevEl);
                s && s.length > 0 && s.on("click", a), i && i.length > 0 && i.on("click", o), Object.assign(l.navigation, { $nextEl: s, nextEl: s && s[0], $prevEl: i, prevEl: i && i[0] }), l.enabled || (s && s.addClass(t.lockClass), i && i.addClass(t.lockClass)) }

            function r() { const { $nextEl: t, $prevEl: e } = l.navigation;
                t && t.length && (t.off("click", a), t.removeClass(l.params.navigation.disabledClass)), e && e.length && (e.off("click", o), e.removeClass(l.params.navigation.disabledClass)) } let { swiper: l, extendParams: d, on: p, emit: c } = t;
            d({ navigation: { nextEl: ".ax-next", prevEl: ".ax-prev", hideOnClick: !1, disabledClass: "ax-disabled", hiddenClass: "ax-hidden", lockClass: "ax-lock" } }), l.navigation = { nextEl: null, $nextEl: null, prevEl: null, $prevEl: null }, p("init", () => { n(), i() }), p("toEdge fromEdge lock unlock", () => { i() }), p("destroy", () => { r() }), p("enable disable", () => { const { $nextEl: t, $prevEl: e } = l.navigation;
                t && t[l.enabled ? "removeClass" : "addClass"](l.params.navigation.lockClass), e && e[l.enabled ? "removeClass" : "addClass"](l.params.navigation.lockClass) }), p("click", (t, e) => { const { $nextEl: s, $prevEl: i } = l.navigation, o = e.target; if (l.params.navigation.hideOnClick && !h(o).is(i) && !h(o).is(s)) { if (l.pagination && l.params.pagination && l.params.pagination.clickable && (l.pagination.el === o || l.pagination.el.contains(o))) return; let t;
                    s ? t = s.hasClass(l.params.navigation.hiddenClass) : i && (t = i.hasClass(l.params.navigation.hiddenClass)), c(!0 === t ? "navigationShow" : "navigationHide"), s && s.toggleClass(l.params.navigation.hiddenClass), i && i.toggleClass(l.params.navigation.hiddenClass) } }), Object.assign(l.navigation, { update: i, init: n, destroy: r }) }

        function de(t) { return void 0 === t && (t = ""), `.${t.trim().replace(/([\.:!\/])/g,"\\$1").replace(/ /g,".")}` }

        function pe(t) {
            function e() { return !r.params.pagination.el || !r.pagination.el || !r.pagination.$el || 0 === r.pagination.$el.length }

            function s(t, e) { const { bulletActiveClass: s } = r.params.pagination;
                t[e]().addClass(`${s}-${e}`)[e]().addClass(`${s}-${e}-${e}`) }

            function i() { const t = r.rtl,
                    i = r.params.pagination; if (e()) return; const o = r.virtual && r.params.virtual.enabled ? r.virtual.slides.length : r.slides.length,
                    a = r.pagination.$el; let n; const l = r.params.loop ? Math.ceil((o - 2 * r.loopedSlides) / r.params.slidesPerGroup) : r.snapGrid.length; if (r.params.loop ? (n = Math.ceil((r.activeIndex - r.loopedSlides) / r.params.slidesPerGroup), n > o - 1 - 2 * r.loopedSlides && (n -= o - 2 * r.loopedSlides), n > l - 1 && (n -= l), n < 0 && "bullets" !== r.params.paginationType && (n = l + n)) : n = void 0 !== r.snapIndex ? r.snapIndex : r.activeIndex || 0, "bullets" === i.type && r.pagination.bullets && r.pagination.bullets.length > 0) { const e = r.pagination.bullets; let o, l, d; if (i.dynamicBullets && (u = e.eq(0)[r.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(r.isHorizontal() ? "width" : "height", `${u*(i.dynamicMainBullets+4)}px`), i.dynamicMainBullets > 1 && void 0 !== r.previousIndex && (m += n - (r.previousIndex - r.loopedSlides || 0), m > i.dynamicMainBullets - 1 ? m = i.dynamicMainBullets - 1 : m < 0 && (m = 0)), o = Math.max(n - m, 0), l = o + (Math.min(e.length, i.dynamicMainBullets) - 1), d = (l + o) / 2), e.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(t => `${i.bulletActiveClass}${t}`).join(" ")), a.length > 1) e.each(t => { const e = h(t),
                            a = e.index();
                        a === n && e.addClass(i.bulletActiveClass), i.dynamicBullets && (a >= o && a <= l && e.addClass(`${i.bulletActiveClass}-main`), a === o && s(e, "prev"), a === l && s(e, "next")) });
                    else { const t = e.eq(n),
                            a = t.index(); if (t.addClass(i.bulletActiveClass), i.dynamicBullets) { const t = e.eq(o),
                                n = e.eq(l); for (let t = o; t <= l; t += 1) e.eq(t).addClass(`${i.bulletActiveClass}-main`); if (r.params.loop)
                                if (a >= e.length) { for (let t = i.dynamicMainBullets; t >= 0; t -= 1) e.eq(e.length - t).addClass(`${i.bulletActiveClass}-main`);
                                    e.eq(e.length - i.dynamicMainBullets - 1).addClass(`${i.bulletActiveClass}-prev`) } else s(t, "prev"), s(n, "next");
                            else s(t, "prev"), s(n, "next") } } if (i.dynamicBullets) { const s = Math.min(e.length, i.dynamicMainBullets + 4),
                            o = (u * s - u) / 2 - d * u,
                            a = t ? "right" : "left";
                        e.css(r.isHorizontal() ? a : "top", `${o}px`) } } if ("fraction" === i.type && (a.find(de(i.currentClass)).text(i.formatFractionCurrent(n + 1)), a.find(de(i.totalClass)).text(i.formatFractionTotal(l))), "progressbar" === i.type) { let t;
                    t = i.progressbarOpposite ? r.isHorizontal() ? "vertical" : "horizontal" : r.isHorizontal() ? "horizontal" : "vertical"; const e = (n + 1) / l; let s = 1,
                        o = 1; "horizontal" === t ? s = e : o = e, a.find(de(i.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${s}) scaleY(${o})`).transition(r.params.speed) } "custom" === i.type && i.renderCustom ? (a.html(i.renderCustom(r, n + 1, l)), p("paginationRender", a[0])) : p("paginationUpdate", a[0]), r.params.watchOverflow && r.enabled && a[r.isLocked ? "addClass" : "removeClass"](i.lockClass) }

            function o() { const t = r.params.pagination; if (e()) return; const s = r.virtual && r.params.virtual.enabled ? r.virtual.slides.length : r.slides.length,
                    i = r.pagination.$el; let o = ""; if ("bullets" === t.type) { let e = r.params.loop ? Math.ceil((s - 2 * r.loopedSlides) / r.params.slidesPerGroup) : r.snapGrid.length;
                    r.params.freeMode && r.params.freeMode.enabled && !r.params.loop && e > s && (e = s); for (let s = 0; s < e; s += 1) t.renderBullet ? o += t.renderBullet.call(r, s, t.bulletClass) : o += `<${t.bulletElement} class="${t.bulletClass}"></${t.bulletElement}>`;
                    i.html(o), r.pagination.bullets = i.find(de(t.bulletClass)) } "fraction" === t.type && (o = t.renderFraction ? t.renderFraction.call(r, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span>` + " / " + `<span class="${t.totalClass}"></span>`, i.html(o)), "progressbar" === t.type && (o = t.renderProgressbar ? t.renderProgressbar.call(r, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`, i.html(o)), "custom" !== t.type && p("paginationRender", r.pagination.$el[0]) }

            function a() { r.params.pagination = le(r, r.originalParams.pagination, r.params.pagination, { el: "ax-pages" }); const t = r.params.pagination; if (!t.el) return; let e = h(t.el);
                0 !== e.length && (r.params.uniqueNavElements && "string" == typeof t.el && e.length > 1 && (e = r.$el.find(t.el), e.length > 1 && (e = e.filter(t => h(t).parents(".swiper")[0] === r.el))), "bullets" === t.type && t.clickable && e.addClass(t.clickableClass), e.addClass(t.modifierClass + t.type), e.addClass(r.isHorizontal() ? t.horizontalClass : t.verticalClass), "bullets" === t.type && t.dynamicBullets && (e.addClass(`${t.modifierClass}${t.type}-dynamic`), m = 0, t.dynamicMainBullets < 1 && (t.dynamicMainBullets = 1)), "progressbar" === t.type && t.progressbarOpposite && e.addClass(t.progressbarOppositeClass), t.clickable && e.on("click", de(t.bulletClass), function(t) { axPreventDefault(t); let e = h(this).index() * r.params.slidesPerGroup;
                    r.params.loop && (e += r.loopedSlides), r.slideTo(e) }), Object.assign(r.pagination, { $el: e, el: e[0] }), r.enabled || e.addClass(t.lockClass)) }

            function n() { const t = r.params.pagination; if (e()) return; const s = r.pagination.$el;
                s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(r.isHorizontal() ? t.horizontalClass : t.verticalClass), r.pagination.bullets && r.pagination.bullets.removeClass && r.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", de(t.bulletClass)) } let { swiper: r, extendParams: l, on: d, emit: p } = t; const c = "ax-pages"; let u;
            l({ pagination: { el: "." + c, bulletElement: "i", clickable: !0, hideOnClick: !1, renderBullet: null, renderProgressbar: null, renderFraction: null, renderCustom: null, progressbarOpposite: !1, type: "bullets", dynamicBullets: !1, dynamicMainBullets: 1, formatFractionCurrent: t => t, formatFractionTotal: t => t, bulletClass: `${c}-bullet`, bulletActiveClass: `${c}-bullet-active`, modifierClass: `${c}-`, currentClass: `${c}-current`, totalClass: `${c}-total`, hiddenClass: `${c}-hidden`, progressbarFillClass: `${c}-progressbar-fill`, progressbarOppositeClass: `${c}-progressbar-opposite`, clickableClass: `${c}-clickable`, lockClass: `${c}-lock`, horizontalClass: `${c}-horizontal`, verticalClass: `${c}-vertical` } }), r.pagination = { el: null, $el: null, bullets: [] }; let m = 0;
            d("init", () => { a(), o(), i() }), d("activeIndexChange", () => { r.params.loop ? i() : void 0 === r.snapIndex && i() }), d("snapIndexChange", () => { r.params.loop || i() }), d("slidesLengthChange", () => { r.params.loop && (o(), i()) }), d("snapGridLengthChange", () => { r.params.loop || (o(), i()) }), d("destroy", () => { n() }), d("enable disable", () => { const { $el: t } = r.pagination;
                t && t[r.enabled ? "removeClass" : "addClass"](r.params.pagination.lockClass) }), d("lock unlock", () => { i() }), d("click", (t, e) => { const s = e.target,
                    { $el: i } = r.pagination; if (r.params.pagination.el && r.params.pagination.hideOnClick && i.length > 0 && !h(s).hasClass(r.params.pagination.bulletClass)) { if (r.navigation && (r.navigation.nextEl && s === r.navigation.nextEl || r.navigation.prevEl && s === r.navigation.prevEl)) return; const t = i.hasClass(r.params.pagination.hiddenClass);
                    p(!0 === t ? "paginationShow" : "paginationHide"), i.toggleClass(r.params.pagination.hiddenClass) } }), Object.assign(r.pagination, { render: o, update: i, init: a, destroy: n }) }

        function ce(t) {
            function e() { if (!f.params.scrollbar.el || !f.scrollbar.el) return; const { scrollbar: t, rtlTranslate: e, progress: s } = f, { $dragEl: i, $el: o } = t, a = f.params.scrollbar; let n = w,
                    r = (T - w) * s;
                e ? (r = -r, r > 0 ? (n = w - r, r = 0) : -r + w > T && (n = T + r)) : r < 0 ? (n = w + r, r = 0) : r + w > T && (n = T - r), f.isHorizontal() ? (i.transform(`translate3d(${r}px, 0, 0)`), i[0].style.width = `${n}px`) : (i.transform(`translate3d(0px, ${r}px, 0)`), i[0].style.height = `${n}px`), a.hide && (clearTimeout(A), o[0].style.opacity = 1, A = setTimeout(() => { o[0].style.opacity = 0, o.transition(400) }, 1e3)) }

            function i(t) { f.params.scrollbar.el && f.scrollbar.el && f.scrollbar.$dragEl.transition(t) }

            function o() { if (!f.params.scrollbar.el || !f.scrollbar.el) return; const { scrollbar: t } = f, { $dragEl: e, $el: s } = t;
                e[0].style.width = "", e[0].style.height = "", T = f.isHorizontal() ? s[0].offsetWidth : s[0].offsetHeight, S = f.size / (f.virtualSize + f.params.slidesOffsetBefore - (f.params.centeredSlides ? f.snapGrid[0] : 0)), w = "auto" === f.params.scrollbar.dragSize ? T * S : parseInt(f.params.scrollbar.dragSize, 10), f.isHorizontal() ? e[0].style.width = `${w}px` : e[0].style.height = `${w}px`, s[0].style.display = S >= 1 ? "none" : "", f.params.scrollbar.hide && (s[0].style.opacity = 0), f.params.watchOverflow && f.enabled && t.$el[f.isLocked ? "addClass" : "removeClass"](f.params.scrollbar.lockClass) }

            function a(t) { return f.isHorizontal() ? "touchstart" === t.type || "touchmove" === t.type ? t.targetTouches[0].clientX : t.clientX : "touchstart" === t.type || "touchmove" === t.type ? t.targetTouches[0].clientY : t.clientY }

            function n(t) { const { scrollbar: e, rtlTranslate: s } = f, { $el: i } = e; let o;
                o = (a(t) - i.offset()[f.isHorizontal() ? "left" : "top"] - (null !== D ? D : w / 2)) / (T - w), o = Math.max(Math.min(o, 1), 0), s && (o = 1 - o); const n = f.minTranslate() + (f.maxTranslate() - f.minTranslate()) * o;
                f.updateProgress(n), f.setTranslate(n), f.updateActiveIndex(), f.updateSlidesClasses() }

            function r(t) { const e = f.params.scrollbar,
                    { scrollbar: s, $wrapperEl: i } = f,
                    { $el: o, $dragEl: r } = s;
                E = !0, D = t.target === r[0] || t.target === r ? a(t) - t.target.getBoundingClientRect()[f.isHorizontal() ? "left" : "top"] : null, axPreventDefault(t), t.stopPropagation(), i.transition(100), r.transition(100), n(t), clearTimeout(C), o.transition(0), e.hide && o.css("opacity", 1), f.params.cssMode && f.$wrapperEl.css("scroll-snap-type", "none"), b("scrollbarDragStart", t) }

            function l(t) { const { scrollbar: e, $wrapperEl: s } = f, { $el: i, $dragEl: o } = e;
                E && (axPreventDefault(t), n(t), s.transition(0), i.transition(0), o.transition(0), b("scrollbarDragMove", t)) }

            function d(t) { const e = f.params.scrollbar,
                    { scrollbar: s, $wrapperEl: i } = f,
                    { $el: o } = s;
                E && (E = !1, f.params.cssMode && (f.$wrapperEl.css("scroll-snap-type", ""), i.transition("")), e.hide && (clearTimeout(C), C = X(() => { o.css("opacity", 0), o.transition(400) }, 1e3)), b("scrollbarDragEnd", t), e.snapOnRelease && f.slideToClosest()) }

            function p(t) { const { scrollbar: e, touchEventsTouch: s, touchEventsDesktop: i, params: o, support: a } = f, n = e.$el, h = n[0], p = !(!a.passiveListener || !o.passiveListeners) && { passive: !1, capture: !1 }, c = !(!a.passiveListener || !o.passiveListeners) && { passive: !0, capture: !1 }; if (!h) return; const u = "on" === t ? "addEventListener" : "removeEventListener";
                a.touch ? (h[u](s.start, r, p), h[u](s.move, l, p), h[u](s.end, d, c)) : (h[u](i.start, r, p), v[u](i.move, l, p), v[u](i.end, d, c)) }

            function c() { f.params.scrollbar.el && p("on") }

            function u() { f.params.scrollbar.el && p("off") }

            function m() { const { scrollbar: t, $el: e } = f;
                f.params.scrollbar = le(f, f.originalParams.scrollbar, f.params.scrollbar, { el: "ax-scrollbar" }); const s = f.params.scrollbar; if (!s.el) return; let i = h(s.el);
                f.params.uniqueNavElements && "string" == typeof s.el && i.length > 1 && 1 === e.find(s.el).length && (i = e.find(s.el)); let o = i.find(`.${f.params.scrollbar.dragClass}`);
                0 === o.length && (o = h(`<div class="${f.params.scrollbar.dragClass}"></div>`), i.append(o)), Object.assign(t, { $el: i, el: i[0], $dragEl: o, dragEl: o[0] }), s.draggable && c(), i && i[f.enabled ? "removeClass" : "addClass"](f.params.scrollbar.lockClass) }

            function g() { u() } let { swiper: f, extendParams: x, on: y, emit: b } = t; const v = s(); let D, w, T, S, E = !1,
                A = null,
                C = null;
            x({ scrollbar: { el: ".ax-scrollbar", dragSize: "auto", hide: !0, draggable: !0, snapOnRelease: !0, lockClass: "ax-scrollbar-lock", dragClass: "ax-scrollbar-drag" } }), f.scrollbar = { el: null, dragEl: null, $el: null, $dragEl: null }, y("init", () => { m(), o(), e() }), y("update resize observerUpdate lock unlock", () => { o() }), y("setTranslate", () => { e() }), y("setTransition", (t, e) => { i(e) }), y("enable disable", () => { const { $el: t } = f.scrollbar;
                t && t[f.enabled ? "removeClass" : "addClass"](f.params.scrollbar.lockClass) }), y("destroy", () => { g() }), Object.assign(f.scrollbar, { updateSize: o, setTranslate: e, init: m, destroy: g }) }

        function ue(t) { let { swiper: e, extendParams: s, on: i } = t;
            s({ parallax: { enabled: !1 } }); const o = (t, s) => { const { rtl: i } = e, o = h(t), a = i ? -1 : 1, n = o.attr("data-swiper-parallax") || "0"; let r = o.attr("data-swiper-parallax-x"),
                        l = o.attr("data-swiper-parallax-y"); const d = o.attr("data-swiper-parallax-scale"),
                        p = o.attr("data-swiper-parallax-opacity"); if (r || l ? (r = r || "0", l = l || "0") : e.isHorizontal() ? (r = n, l = "0") : (l = n, r = "0"), r = r.indexOf("%") >= 0 ? `${parseInt(r,10)*s*a}%` : `${r*s*a}px`, l = l.indexOf("%") >= 0 ? `${parseInt(l,10)*s}%` : `${l*s}px`, null != p) { const t = p - (p - 1) * (1 - Math.abs(s));
                        o[0].style.opacity = t } if (null == d) o.transform(`translate3d(${r}, ${l}, 0px)`);
                    else { const t = d - (d - 1) * (1 - Math.abs(s));
                        o.transform(`translate3d(${r}, ${l}, 0px) scale(${t})`) } },
                a = () => { const { $el: t, slides: s, progress: i, snapGrid: a } = e;
                    t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(t => { o(t, i) }), s.each((t, s) => { let n = t.progress;
                        e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (n += Math.ceil(s / 2) - i * (a.length - 1)), n = Math.min(Math.max(n, -1), 1), h(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(t => { o(t, n) }) }) },
                n = function(t) { void 0 === t && (t = e.params.speed); const { $el: s } = e;
                    s.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(e => { const s = h(e); let i = parseInt(s.attr("data-swiper-parallax-duration"), 10) || t;
                        0 === t && (i = 0), s.transition(i) }) };
            i("beforeInit", () => { e.params.parallax.enabled && (e.params.watchSlidesProgress = !0, e.originalParams.watchSlidesProgress = !0) }), i("init", () => { e.params.parallax.enabled && a() }), i("setTranslate", () => { e.params.parallax.enabled && a() }), i("setTransition", (t, s) => { e.params.parallax.enabled && n(s) }) }

        function me(t) {
            function e(t) { if (t.targetTouches.length < 2) return 1; const e = t.targetTouches[0].pageX,
                    s = t.targetTouches[0].pageY,
                    i = t.targetTouches[1].pageX,
                    o = t.targetTouches[1].pageY,
                    a = Math.sqrt((i - e) ** 2 + (o - s) ** 2); return a }

            function s(t) { const s = D.support,
                    i = D.params.zoom; if (C = !1, I = !1, !s.gestures) { if ("touchstart" !== t.type || "touchstart" === t.type && t.targetTouches.length < 2) return;
                    C = !0, L.scaleStart = e(t) }
                L.$slideEl && L.$slideEl.length || (L.$slideEl = h(t.target).closest(`.${D.params.slideClass}`), 0 === L.$slideEl.length && (L.$slideEl = D.slides.eq(D.activeIndex)), L.$imageEl = L.$slideEl.find(`.${i.containerClass}`).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), L.$imageWrapEl = L.$imageEl.parent(`.${i.containerClass}`), L.maxRatio = L.$imageWrapEl.attr("data-swiper-zoom") || i.maxRatio, 0 !== L.$imageWrapEl.length) ? (L.$imageEl && L.$imageEl.transition(0), M = !0) : L.$imageEl = void 0 }

            function o(t) { const i = D.support,
                    o = D.params.zoom,
                    a = D.zoom; if (!i.gestures) { if ("touchmove" !== t.type || "touchmove" === t.type && t.targetTouches.length < 2) return;
                    I = !0, L.scaleMove = e(t) }
                L.$imageEl && 0 !== L.$imageEl.length ? (i.gestures ? a.scale = t.scale * k : a.scale = L.scaleMove / L.scaleStart * k, a.scale > L.maxRatio && (a.scale = L.maxRatio - 1 + (a.scale - L.maxRatio + 1) ** .5), a.scale < o.minRatio && (a.scale = o.minRatio + 1 - (o.minRatio - a.scale + 1) ** .5), L.$imageEl.transform(`translate3d(0,0,0) scale(${a.scale})`)) : "gesturechange" === t.type && s(t) }

            function a(t) { const e = D.device,
                    s = D.support,
                    i = D.params.zoom,
                    o = D.zoom; if (!s.gestures) { if (!C || !I) return; if ("touchend" !== t.type || "touchend" === t.type && t.changedTouches.length < 2 && !e.android) return;
                    C = !1, I = !1 }
                L.$imageEl && 0 !== L.$imageEl.length && (o.scale = Math.max(Math.min(o.scale, L.maxRatio), i.minRatio), L.$imageEl.transition(D.params.speed).transform(`translate3d(0,0,0) scale(${o.scale})`), k = o.scale, M = !1, 1 === o.scale && (L.$slideEl = void 0)) }

            function n(t) { const e = D.device;
                L.$imageEl && 0 !== L.$imageEl.length && (P.isTouched || (e.android && t.cancelable && axPreventDefault(t), P.isTouched = !0, P.touchesStart.x = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX, P.touchesStart.y = "touchstart" === t.type ? t.targetTouches[0].pageY : t.pageY)) }

            function r(t) {
                const e = D.zoom;
                if (!L.$imageEl || 0 === L.$imageEl.length) return;
                if (D.allowClick = !1, !P.isTouched || !L.$slideEl) return;
                P.isMoved || (P.width = L.$imageEl[0].offsetWidth, P.height = L.$imageEl[0].offsetHeight, P.startX = J(L.$imageWrapEl[0], "x") || 0, P.startY = J(L.$imageWrapEl[0], "y") || 0, L.slideWidth = L.$slideEl[0].offsetWidth, L.slideHeight = L.$slideEl[0].offsetHeight, L.$imageWrapEl.transition(0));
                const s = P.width * e.scale,
                    i = P.height * e.scale;
                if (!(s < L.slideWidth && i < L.slideHeight)) {
                    if (P.minX = Math.min(L.slideWidth / 2 - s / 2, 0), P.maxX = -P.minX, P.minY = Math.min(L.slideHeight / 2 - i / 2, 0), P.maxY = -P.minY, P.touchesCurrent.x = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, P.touchesCurrent.y = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, !P.isMoved && !M) {
                        if (D.isHorizontal() && (Math.floor(P.minX) === Math.floor(P.startX) && P.touchesCurrent.x < P.touchesStart.x || Math.floor(P.maxX) === Math.floor(P.startX) && P.touchesCurrent.x > P.touchesStart.x)) return void(P.isTouched = !1);
                        if (!D.isHorizontal() && (Math.floor(P.minY) === Math.floor(P.startY) && P.touchesCurrent.y < P.touchesStart.y || Math.floor(P.maxY) === Math.floor(P.startY) && P.touchesCurrent.y > P.touchesStart.y)) return void(P.isTouched = !1)
                    }
                    t.cancelable && axPreventDefault(t), t.stopPropagation(), P.isMoved = !0, P.currentX = P.touchesCurrent.x - P.touchesStart.x + P.startX, P.currentY = P.touchesCurrent.y - P.touchesStart.y + P.startY, P.currentX < P.minX && (P.currentX = P.minX + 1 - (P.minX - P.currentX + 1) ** .8), P.currentX > P.maxX && (P.currentX = P.maxX - 1 + (P.currentX - P.maxX + 1) ** .8), P.currentY < P.minY && (P.currentY = P.minY + 1 - (P.minY - P.currentY + 1) ** .8), P.currentY > P.maxY && (P.currentY = P.maxY - 1 + (P.currentY - P.maxY + 1) ** .8), $.prevPositionX || ($.prevPositionX = P.touchesCurrent.x), $.prevPositionY || ($.prevPositionY = P.touchesCurrent.y), $.prevTime || ($.prevTime = Date.now()), $.x = (P.touchesCurrent.x - $.prevPositionX) / (Date.now() - $.prevTime) / 2, $.y = (P.touchesCurrent.y - $.prevPositionY) / (Date.now() - $.prevTime) / 2, Math.abs(P.touchesCurrent.x - $.prevPositionX) < 2 && ($.x = 0), Math.abs(P.touchesCurrent.y - $.prevPositionY) < 2 && ($.y = 0), $.prevPositionX = P.touchesCurrent.x, $.prevPositionY = P.touchesCurrent.y, $.prevTime = Date.now(), L.$imageWrapEl.transform(`translate3d(${P.currentX}px, ${P.currentY}px,0)`)
                }
            }

            function l() { const t = D.zoom; if (!L.$imageEl || 0 === L.$imageEl.length) return; if (!P.isTouched || !P.isMoved) return P.isTouched = !1, void(P.isMoved = !1);
                P.isTouched = !1, P.isMoved = !1; let e = 300,
                    s = 300; const i = $.x * e,
                    o = P.currentX + i,
                    a = $.y * s,
                    n = P.currentY + a;
                0 !== $.x && (e = Math.abs((o - P.currentX) / $.x)), 0 !== $.y && (s = Math.abs((n - P.currentY) / $.y)); const r = Math.max(e, s);
                P.currentX = o, P.currentY = n; const l = P.width * t.scale,
                    h = P.height * t.scale;
                P.minX = Math.min(L.slideWidth / 2 - l / 2, 0), P.maxX = -P.minX, P.minY = Math.min(L.slideHeight / 2 - h / 2, 0), P.maxY = -P.minY, P.currentX = Math.max(Math.min(P.currentX, P.maxX), P.minX), P.currentY = Math.max(Math.min(P.currentY, P.maxY), P.minY), L.$imageWrapEl.transition(r).transform(`translate3d(${P.currentX}px, ${P.currentY}px,0)`) }

            function d() { const t = D.zoom;
                L.$slideEl && D.previousIndex !== D.activeIndex && (L.$imageEl && L.$imageEl.transform("translate3d(0,0,0) scale(1)"), L.$imageWrapEl && L.$imageWrapEl.transform("translate3d(0,0,0)"), t.scale = 1, k = 1, L.$slideEl = void 0, L.$imageEl = void 0, L.$imageWrapEl = void 0) }

            function p(t) { const e = D.zoom,
                    s = D.params.zoom; if (L.$slideEl || (t && t.target && (L.$slideEl = h(t.target).closest(`.${D.params.slideClass}`)), L.$slideEl || (D.params.virtual && D.params.virtual.enabled && D.virtual ? L.$slideEl = D.$wrapperEl.children(`.${D.params.slideActiveClass}`) : L.$slideEl = D.slides.eq(D.activeIndex)), L.$imageEl = L.$slideEl.find(`.${s.containerClass}`).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), L.$imageWrapEl = L.$imageEl.parent(`.${s.containerClass}`)), !L.$imageEl || 0 === L.$imageEl.length || !L.$imageWrapEl || 0 === L.$imageWrapEl.length) return; let i, o, a, n, r, l, d, p, c, u, m, g, f, x, y, b, v, w;
                D.params.cssMode && (D.wrapperEl.style.overflow = "hidden", D.wrapperEl.style.touchAction = "none"), L.$slideEl.addClass(`${s.zoomedSlideClass}`), void 0 === P.touchesStart.x && t ? (i = "touchend" === t.type ? t.changedTouches[0].pageX : t.pageX, o = "touchend" === t.type ? t.changedTouches[0].pageY : t.pageY) : (i = P.touchesStart.x, o = P.touchesStart.y), e.scale = L.$imageWrapEl.attr("data-swiper-zoom") || s.maxRatio, k = L.$imageWrapEl.attr("data-swiper-zoom") || s.maxRatio, t ? (v = L.$slideEl[0].offsetWidth, w = L.$slideEl[0].offsetHeight, a = L.$slideEl.offset().left + E.scrollX, n = L.$slideEl.offset().top + E.scrollY, r = a + v / 2 - i, l = n + w / 2 - o, c = L.$imageEl[0].offsetWidth, u = L.$imageEl[0].offsetHeight, m = c * e.scale, g = u * e.scale, f = Math.min(v / 2 - m / 2, 0), x = Math.min(w / 2 - g / 2, 0), y = -f, b = -x, d = r * e.scale, p = l * e.scale, d < f && (d = f), d > y && (d = y), p < x && (p = x), p > b && (p = b)) : (d = 0, p = 0), L.$imageWrapEl.transition(300).transform(`translate3d(${d}px, ${p}px,0)`), L.$imageEl.transition(300).transform(`translate3d(0,0,0) scale(${e.scale})`) }

            function c() { const t = D.zoom,
                    e = D.params.zoom;
                L.$slideEl || (D.params.virtual && D.params.virtual.enabled && D.virtual ? L.$slideEl = D.$wrapperEl.children(`.${D.params.slideActiveClass}`) : L.$slideEl = D.slides.eq(D.activeIndex), L.$imageEl = L.$slideEl.find(`.${e.containerClass}`).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), L.$imageWrapEl = L.$imageEl.parent(`.${e.containerClass}`)), L.$imageEl && 0 !== L.$imageEl.length && L.$imageWrapEl && 0 !== L.$imageWrapEl.length && (D.params.cssMode && (D.wrapperEl.style.overflow = "", D.wrapperEl.style.touchAction = ""), t.scale = 1, k = 1, L.$imageWrapEl.transition(300).transform("translate3d(0,0,0)"), L.$imageEl.transition(300).transform("translate3d(0,0,0) scale(1)"), L.$slideEl.removeClass(`${e.zoomedSlideClass}`), L.$slideEl = void 0) }

            function u(t) { const e = D.zoom;
                e.scale && 1 !== e.scale ? c() : p(t) }

            function m() { const t = D.support,
                    e = !("touchstart" !== D.touchEvents.start || !t.passiveListener || !D.params.passiveListeners) && { passive: !0, capture: !1 },
                    s = !t.passiveListener || { passive: !1, capture: !0 }; return { passiveListener: e, activeListenerWithCapture: s } }

            function g() { return `.${D.params.slideClass}` }

            function f(t) { const { passiveListener: e } = m(), i = g();
                D.$wrapperEl[t]("gesturestart", i, s, e), D.$wrapperEl[t]("gesturechange", i, o, e), D.$wrapperEl[t]("gestureend", i, a, e) }

            function x() { A || (A = !0, f("on")) }

            function y() { A && (A = !1, f("off")) }

            function b() { const t = D.zoom; if (t.enabled) return;
                t.enabled = !0; const e = D.support,
                    { passiveListener: i, activeListenerWithCapture: n } = m(),
                    l = g();
                e.gestures ? (D.$wrapperEl.on(D.touchEvents.start, x, i), D.$wrapperEl.on(D.touchEvents.end, y, i)) : "touchstart" === D.touchEvents.start && (D.$wrapperEl.on(D.touchEvents.start, l, s, i), D.$wrapperEl.on(D.touchEvents.move, l, o, n), D.$wrapperEl.on(D.touchEvents.end, l, a, i), D.touchEvents.cancel && D.$wrapperEl.on(D.touchEvents.cancel, l, a, i)), D.$wrapperEl.on(D.touchEvents.move, `.${D.params.zoom.containerClass}`, r, n) }

            function v() { const t = D.zoom; if (!t.enabled) return; const e = D.support;
                t.enabled = !1; const { passiveListener: i, activeListenerWithCapture: n } = m(), l = g();
                e.gestures ? (D.$wrapperEl.off(D.touchEvents.start, x, i), D.$wrapperEl.off(D.touchEvents.end, y, i)) : "touchstart" === D.touchEvents.start && (D.$wrapperEl.off(D.touchEvents.start, l, s, i), D.$wrapperEl.off(D.touchEvents.move, l, o, n), D.$wrapperEl.off(D.touchEvents.end, l, a, i), D.touchEvents.cancel && D.$wrapperEl.off(D.touchEvents.cancel, l, a, i)), D.$wrapperEl.off(D.touchEvents.move, `.${D.params.zoom.containerClass}`, r, n) }
            let { swiper: D, extendParams: w, on: T, emit: S } = t;
            const E = i();
            w({ zoom: { enabled: !1, maxRatio: 3, minRatio: 1, toggle: !0, containerClass: "ax-zoom", zoomedSlideClass: "ax-slide-zoomed" } }), D.zoom = { enabled: !1 };
            let A, C, I, k = 1,
                M = !1;
            const L = { $slideEl: void 0, slideWidth: void 0, slideHeight: void 0, $imageEl: void 0, $imageWrapEl: void 0, maxRatio: 3 },
            ...
            let O = 1;
            Object.defineProperty(D.zoom, "scale", { get: () => O, set(t) { if (O !== t) { const e = L.$imageEl ? L.$imageEl[0] : void 0,
                            s = L.$slideEl ? L.$slideEl[0] : void 0;
                        S("zoomChange", t, e, s) }
                    O = t } }), T("init", () => { D.params.zoom.enabled && b() }), T("destroy", () => { v() }), T("touchStart", (t, e) => { D.zoom.enabled && n(e) }), T("touchEnd", (t, e) => { D.zoom.enabled && l() }), T("doubleTap", (t, e) => {!D.animating && D.params.zoom.enabled && D.zoom.enabled && D.params.zoom.toggle && u(e) }), T("transitionEnd", () => { D.zoom.enabled && D.params.zoom.enabled && d() }), T("slideChange", () => { D.zoom.enabled && D.params.zoom.enabled && D.params.cssMode && d() }), Object.assign(D.zoom, { enable: b, disable: v, in: p, out: c, toggle: u })
        }

        function ge(t) {
            function e(t, s) { void 0 === s && (s = !0); const i = a.params.lazy; if (void 0 === t) return; if (0 === a.slides.length) return; const o = a.virtual && a.params.virtual.enabled,
                    n = o ? a.$wrapperEl.children(`.${a.params.slideClass}[data-swiper-slide-index="${t}"]`) : a.slides.eq(t),
                    r = n.find(`.${i.elementClass}:not(.${i.loadedClass}):not(.${i.loadingClass})`);!n.hasClass(i.elementClass) || n.hasClass(i.loadedClass) || n.hasClass(i.loadingClass) || r.push(n[0]), 0 !== r.length && r.each(t => { const o = h(t);
                    o.addClass(i.loadingClass); const r = o.attr("data-background"),
                        d = o.attr("data-src"),
                        p = o.attr("data-srcset"),
                        c = o.attr("data-sizes"),
                        u = o.parent("picture");
                    a.loadImage(o[0], d || r, p, c, !1, () => { if (null != a && a && (!a || a.params) && !a.destroyed) { if (r ? (o.css("background-image", `url("${r}")`), o.removeAttr("data-background")) : (p && (o.attr("srcset", p), o.removeAttr("data-srcset")), c && (o.attr("sizes", c), o.removeAttr("data-sizes")), u.length && u.children("source").each(t => { const e = h(t);
                                    e.attr("data-srcset") && (e.attr("srcset", e.attr("data-srcset")), e.removeAttr("data-srcset")) }), d && (o.attr("src", d), o.removeAttr("data-src"))), o.addClass(i.loadedClass).removeClass(i.loadingClass), n.find(`.${i.preloaderClass}`).remove(), a.params.loop && s) { const t = n.attr("data-swiper-slide-index"); if (n.hasClass(a.params.slideDuplicateClass)) { const s = a.$wrapperEl.children(`[data-swiper-slide-index="${t}"]:not(.${a.params.slideDuplicateClass})`);
                                    e(s.index(), !1) } else { const s = a.$wrapperEl.children(`.${a.params.slideDuplicateClass}[data-swiper-slide-index="${t}"]`);
                                    e(s.index(), !1) } }
                            l("lazyImageReady", n[0], o[0]), a.params.autoHeight && a.updateAutoHeight() } }), l("lazyImageLoad", n[0], o[0]) }) }

            function s() {
                function t(t) { if (l) { if (i.children(`.${o.slideClass}[data-swiper-slide-index="${t}"]`).length) return !0 } else if (n[t]) return !0; return !1 }

                function s(t) { return l ? h(t).attr("data-swiper-slide-index") : h(t).index() } const { $wrapperEl: i, params: o, slides: n, activeIndex: r } = a, l = a.virtual && o.virtual.enabled, d = o.lazy; let c = o.slidesPerView; if ("auto" === c && (c = 0), p || (p = !0), a.params.watchSlidesProgress) i.children(`.${o.slideVisibleClass}`).each(t => { const s = l ? h(t).attr("data-swiper-slide-index") : h(t).index();
                    e(s) });
                else if (c > 1)
                    for (let s = r; s < r + c; s += 1) t(s) && e(s);
                else e(r); if (d.loadPrevNext)
                    if (c > 1 || d.loadPrevNextAmount && d.loadPrevNextAmount > 1) { const s = d.loadPrevNextAmount,
                            i = c,
                            o = Math.min(r + i + Math.max(s, i), n.length),
                            a = Math.max(r - Math.max(i, s), 0); for (let s = r + c; s < o; s += 1) t(s) && e(s); for (let s = a; s < r; s += 1) t(s) && e(s) } else { const t = i.children(`.${o.slideNextClass}`);
                        t.length > 0 && e(s(t)); const a = i.children(`.${o.slidePrevClass}`);
                        a.length > 0 && e(s(a)) } }

            function o() { const t = i(); if (!a || a.destroyed) return; const e = a.params.lazy.scrollingElement ? h(a.params.lazy.scrollingElement) : h(t),
                    n = e[0] === t,
                    r = n ? t.innerWidth : e[0].offsetWidth,
                    l = n ? t.innerHeight : e[0].offsetHeight,
                    p = a.$el.offset(),
                    { rtlTranslate: c } = a; let u = !1;
                c && (p.left -= a.$el[0].scrollLeft); const m = [
                    [p.left, p.top],
                    [p.left + a.width, p.top],
                    [p.left, p.top + a.height],
                    [p.left + a.width, p.top + a.height]
                ]; for (let t = 0; t < m.length; t += 1) { const e = m[t]; if (e[0] >= 0 && e[0] <= r && e[1] >= 0 && e[1] <= l) { if (0 === e[0] && 0 === e[1]) continue;
                        u = !0 } } const g = !("touchstart" !== a.touchEvents.start || !a.support.passiveListener || !a.params.passiveListeners) && { passive: !0, capture: !1 };
                u ? (s(), e.off("scroll", o, g)) : d || (d = !0, e.on("scroll", o, g)) } let { swiper: a, extendParams: n, on: r, emit: l } = t;
            n({ lazy: { checkInView: !1, enabled: !1, loadPrevNext: !1, loadPrevNextAmount: 1, loadOnTransitionStart: !1, scrollingElement: "", elementClass: "ax-lazy", loadingClass: "ax-lazy-loading", loadedClass: "ax-lazy-loaded", preloaderClass: "ax-loading" } }), a.lazy = {}; let d = !1,
                p = !1;
            r("beforeInit", () => { a.params.lazy.enabled && a.params.preloadImages && (a.params.preloadImages = !1) }), r("init", () => { a.params.lazy.enabled && (a.params.lazy.checkInView ? o() : s()) }), r("scroll", () => { a.params.freeMode && a.params.freeMode.enabled && !a.params.freeMode.sticky && s() }), r("scrollbarDragMove resize _freeModeNoMomentumRelease", () => { a.params.lazy.enabled && (a.params.lazy.checkInView ? o() : s()) }), r("transitionStart", () => { a.params.lazy.enabled && (a.params.lazy.loadOnTransitionStart || !a.params.lazy.loadOnTransitionStart && !p) && (a.params.lazy.checkInView ? o() : s()) }), r("transitionEnd", () => { a.params.lazy.enabled && !a.params.lazy.loadOnTransitionStart && (a.params.lazy.checkInView ? o() : s()) }), r("slideChange", () => { const { lazy: t, cssMode: e, watchSlidesProgress: i, touchReleaseOnEdges: o, resistanceRatio: n } = a.params;
                t.enabled && (e || i && (o || 0 === n)) && s() }), Object.assign(a.lazy, { load: s, loadInSlide: e }) }

        function fe(t) {
            function e(t, e) { const s = function() { let t, e, s; return (i, o) => { for (e = -1, t = i.length; t - e > 1;) s = t + e >> 1, i[s] <= o ? e = s : t = s; return t } }(); let i, o; return this.x = t, this.y = e, this.lastIndex = t.length - 1, this.interpolate = function(t) { return t ? (o = s(this.x, t), i = o - 1, (t - this.x[i]) * (this.y[o] - this.y[i]) / (this.x[o] - this.x[i]) + this.y[i]) : 0 }, this }

            function s(t) { n.controller.spline || (n.controller.spline = n.params.loop ? new e(n.slidesGrid, t.slidesGrid) : new e(n.snapGrid, t.snapGrid)) }

            function i(t, e) {
                function i(t) { const e = n.rtlTranslate ? -n.translate : n.translate; "slide" === n.params.controller.by && (s(t), r = -n.controller.spline.interpolate(-e)), r && "container" !== n.params.controller.by || (a = (t.maxTranslate() - t.minTranslate()) / (n.maxTranslate() - n.minTranslate()), r = (e - n.minTranslate()) * a + t.minTranslate()), n.params.controller.inverse && (r = t.maxTranslate() - r), t.updateProgress(r), t.setTranslate(r, n), t.updateActiveIndex(), t.updateSlidesClasses() } const o = n.controller.control; let a, r; const l = n.constructor; if (Array.isArray(o))
                    for (let t = 0; t < o.length; t += 1) o[t] !== e && o[t] instanceof l && i(o[t]);
                else o instanceof l && e !== o && i(o) }

            function o(t, e) {
                function s(e) { e.setTransition(t, n), 0 !== t && (e.transitionStart(), e.params.autoHeight && X(() => { e.updateAutoHeight() }), e.$wrapperEl.transitionEnd(() => { o && (e.params.loop && "slide" === n.params.controller.by && e.loopFix(), e.transitionEnd()) })) } const i = n.constructor,
                    o = n.controller.control; let a; if (Array.isArray(o))
                    for (a = 0; a < o.length; a += 1) o[a] !== e && o[a] instanceof i && s(o[a]);
                else o instanceof i && e !== o && s(o) }

            function a() { n.controller.control && n.controller.spline && (n.controller.spline = void 0, delete n.controller.spline) } let { swiper: n, extendParams: r, on: l } = t;
            r({ controller: { control: void 0, inverse: !1, by: "slide" } }), n.controller = { control: void 0 }, l("beforeInit", () => { n.controller.control = n.params.controller.control }), l("update", () => { a() }), l("resize", () => { a() }), l("observerUpdate", () => { a() }), l("setTranslate", (t, e, s) => { n.controller.control && n.controller.setTranslate(e, s) }), l("setTransition", (t, e, s) => { n.controller.control && n.controller.setTransition(e, s) }), Object.assign(n.controller, { setTranslate: i, setTransition: o }) }

        function xe(t) {
            function e(t) { const e = S;
                0 !== e.length && (e.html(""), e.html(t)) }

            function s(t) { void 0 === t && (t = 16); const e = () => Math.round(16 * Math.random()).toString(16); return "x".repeat(t).replace(/x/g, e) }

            function i(t) { t.attr("tabIndex", "0") }

            function o(t) { t.attr("tabIndex", "-1") }

            function a(t, e) { t.attr("role", e) }

            function n(t, e) { t.attr("aria-roledescription", e) }

            function r(t, e) { t.attr("aria-controls", e) }

            function l(t, e) { t.attr("aria-label", e) }

            function d(t, e) { t.attr("id", e) }

            function p(t, e) { t.attr("aria-live", e) }

            function c(t) { t.attr("aria-disabled", !0) }

            function u(t) { t.attr("aria-disabled", !1) }

            function m(t) { if (13 !== t.keyCode && 32 !== t.keyCode) return; const s = D.params.a11y,
                    i = h(t.target);
            ...
            function g() { if (D.params.loop || D.params.rewind || !D.navigation) return; const { $nextEl: t, $prevEl: e } = D.navigation;
                e && e.length > 0 && (D.isBeginning ? (c(e), o(e)) : (u(e), i(e))), t && t.length > 0 && (D.isEnd ? (c(t), o(t)) : (u(t), i(t))) }

            function f() { return D.pagination && D.pagination.bullets && D.pagination.bullets.length }

            function x() { return f() && D.params.pagination.clickable }

            function y() { const t = D.params.a11y;
                f() && D.pagination.bullets.each(e => { const s = h(e);
                    D.params.pagination.clickable && (i(s), D.params.pagination.renderBullet || (a(s, "button"), l(s, t.paginationBulletMessage.replace(/\{\{index\}\}/, s.index() + 1)))), s.is(`.${D.params.pagination.bulletActiveClass}`) ? s.attr("aria-current", "true") : s.removeAttr("aria-current") }) }

            function b() { const t = D.params.a11y;
                D.$el.append(S); const e = D.$el;
                t.containerRoleDescriptionMessage && n(e, t.containerRoleDescriptionMessage), t.containerMessage && l(e, t.containerMessage); const i = D.$wrapperEl,
                    o = t.id || i.attr("id") || `ax-wrapper-${s(16)}`,
                    r = D.params.autoplay && D.params.autoplay.enabled ? "off" : "polite";
                d(i, o), p(i, r), t.itemRoleDescriptionMessage && n(h(D.slides), t.itemRoleDescriptionMessage), a(h(D.slides), t.slideRole); const c = D.params.loop ? D.slides.filter(t => !t.classList.contains(D.params.slideDuplicateClass)).length : D.slides.length; let u, g;
                D.slides.each((e, s) => { const i = h(e),
                        o = D.params.loop ? parseInt(i.attr("data-swiper-slide-index"), 10) : s,
                        a = t.slideLabelMessage.replace(/\{\{index\}\}/, o + 1).replace(/\{\{slidesLength\}\}/, c);
                    l(i, a) }), D.navigation && D.navigation.$nextEl && (u = D.navigation.$nextEl), D.navigation && D.navigation.$prevEl && (g = D.navigation.$prevEl), u && u.length && E(u, o, t.nextSlideMessage), g && g.length && E(g, o, t.prevSlideMessage), x() && D.pagination.$el.on("keydown", de(D.params.pagination.bulletClass), m), D.$el.on("focus", A, !0) }

            function v() { let t, e;
                S && S.length > 0 && S.remove(), D.navigation && D.navigation.$nextEl && (t = D.navigation.$nextEl), D.navigation && D.navigation.$prevEl && (e = D.navigation.$prevEl), t && t.off("keydown", m), e && e.off("keydown", m), x() && D.pagination.$el.off("keydown", de(D.params.pagination.bulletClass), m), D.$el.off("focus", A, !0) } let { swiper: D, extendParams: w, on: T } = t;
            w({ a11y: { enabled: !0, notificationClass: "ax-notification", prevSlideMessage: "上一个", nextSlideMessage: "下一个", firstSlideMessage: "这是第一个", lastSlideMessage: "这是最后一个", paginationBulletMessage: "跳转到第{{index}}页", slideLabelMessage: "第{{index}}/{{slidesLength}}页", containerMessage: null, containerRoleDescriptionMessage: null, itemRoleDescriptionMessage: null, slideRole: "group", id: null } }); let S = null; const E = (t, e, s) => { i(t), "BUTTON" !== t[0].tagName && (a(t, "button"), t.on("keydown", m)), l(t, s), r(t, e) },
                A = t => { const e = t.target.closest(`.${D.params.slideClass}`); if (!e || !D.slides.includes(e)) return; const s = D.slides.indexOf(e) === D.activeIndex,
                        i = D.params.watchSlidesProgress && D.visibleSlides && D.visibleSlides.includes(e);
                    s || i || D.slideTo(D.slides.indexOf(e), 0) };
            T("beforeInit", () => { S = h(`<span class="${D.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`) }), T("afterInit", () => { D.params.a11y.enabled && b() }), T("fromEdge toEdge afterInit lock unlock", () => { D.params.a11y.enabled && g() }), T("paginationUpdate", () => { D.params.a11y.enabled && y() }), T("destroy", () => { D.params.a11y.enabled && v() }) }

        function ye(t) { let { swiper: e, extendParams: s, on: o } = t;
            s({ history: { enabled: !1, root: "", replaceState: !1, key: "slides" } }); let a = !1,
                n = {}; const r = t => t.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
                l = t => { const e = i(); let s;
                    s = t ? new URL(t) : e.location; const o = s.pathname.slice(1).split("/").filter(t => "" !== t),
                        a = o.length,
                        n = o[a - 2],
                        r = o[a - 1]; return { key: n, value: r } },
                h = (t, s) => { const o = i(); if (!a || !e.params.history.enabled) return; let n;
                    n = e.params.url ? new URL(e.params.url) : o.location; const l = e.slides.eq(s); let h = r(l.attr("data-history")); if (e.params.history.root.length > 0) { let s = e.params.history.root; "/" === s[s.length - 1] && (s = s.slice(0, s.length - 1)), h = `${s}/${t}/${h}` } else n.pathname.includes(t) || (h = `${t}/${h}`); const d = o.history.state;
                    d && d.value === h || (e.params.history.replaceState ? o.history.replaceState({ value: h }, null, h) : o.history.pushState({ value: h }, null, h)) },
                d = (t, s, i) => { if (s)
                        for (let o = 0, a = e.slides.length; o < a; o += 1) { const a = e.slides.eq(o),
                                n = r(a.attr("data-history")); if (n === s && !a.hasClass(e.params.slideDuplicateClass)) { const s = a.index();
                                e.slideTo(s, t, i) } } else e.slideTo(0, t, i) },
                p = () => { n = l(e.params.url), d(e.params.speed, e.paths.value, !1) },
                c = () => { const t = i(); if (e.params.history) { if (!t.history || !t.history.pushState) return e.params.history.enabled = !1, void(e.params.hashNavigation.enabled = !0);
                        a = !0, n = l(e.params.url), (n.key || n.value) && (d(0, n.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", p)) } },
                u = () => { const t = i();
                    e.params.history.replaceState || t.removeEventListener("popstate", p) };
            o("init", () => { e.params.history.enabled && c() }), o("destroy", () => { e.params.history.enabled && u() }), o("transitionEnd _freeModeNoMomentumRelease", () => { a && h(e.params.history.key, e.activeIndex) }), o("slideChange", () => { a && e.params.cssMode && h(e.params.history.key, e.activeIndex) }) }

        function be(t) { let { swiper: e, extendParams: o, emit: a, on: n } = t, r = !1; const l = s(),
                d = i();
            o({ hashNavigation: { enabled: !1, replaceState: !1, watchState: !1 } }); const p = () => { a("hashChange"); const t = l.location.hash.replace("#", ""),
                        s = e.slides.eq(e.activeIndex).attr("data-hash"); if (t !== s) { const s = e.$wrapperEl.children(`.${e.params.slideClass}[data-hash="${t}"]`).index(); if (void 0 === s) return;
                        e.slideTo(s) } },
                c = () => { if (r && e.params.hashNavigation.enabled)
                        if (e.params.hashNavigation.replaceState && d.history && d.history.replaceState) d.history.replaceState(null, null, `#${e.slides.eq(e.activeIndex).attr("data-hash")}` || ""), a("hashSet");
                        else { const t = e.slides.eq(e.activeIndex),
                                s = t.attr("data-hash") || t.attr("data-history");
                            l.location.hash = s || "", a("hashSet") } },
                u = () => { if (!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled) return;
                    r = !0; const t = l.location.hash.replace("#", ""); if (t) { const s = 0; for (let i = 0, o = e.slides.length; i < o; i += 1) { const o = e.slides.eq(i),
                                a = o.attr("data-hash") || o.attr("data-history"); if (a === t && !o.hasClass(e.params.slideDuplicateClass)) { const t = o.index();
                                e.slideTo(t, s, e.params.runCallbacksOnInit, !0) } } }
                    e.params.hashNavigation.watchState && h(d).on("hashchange", p) },
                m = () => { e.params.hashNavigation.watchState && h(d).off("hashchange", p) };
            n("init", () => { e.params.hashNavigation.enabled && u() }), n("destroy", () => { e.params.hashNavigation.enabled && m() }), n("transitionEnd _freeModeNoMomentumRelease", () => { r && c() }), n("slideChange", () => { r && e.params.cssMode && c() }) }

        function ve(t) {
            function e() { const t = u.slides.eq(u.activeIndex); let s = u.params.autoplay.delay;
                t.attr("data-swiper-autoplay") && (s = t.attr("data-swiper-autoplay") || u.params.autoplay.delay), clearTimeout(c), c = X(() => { let t;
                    u.params.autoplay.reverseDirection ? u.params.loop ? (u.loopFix(), t = u.slidePrev(u.params.speed, !0, !0), f("autoplay")) : u.isBeginning ? u.params.autoplay.stopOnLastSlide ? o() : (t = u.slideTo(u.slides.length - 1, u.params.speed, !0, !0), f("autoplay")) : (t = u.slidePrev(u.params.speed, !0, !0), f("autoplay")) : u.params.loop ? (u.loopFix(), t = u.slideNext(u.params.speed, !0, !0), f("autoplay")) : u.isEnd ? u.params.autoplay.stopOnLastSlide ? o() : (t = u.slideTo(0, u.params.speed, !0, !0), f("autoplay")) : (t = u.slideNext(u.params.speed, !0, !0), f("autoplay")), u.params.cssMode && u.autoplay.running ? e() : !1 === t && e() }, s) }

            function i() { return void 0 === c && (!u.autoplay.running && (u.autoplay.running = !0, f("autoplayStart"), e(), !0)) }

            function o() { return !!u.autoplay.running && (void 0 !== c && (c && (clearTimeout(c), c = void 0), u.autoplay.running = !1, f("autoplayStop"), !0)) }

            function a(t) { u.autoplay.running && (u.autoplay.paused || (c && clearTimeout(c), u.autoplay.paused = !0, 0 !== t && u.params.autoplay.waitForTransition ? ["transitionend", "webkitTransitionEnd"].forEach(t => { u.$wrapperEl[0].addEventListener(t, r) }) : (u.autoplay.paused = !1, e()))) }

            function n() { const t = s(); "hidden" === t.visibilityState && u.autoplay.running && a(), "visible" === t.visibilityState && u.autoplay.paused && (e(), u.autoplay.paused = !1) }

            function r(t) { u && !u.destroyed && u.$wrapperEl && t.target === u.$wrapperEl[0] && (["transitionend", "webkitTransitionEnd"].forEach(t => { u.$wrapperEl[0].removeEventListener(t, r) }), u.autoplay.paused = !1, u.autoplay.running ? e() : o()) }

            function l() { u.params.autoplay.disableOnInteraction ? o() : (f("autoplayPause"), a()), ["transitionend", "webkitTransitionEnd"].forEach(t => { u.$wrapperEl[0].removeEventListener(t, r) }) }

            function h() { u.params.autoplay.disableOnInteraction || (u.autoplay.paused = !1, f("autoplayResume"), e()) }

            function d() { u.params.autoplay.pauseOnMouseEnter && (u.$el.on("mouseenter", l), u.$el.on("mouseleave", h)) }

            function p() { u.$el.off("mouseenter", l), u.$el.off("mouseleave", h) } let c, { swiper: u, extendParams: m, on: g, emit: f } = t;
            u.autoplay = { running: !1, paused: !1 }, m({ autoplay: { enabled: !1, delay: 3e3, waitForTransition: !0, disableOnInteraction: !0, stopOnLastSlide: !1, reverseDirection: !1, pauseOnMouseEnter: !1 } }), g("init", () => { if (u.params.autoplay.enabled) { i(); const t = s();
                ...
                t.removeEventListener("visibilitychange", n) }), Object.assign(u.autoplay, { pause: a, run: e, start: i, stop: o }) }

        function De(t) {
            function e() { const t = o.thumbs.swiper; if (!t || t.destroyed) return; const e = t.clickedIndex,
                    s = t.clickedSlide; if (s && h(s).hasClass(o.params.thumbs.slideThumbActiveClass)) return; if (null == e) return; let i; if (i = t.params.loop ? parseInt(h(t.clickedSlide).attr("data-swiper-slide-index"), 10) : e, o.params.loop) { let t = o.activeIndex;
                    o.slides.eq(t).hasClass(o.params.slideDuplicateClass) && (o.loopFix(), o._clientLeft = o.$wrapperEl[0].clientLeft, t = o.activeIndex); const e = o.slides.eq(t).prevAll(`[data-swiper-slide-index="${i}"]`).eq(0).index(),
                        s = o.slides.eq(t).nextAll(`[data-swiper-slide-index="${i}"]`).eq(0).index();
                    i = void 0 === e ? s : void 0 === s ? e : s - t < t - e ? s : e }
                o.slideTo(i) }

            function s() { const { thumbs: t } = o.params; if (r) return !1;
                r = !0; const s = o.constructor; if (t.swiper instanceof s) o.thumbs.swiper = t.swiper, Object.assign(o.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), Object.assign(o.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 });
                else if (Z(t.swiper)) { const e = Object.assign({}, t.swiper);
                    Object.assign(e, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), o.thumbs.swiper = new s(e), l = !0 } return o.thumbs.swiper.$el.addClass(o.params.thumbs.thumbsContainerClass), o.thumbs.swiper.on("tap", e), !0 }

            function i(t) { const e = o.thumbs.swiper; if (!e || e.destroyed) return; const s = "auto" === e.params.slidesPerView ? e.slidesPerViewDynamic() : e.params.slidesPerView,
                    i = o.params.thumbs.autoScrollOffset,
                    a = i && !e.params.loop; if (o.realIndex !== e.realIndex || a) { let n, r, l = e.activeIndex; if (e.params.loop) { e.slides.eq(l).hasClass(e.params.slideDuplicateClass) && (e.loopFix(), e._clientLeft = e.$wrapperEl[0].clientLeft, l = e.activeIndex); const t = e.slides.eq(l).prevAll(`[data-swiper-slide-index="${o.realIndex}"]`).eq(0).index(),
                            s = e.slides.eq(l).nextAll(`[data-swiper-slide-index="${o.realIndex}"]`).eq(0).index();
                        n = void 0 === t ? s : void 0 === s ? t : s - l == l - t ? e.params.slidesPerGroup > 1 ? s : l : s - l < l - t ? s : t, r = o.activeIndex > o.previousIndex ? "next" : "prev" } else n = o.realIndex, r = n > o.previousIndex ? "next" : "prev";
                    a && (n += "next" === r ? i : -1 * i), e.visibleSlidesIndexes && e.visibleSlidesIndexes.indexOf(n) < 0 && (e.params.centeredSlides ? n = n > l ? n - Math.floor(s / 2) + 1 : n + Math.floor(s / 2) - 1 : n > l && e.params.slidesPerGroup, e.slideTo(n, t ? 0 : void 0)) } let n = 1; const r = o.params.thumbs.slideThumbActiveClass; if (o.params.slidesPerView > 1 && !o.params.centeredSlides && (n = o.params.slidesPerView), o.params.thumbs.multipleActiveThumbs || (n = 1), n = Math.floor(n), e.slides.removeClass(r), e.params.loop || e.params.virtual && e.params.virtual.enabled)
                    for (let t = 0; t < n; t += 1) e.$wrapperEl.children(`[data-swiper-slide-index="${o.realIndex+t}"]`).addClass(r);
                else
                    for (let t = 0; t < n; t += 1) e.slides.eq(o.realIndex + t).addClass(r) } let { swiper: o, extendParams: a, on: n } = t;
            a({ thumbs: { swiper: null, multipleActiveThumbs: !0, autoScrollOffset: 0, slideThumbActiveClass: "ax-slide-thumb-active", thumbsContainerClass: "ax-thumbs" } }); let r = !1,
                l = !1;
            o.thumbs = { swiper: null }, n("beforeInit", () => { const { thumbs: t } = o.params;
                t && t.swiper && (s(), i(!0)) }), n("slideChange update resize observerUpdate", () => { i() }), n("setTransition", (t, e) => { const s = o.thumbs.swiper;
                s && !s.destroyed && s.setTransition(e) }), n("beforeDestroy", () => { const t = o.thumbs.swiper;
                t && !t.destroyed && l && t.destroy() }), Object.assign(o.thumbs, { init: s, update: i }) }

        function we(t) {
            function e() { const t = o.getTranslate();
                o.setTranslate(t), o.setTransition(0), o.touchEventsData.velocities.length = 0, o.freeMode.onTouchEnd({ currentPos: o.rtl ? o.translate : -o.translate }) }

            function s() { const { touchEventsData: t, touches: e } = o;
                0 === t.velocities.length && t.velocities.push({ position: e[o.isHorizontal() ? "startX" : "startY"], time: t.touchStartTime }), t.velocities.push({ position: e[o.isHorizontal() ? "currentX" : "currentY"], time: G() }) }

            function i(t) { let { currentPos: e } = t; const { params: s, $wrapperEl: i, rtlTranslate: a, snapGrid: l, touchEventsData: h } = o, d = G(), p = d - h.touchStartTime; if (e < -o.minTranslate()) o.slideTo(o.activeIndex);
                else if (e > -o.maxTranslate()) o.slides.length < l.length ? o.slideTo(l.length - 1) : o.slideTo(o.slides.length - 1);
                else { if (s.freeMode.momentum) { if (h.velocities.length > 1) { const t = h.velocities.pop(),
                                e = h.velocities.pop(),
                                i = t.position - e.position,
                                a = t.time - e.time;
                            o.velocity = i / a, o.velocity /= 2, Math.abs(o.velocity) < s.freeMode.minimumVelocity && (o.velocity = 0), (a > 150 || G() - t.time > 300) && (o.velocity = 0) } else o.velocity = 0;
                        o.velocity *= s.freeMode.momentumVelocityRatio, h.velocities.length = 0; let t = 1e3 * s.freeMode.momentumRatio; const e = o.velocity * t; let d = o.translate + e;
                        a && (d = -d); let p, c = !1; const u = 20 * Math.abs(o.velocity) * s.freeMode.momentumBounceRatio; let m; if (d < o.maxTranslate()) s.freeMode.momentumBounce ? (d + o.maxTranslate() < -u && (d = o.maxTranslate() - u), p = o.maxTranslate(), c = !0, h.allowMomentumBounce = !0) : d = o.maxTranslate(), s.loop && s.centeredSlides && (m = !0);
                        else if (d > o.minTranslate()) s.freeMode.momentumBounce ? (d - o.minTranslate() > u && (d = o.minTranslate() + u), p = o.minTranslate(), c = !0, h.allowMomentumBounce = !0) : d = o.minTranslate(), s.loop && s.centeredSlides && (m = !0);
                        else if (s.freeMode.sticky) { let t; for (let e = 0; e < l.length; e += 1)
                                if (l[e] > -d) { t = e; break }
                            d = Math.abs(l[t] - d) < Math.abs(l[t - 1] - d) || "next" === o.swipeDirection ? l[t] : l[t - 1], d = -d } if (m && r("transitionEnd", () => { o.loopFix() }), 0 !== o.velocity) { if (t = a ? Math.abs((-d - o.translate) / o.velocity) : Math.abs((d - o.translate) / o.velocity), s.freeMode.sticky) { const e = Math.abs((a ? -d : d) - o.translate),
                                    i = o.slidesSizesGrid[o.activeIndex];
                                t = e < i ? s.speed : e < 2 * i ? 1.5 * s.speed : 2.5 * s.speed } } else if (s.freeMode.sticky) return void o.slideToClosest();
                        s.freeMode.momentumBounce && c ? (o.updateProgress(p), o.setTransition(t), o.setTranslate(d), o.transitionStart(!0, o.swipeDirection), o.animating = !0, i.transitionEnd(() => { o && !o.destroyed && h.allowMomentumBounce && (n("momentumBounce"), o.setTransition(s.speed), setTimeout(() => { o.setTranslate(p), i.transitionEnd(() => { o && !o.destroyed && o.transitionEnd() }) }, 0)) })) : o.velocity ? (n("_freeModeNoMomentumRelease"), o.updateProgress(d), o.setTransition(t), o.setTranslate(d), o.transitionStart(!0, o.swipeDirection), o.animating || (o.animating = !0, i.transitionEnd(() => { o && !o.destroyed && o.transitionEnd() }))) : o.updateProgress(d), o.updateActiveIndex(), o.updateSlidesClasses() } else { if (s.freeMode.sticky) return void o.slideToClosest();
                        s.freeMode && n("_freeModeNoMomentumRelease") }(!s.freeMode.momentum || p >= s.longSwipesMs) && (o.updateProgress(), o.updateActiveIndex(), o.updateSlidesClasses()) } } let { swiper: o, extendParams: a, emit: n, once: r } = t;
            a({ freeMode: { enabled: !1, momentum: !0, momentumRatio: 1, momentumBounce: !0, momentumBounceRatio: 1, momentumVelocityRatio: 1, sticky: !1, minimumVelocity: .02 } }), Object.assign(o, { freeMode: { onTouchStart: e, onTouchMove: s, onTouchEnd: i } }) }

        function Te(t) {
            let e, s, i, { swiper: o, extendParams: a } = t;
            a({ grid: { rows: 1, fill: "column" } });
            const n = t => { const { slidesPerView: a } = o.params, { rows: n, fill: r } = o.params.grid;
                    s = e / n, i = Math.floor(t / n), e = Math.floor(t / n) === t / n ? t : Math.ceil(t / n) * n, "auto" !== a && "row" === r && (e = Math.max(e, a * n)) },
                r = (t, a, n, r) => { const { slidesPerGroup: l, spaceBetween: h } = o.params, { rows: d, fill: p } = o.params.grid; let c, u, m; if ("row" === p && l > 1) { const s = Math.floor(t / (l * d)),
                            i = t - d * l * s,
                            o = 0 === s ? l : Math.min(Math.ceil((n - s * d * l) / d), l);
                        m = Math.floor(i / o), u = i - m * o + s * l, c = u + m * e / d, a.css({ "-webkit-order": c, order: c }) } else "column" === p ? (u = Math.floor(t / d), m = t - u * d, (u > i || u === i && m === d - 1) && (m += 1, m >= d && (m = 0, u += 1))) : (m = Math.floor(t / s), u = t - m * s);
                    a.css(r("margin-top"), 0 !== m ? h && `${h}px` : "") },
                l = (t, s, i) => {
                    const { spaceBetween: a, centeredSlides: n, roundLengths: r } = o.params, { rows: l } = o.params.grid;
                    if (o.virtualSize = (t + a) * e,
                        o.virtualSize = Math.ceil(o.virtualSize / l) - a, o.$wrapperEl.css({
                            [i("width")]: `${o.virtualSize+a}px` }), n) { s.splice(0, s.length); const t = []; for (let e = 0; e < s.length; e += 1) { let i = s[e];
                            r && (i = Math.floor(i)), s[e] < o.virtualSize + s[0] && t.push(i) }
                        s.push(...t) }
                };
            o.grid = { initSlides: n, updateSlide: r, updateWrapperSize: l }
        }

        function Se(t) { const e = this,
                { $wrapperEl: s, params: i } = e; if (i.loop && e.loopDestroy(), "object" == typeof t && "length" in t)
                for (let e = 0; e < t.length; e += 1) t[e] && s.append(t[e]);
            else s.append(t);
            i.loop && e.loopCreate(), i.observer || e.update() }

        function Ee(t) { const e = this,
                { params: s, $wrapperEl: i, activeIndex: o } = e;
            s.loop && e.loopDestroy(); let a = o + 1; if ("object" == typeof t && "length" in t) { for (let e = 0; e < t.length; e += 1) t[e] && i.prepend(t[e]);
                a = o + t.length } else i.prepend(t);
            s.loop && e.loopCreate(), s.observer || e.update(), e.slideTo(a, 0, !1) }

        function Ae(t, e) { const s = this,
                { $wrapperEl: i, params: o, activeIndex: a } = s; let n = a;
            o.loop && (n -= s.loopedSlides, s.loopDestroy(), s.slides = i.children(`.${o.slideClass}`)); const r = s.slides.length; if (t <= 0) return void s.prependSlide(e); if (t >= r) return void s.appendSlide(e); let l = n > t ? n + 1 : n; const h = []; for (let e = r - 1; e >= t; e -= 1) { const t = s.slides.eq(e);
                t.remove(), h.unshift(t) } if ("object" == typeof e && "length" in e) { for (let t = 0; t < e.length; t += 1) e[t] && i.append(e[t]);
                l = n > t ? n + e.length : n } else i.append(e); for (let t = 0; t < h.length; t += 1) i.append(h[t]);
            o.loop && s.loopCreate(), o.observer || s.update(), o.loop ? s.slideTo(l + s.loopedSlides, 0, !1) : s.slideTo(l, 0, !1) }

        function Ce(t) { const e = this,
                { params: s, $wrapperEl: i, activeIndex: o } = e; let a = o;
            s.loop && (a -= e.loopedSlides, e.loopDestroy(), e.slides = i.children(`.${s.slideClass}`)); let n, r = a; if ("object" == typeof t && "length" in t) { for (let s = 0; s < t.length; s += 1) n = t[s], e.slides[n] && e.slides.eq(n).remove(), n < r && (r -= 1);
                r = Math.max(r, 0) } else n = t, e.slides[n] && e.slides.eq(n).remove(), n < r && (r -= 1), r = Math.max(r, 0);
            s.loop && e.loopCreate(), s.observer || e.update(), s.loop ? e.slideTo(r + e.loopedSlides, 0, !1) : e.slideTo(r, 0, !1) }

        function Ie() { const t = this,
                e = []; for (let s = 0; s < t.slides.length; s += 1) e.push(s);
            t.removeSlide(e) }

        function ke(t) { let { swiper: e } = t;
            Object.assign(e, { appendSlide: Se.bind(e), prependSlide: Ee.bind(e), addSlide: Ae.bind(e), removeSlide: Ce.bind(e), removeAllSlides: Ie.bind(e) }) }

        function Me(t) { const { effect: e, swiper: s, on: i, setTranslate: o, setTransition: a, overwriteParams: n, perspective: r, recreateShadows: l, getEffectParams: h } = t; let d;
            i("beforeInit", () => { if (s.params.effect !== e) return;
                s.classNames.push(`${s.params.containerModifierClass}${e}`), r && r() && s.classNames.push(`${s.params.containerModifierClass}3d`); const t = n ? n() : {};
                Object.assign(s.params, t), Object.assign(s.originalParams, t) }), i("setTranslate", () => { s.params.effect === e && o() }), i("setTransition", (t, i) => { s.params.effect === e && a(i) }), i("transitionEnd", () => { if (s.params.effect === e && l) { if (!h || !h().slideShadows) return;
                    s.slides.each(t => { const e = s.$(t);
                        e.find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").remove() }), l() } }), i("virtualUpdate", () => { s.params.effect === e && (s.slides.length || (d = !0), requestAnimationFrame(() => { d && s.slides && s.slides.length && (o(), d = !1) })) }) }

        function Le(t, e) { return t.transformEl ? e.find(t.transformEl).css({ "backface-visibility": "hidden", "-webkit-backface-visibility": "hidden" }) : e }

        function Pe(t) { let { swiper: e, duration: s, transformEl: i, allSlides: o } = t; const { slides: a, activeIndex: n, $wrapperEl: r } = e; if (e.params.virtualTranslate && 0 !== s) { let t, s = !1;
                t = o ? i ? a.find(i) : a : i ? a.eq(n).find(i) : a.eq(n), t.transitionEnd(() => { if (s) return; if (!e || e.destroyed) return;
                    s = !0, e.animating = !1; const t = ["webkitTransitionEnd", "transitionend"]; for (let e = 0; e < t.length; e += 1) r.trigger(t[e]) }) } }

        function $e(t) { let { swiper: e, extendParams: s, on: i } = t;
            s({ fadeEffect: { crossFade: !1, transformEl: null } }); const o = () => { const { slides: t } = e, s = e.params.fadeEffect; for (let i = 0; i < t.length; i += 1) { const t = e.slides.eq(i),
                            o = t[0].swiperSlideOffset; let a = -o;
                        e.params.virtualTranslate || (a -= e.translate); let n = 0;
                        e.isHorizontal() || (n = a, a = 0); const r = e.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(t[0].progress), 0) : 1 + Math.min(Math.max(t[0].progress, -1), 0),
                            l = Le(s, t);
                        l.css({ opacity: r }).transform(`translate3d(${a}px, ${n}px, 0px)`) } },
                a = t => { const { transformEl: s } = e.params.fadeEffect, i = s ? e.slides.find(s) : e.slides;
                    i.transition(t), Pe({ swiper: e, duration: t, transformEl: s, allSlides: !0 }) };
            Me({ effect: "fade", swiper: e, on: i, setTranslate: o, setTransition: a, overwriteParams: () => ({ slidesPerView: 1, slidesPerGroup: 1, watchSlidesProgress: !0, spaceBetween: 0, virtualTranslate: !e.params.cssMode }) }) }

        function Oe(t) { let { swiper: e, extendParams: s, on: i } = t;
            s({ cubeEffect: { slideShadows: !0, shadow: !0, shadowOffset: 20, shadowScale: .94 } }); const o = (t, e, s) => { let i = s ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                        o = s ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                    0 === i.length && (i = h(`<div class="swiper-slide-shadow-${s?"left":"top"}"></div>`), t.append(i)), 0 === o.length && (o = h(`<div class="swiper-slide-shadow-${s?"right":"bottom"}"></div>`), t.append(o)), i.length && (i[0].style.opacity = Math.max(-e, 0)), o.length && (o[0].style.opacity = Math.max(e, 0)) },
                a = () => { const t = e.isHorizontal();
                    e.slides.each(e => { const s = Math.max(Math.min(e.progress, 1), -1);
                        o(h(e), s, t) }) },
                n = () => { const { $el: t, $wrapperEl: s, slides: i, width: a, height: n, rtlTranslate: r, size: l, browser: d } = e, p = e.params.cubeEffect, c = e.isHorizontal(), u = e.virtual && e.params.virtual.enabled; let m, g = 0;
                    p.shadow && (c ? (m = s.find(".swiper-cube-shadow"), 0 === m.length && (m = h('<div class="swiper-cube-shadow"></div>'), s.append(m)), m.css({ height: `${a}px` })) : (m = t.find(".swiper-cube-shadow"), 0 === m.length && (m = h('<div class="swiper-cube-shadow"></div>'), t.append(m)))); for (let t = 0; t < i.length; t += 1) { const e = i.eq(t); let s = t;
                        u && (s = parseInt(e.attr("data-swiper-slide-index"), 10)); let a = 90 * s,
                            n = Math.floor(a / 360);
                        r && (a = -a, n = Math.floor(-a / 360)); const h = Math.max(Math.min(e[0].progress, 1), -1); let d = 0,
                            m = 0,
                            f = 0;
                        s % 4 == 0 ? (d = 4 * -n * l, f = 0) : (s - 1) % 4 == 0 ? (d = 0, f = 4 * -n * l) : (s - 2) % 4 == 0 ? (d = l + 4 * n * l, f = l) : (s - 3) % 4 == 0 && (d = -l, f = 3 * l + 4 * l * n), r && (d = -d), c || (m = d, d = 0); const x = `rotateX(${c?0:-a}deg) rotateY(${c?a:0}deg) translate3d(${d}px, ${m}px, ${f}px)`;
                        h <= 1 && h > -1 && (g = 90 * s + 90 * h, r && (g = 90 * -s - 90 * h)), e.transform(x), p.slideShadows && o(e, h, c) } if (s.css({ "-webkit-transform-origin": `50% 50% -${l/2}px`, "transform-origin": `50% 50% -${l/2}px` }), p.shadow)
                        if (c) m.transform(`translate3d(0px, ${a/2+p.shadowOffset}px, ${-a/2}px) rotateX(90deg) rotateZ(0deg) scale(${p.shadowScale})`);
                        else { const t = Math.abs(g) - 90 * Math.floor(Math.abs(g) / 90),
                                e = 1.5 - (Math.sin(2 * t * Math.PI / 360) / 2 + Math.cos(2 * t * Math.PI / 360) / 2),
                                s = p.shadowScale,
                                i = p.shadowScale / e,
                                o = p.shadowOffset;
                            m.transform(`scale3d(${s}, 1, ${i}) translate3d(0px, ${n/2+o}px, ${-n/2/i}px) rotateX(-90deg)`) }
                    const f = d.isSafari || d.isWebView ? -l / 2 : 0;
                    s.transform(`translate3d(0px,0,${f}px) rotateX(${e.isHorizontal()?0:g}deg) rotateY(${e.isHorizontal()?-g:0}deg)`), s[0].style.setProperty("--swiper-cube-translate-z", `${f}px`) },
                r = t => { const { $el: s, slides: i } = e;
